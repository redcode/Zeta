...
#define Z_TZX_HARDWARE_ID_ZX_MICRODRIVE			 0x00
#define Z_TZX_HARDWARE_ID_OPUS_DISCOVERY_1		 0x01
#define Z_TZX_HARDWARE_ID_DISCIPLE			 0x02
#define Z_TZX_HARDWARE_ID_PLUS_D			 0x03
#define Z_TZX_HARDWARE_ID_WAFADRIVE			 0x04
#define Z_TZX_HARDWARE_ID_BETA_DISK_INTERFACE		 0x05
#define Z_TZX_HARDWARE_ID_BYTE_DRIVE_500		 0x06
#define Z_TZX_HARDWARE_ID_WATFORD			 0x07 /* (What model?) */
#define Z_TZX_HARDWARE_ID_FIZ				 0x08
#define Z_TZX_HARDWARE_ID_TRITON_QUICK_DISK		 0x09
#define Z_TZX_HARDWARE_ID_DIDAKTIK_40_80		 0x0A
#define Z_TZX_HARDWARE_ID_MB_02_PLUS			 0x0B
#define Z_TZX_HARDWARE_ID_ZX_SPECTRUM_PLUS_3_DISK_DRIVE	 0x0C
#define Z_TZX_HARDWARE_ID_OLIGER_DISK_INTERFACE		 0x0D
#define Z_TZX_HARDWARE_ID_TIMEX_FDD_3000		 0x0E
#define Z_TZX_HARDWARE_ID_ZEBRA_FLOPPY_DISK_DRIVE	 0x0F
#define Z_TZX_HARDWARE_ID_MILLENA_K			 0x10
#define Z_TZX_HARDWARE_ID_LARKEN			 0x11
#define Z_TZX_HARDWARE_ID_KEMPSTON_DISC_INTERFACE	 0x12 /* Added in v1.20 */
#define Z_TZX_HARDWARE_ID_SANDY				 0x13 /* Added in v1.20 */
#define Z_TZX_HARDWARE_ID_ZX_SPECTRUM_PLUS_3E_HDD	 0x14 /* Added in v1.20 */
#define Z_TZX_HARDWARE_ID_ZXATASP			 0x15 /* Added in v1.20 */
#define Z_TZX_HARDWARE_ID_DIVIDE			 0x16 /* Added in v1.20 */
#define Z_TZX_HARDWARE_ID_ZXCF				 0x17 /* Added in v1.20 */
...
Multiface +3						0x03
MultiPrint						0x04
MB-02 ROM/RAM expansion					0x05
SoftROM							0x06 /* Added in v1.20 */
1k							0x07 /* Added in v1.20 */
16k							0x08 /* Added in v1.20 */
48k							0x09 /* Added in v1.20 */
Memory in 8-16k used					0x0A /* Added in v1.20 */

Classic AY hardware (compatible with 128k ZXs)		0x00
Fuller Box AY sound hardware				0x01
Currah microSpeech					0x02
SpecDrum						0x03
AY ACB stereo (A+C=left, B+C=right); Melodik		0x04
AY ABC stereo (A+B=left, B+C=right)			0x05
RAM Music Machine					0x06 /* Added in v1.20 */
Covox							0x07 /* Added in v1.20 */
General Sound						0x08 /* Added in v1.20 */
Intec Electronics Digital Interface B8001		0x09 /* Added in v1.20 */
Zon-X AY						0x0A /* Added in v1.20 */
QuickSilva AY						0x0B /* Added in v1.20 */
Jupiter ACE						0x0C /* Added in v1.20 */

Kempston						0x00
Cursor, Protek, AGF					0x01
Sinclair 2 Left (12345)					0x02
Sinclair 1 Right (67890)				0x03
Fuller							0x04
...
Trickstick						0x00
ZX Light Gun						0x01
Zebra Graphics Tablet					0x02
Defender Light Gun					0x03 /* Added in v1.20 */

ZX Interface 1						0x00
ZX Spectrum 128k					0x01
...
DK'Tronics						0x04
Hilderbay						0x05
INES Printerface					0x06
ZX LPrint Interface 3					0x07
MultiPrint						0x08
Opus Discovery						0x09
Standard 8255 chip with ports 31,63,95			0x0A

ZX Printer, Alphacom 32 & compatibles			0x00
Generic printer						0x01
EPSON compatible					0x02

Prism VTX 5000						0x00
T/S 2050 or Westridge 2050				0x01

RD Digital Tracer					0x00
DK'Tronics Light Pen					0x01
British MicroGraph Pad					0x02
Romantic Robot Videoface				0x03 /* Added in v1.20 */

ZX Interface 1						0x00

Keypad for ZX Spectrum 128k				0x00

Harley Systems ADC 8.2					0x00
Blackboard Electronics					0x01

Orme Electronics					0x00

WRX Hi-Res						0x00 /* Added in v1.20 */
G007							0x01 /* Added in v1.20 */
Memotech						0x02 /* Added in v1.20 */
Lambda Colour						0x03 /* Added in v1.20 */
