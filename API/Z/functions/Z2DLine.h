...
#ifndef _Z_functions_Z2DLine_H_
#define _Z_functions_Z2DLine_H_
...
zboolean z_2d_line_##type##_are_equal(Z2DLine##Type a, Z2DLine##Type b)		\
	{									\
	return	z_2d_##type##_are_equal(a.a, b.a) &&				\
		z_2d_##type##_are_equal(a.b, b.b);				\
	}									\
										\
										\
static Z_INLINE									\
zboolean z_2d_line_##type##_are_perpendicular(Z2DLine##Type a, Z2DLine##Type b)	\
	...
	return z_2d_##type##_are_perpendicular					\
		(z_2d_##type##_subtract(a.b, a.a),				\
		 z_2d_##type##_subtract(b.b, b.a));				\
	}									\
										\
										\
static Z_INLINE									\
zboolean z_2d_line_##type##_is_zero(Z2DLine##Type object)			\
	{									\
	return	z_2d_##type##_is_zero(object.a) &&				\
		z_2d_##type##_is_zero(object.b);				\
	}									\
										\
										\
static Z_INLINE									\
...
zboolean z_2d_line_segment_##type##_intersect(Z2DLine##Type a, Z2DLine##Type b)	\
	...
	z##type	  u  = z_2d_##type##_cross_product(d, va) / c;			\
										\
	return	!(t < (z##type)0 || t > (z##type)1 ||				\
		  u < (z##type)0 || u > (z##type)1);				\
	}									\
										\
										\
static Z_INLINE									\
