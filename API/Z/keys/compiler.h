...
#define Z_COMPILER_MSC				   3 /* Microsoft											   */
#define Z_COMPILER_MSVC				   4 /* Microsoft				   <https://visualstudio.microsoft.com>			   */
#define Z_COMPILER_ACC				   5 /*													   */
#define Z_COMPILER_ALTIUM_MICROBLAZE_C		   6 /*													   */
#define Z_COMPILER_ALTIUM_C_TO_HARDWARE		   7 /*													   */
#define Z_COMPILER_AMSTERDAM_COMPILER_KIT	   8 /*													   */
#define Z_COMPILER_APPLE_LLVM			   9 /* Apple					   <https://developer.apple.com/xcode>			   */
#define Z_COMPILER_ARM_C_CPP_COMPILER		  10 /*													   */
#define Z_COMPILER_ARM_COMPILER			  11 /*													   */
#define Z_COMPILER_AZTEC_C			  12 /*													   */
...
#define Z_COMPILER_NDP_C			  49 /* Microway											   */
...
#define Z_COMPILER_PELLES_C			  58 /* Orinius, Pelle				   <http://www.smorgasbordet.com/pellesc>		   */
...
#define Z_COMPILER_SNC				  64 /* SN Systems											   */
#define Z_COMPILER_SYMANTEC_CPP			  65 /*													   */
#define Z_COMPILER_SYSTEMS_C			  66 /* Dignus					   <http://www.dignus.com/dcc>				   */
#define Z_COMPILER_TENDRA			  67 /* DERA												   */
#define Z_COMPILER_TI_C_CPP_COMPILER		  68 /*													   */
#define Z_COMPILER_THINK_C			  69 /*													   */
#define Z_COMPILER_TINY_C			  70 /* Bellard, Fabrice			   <https://bellard.org/tcc>				   */
#define Z_COMPILER_TURBO_C			  71 /* Borland												   */
#define Z_COMPILER_TURBO_CPP			  72 /* Borland												   */
#define Z_COMPILER_ULTRA_C_CPP			  73 /* Microware Systems										   */
#define Z_COMPILER_USL				  74 /*													   */
#define Z_COMPILER_VBCC				  75 /* Barthelmann, Volker			   <http://www.compilers.de/vbcc.html>			   */
#define Z_COMPILER_VOS_C			  76 /* Stratus Technologies										   */
#define Z_COMPILER_VOS_STANDARD_C		  77 /* Stratus Technologies										   */
#define Z_COMPILER_WATCOM_C_CPP			  78 /* Watcom International			   <http://openwatcom.org>				   */
#define Z_COMPILER_ZORTECH_CPP			  79 /*													   */
