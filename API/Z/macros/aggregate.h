...
#ifndef _Z_macros_aggregate_H_
#define _Z_macros_aggregate_H_
...
#define Z_DEFINE_STRICT_STRUCTURE(body, type)			  \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_TYPEDEF typedef \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_STRUCT  struct  \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_BODY	  body	  \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_TYPE	  type	  \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_AFTER_TYPE

#define Z_DEFINE_STRICT_STRUCTURE_BEGIN				  \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_TYPEDEF typedef \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_STRUCT  struct  \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_BODY

#define Z_DEFINE_STRICT_STRUCTURE_END(type)		    \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_BEFORE_TYPE type \
	Z_COMPILER_DEFINE_STRICT_STRUCTURE_AFTER_TYPE

#define Z_DEFINE_STRICT_UNION(body, type)		      \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_TYPEDEF typedef \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_UNION   union   \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_BODY    body    \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_TYPE    type    \
	Z_COMPILER_DEFINE_STRICT_UNION_AFTER_TYPE

#define Z_DEFINE_STRICT_UNION_BEGIN			      \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_TYPEDEF typedef \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_UNION   union   \
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_BODY

#define Z_DEFINE_STRICT_UNION_END(type)			\
	Z_COMPILER_DEFINE_STRICT_UNION_BEFORE_TYPE type	\
	Z_COMPILER_DEFINE_STRICT_UNION_AFTER_TYPE

#define Z_STRICT_NAMED_STRUCTURE(type, body)		       \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_BEFORE_STRUCT struct \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_BEFORE_TYPE	type   \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_BEFORE_BODY	body   \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_AFTER_BODY

#define Z_STRICT_NAMED_STRUCTURE_BEGIN(type)		       \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_BEFORE_STRUCT struct \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_BEFORE_TYPE	type   \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_BEFORE_BODY

#define Z_STRICT_NAMED_STRUCTURE_END \
	Z_COMPILER_STRICT_NAMED_STRUCTURE_AFTER_BODY

#define Z_STRICT_NAMED_UNION(type, body)		 \
	Z_COMPILER_STRICT_NAMED_UNION_BEFORE_UNION union \
	Z_COMPILER_STRICT_NAMED_UNION_BEFORE_TYPE  type	 \
	Z_COMPILER_STRICT_NAMED_UNION_BEFORE_BODY  body	 \
	Z_COMPILER_STRICT_NAMED_UNION_AFTER_BODY

#define Z_STRICT_NAMED_UNION_BEGIN(type)		 \
	Z_COMPILER_STRICT_NAMED_UNION_BEFORE_UNION union \
	Z_COMPILER_STRICT_NAMED_UNION_BEFORE_TYPE  type	 \
	Z_COMPILER_STRICT_NAMED_UNION_BEFORE_BODY

#define Z_STRICT_NAMED_UNION_END \
	Z_COMPILER_STRICT_NAMED_UNION_AFTER_BODY

#define Z_STRICT_UNNAMED_STRUCTURE(body, identifier)			\
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_BEFORE_STRUCT     struct	\
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_BEFORE_BODY	     body	\
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_BEFORE_IDENTIFIER identifier \
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_AFTER_IDENTIFIER

#define Z_STRICT_UNNAMED_STRUCTURE_BEGIN			\
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_BEFORE_STRUCT struct	\
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_BEFORE_BODY

#define Z_STRICT_UNNAMED_STRICTURE_END(identifier)			\
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_BEFORE_IDENTIFIER identifier \
	Z_COMPILER_STRICT_UNNAMED_STRUTURE_AFTER_IDENTIFIER

#define Z_STRICT_UNNAMED_UNION(body, identifier)		     \
	Z_COMPILER_STRICT_UNNAMED_UNION_BEFORE_STRUCT     union	     \
	Z_COMPILER_STRICT_UNNAMED_UNION_BEFORE_BODY	  body	     \
	Z_COMPILER_STRICT_UNNAMED_UNION_BEFORE_IDENTIFIER identifier \
	Z_COMPILER_STRICT_UNNAMED_UNION_AFTER_IDENTIFIER

#define Z_STRICT_UNNAMED_UNION_BEGIN			    \
	Z_COMPILER_STRICT_UNNAMED_UNION_BEFORE_STRUCT union \
	Z_COMPILER_STRICT_UNNAMED_UNION_BEFORE_BODY

#define Z_STRICT_UNNAMED_UNION_END(identifier)			     \
	Z_COMPILER_STRICT_UNNAMED_UNION_BEFORE_IDENTIFIER identifier \
	Z_COMPILER_STRICT_UNNAMED_UNION_AFTER_IDENTIFIER
