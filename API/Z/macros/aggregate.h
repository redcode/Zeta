...
#define Z_STRICT_STRUCTURE(body) \
	Z_STRICT_SIZE_BEGIN struct body Z_STRICT_SIZE_END

#define Z_STRICT_UNION(body) \
	Z_STRICT_SIZE_BEGIN union body Z_STRICT_SIZE_END
...
#define Z_ENDIANIZED_MEMBERS(bits, member_count)	  \
	Z_APPEND_TERNARY(Z_CPU_ENDIANNESS(INTEGER, bits)) \
		(Z_MEMBERIZE_, REVERSED_##member_count, member_count)
