...
#define Z_CALL_WITH_TYPE_1(macro)      macro(CHAR)
...
#define Z_CALL_WITH_TYPE_2(macro)      macro(UCHAR)
...
#define Z_CALL_WITH_TYPE_3(macro)      macro(SCHAR)
...
#define Z_CALL_WITH_TYPE_4(macro)      macro(USHORT)
...
#define Z_CALL_WITH_TYPE_5(macro)      macro(SSHORT)
...
#define Z_CALL_WITH_TYPE_6(macro)      macro(UINT)
...
#define Z_CALL_WITH_TYPE_7(macro)      macro(SINT)
...
#define Z_CALL_WITH_TYPE_8(macro)      macro(ULONG)
...
#define Z_CALL_WITH_TYPE_9(macro)      macro(SLONG)
...
#define Z_CALL_WITH_TYPE_10(macro)     macro(ULLONG)
...
#define Z_CALL_WITH_TYPE_11(macro)     macro(SLLONG)
...
#define Z_CALL_WITH_TYPE_13(macro)     macro(WCHAR)
...
#define Z_CALL_WITH_TYPE_14(macro)     macro(CHAR8)
...
#define Z_CALL_WITH_TYPE_15(macro)     macro(CHAR16)
...
#define Z_CALL_WITH_TYPE_16(macro)     macro(CHAR32)
...
#define Z_CALL_WITH_TYPE_17(macro)     macro(FLOAT)
...
#define Z_CALL_WITH_TYPE_18(macro)     macro(DOUBLE)
...
#define Z_CALL_WITH_TYPE_19(macro)     macro(LDOUBLE)
...
#define Z_CALL_WITH_TYPE_20(macro)     macro(FLOAT16)
...
#define Z_CALL_WITH_TYPE_21(macro)     macro(FLOAT32)
...
#define Z_CALL_WITH_TYPE_22(macro)     macro(FLOAT64)
...
#define Z_CALL_WITH_TYPE_23(macro)     macro(FLOAT128)
...
#define Z_CALL_WITH_TYPE_24(macro)     macro(FLOAT32X)
...
#define Z_CALL_WITH_TYPE_25(macro)     macro(FLOAT64X)
...
#define Z_CALL_WITH_TYPE_26(macro)     macro(FLOAT128X)
...
#define Z_CALL_WITH_TYPE_27(macro)     macro(DECIMAL32)
...
#define Z_CALL_WITH_TYPE_28(macro)     macro(DECIMAL64)
...
#define Z_CALL_WITH_TYPE_29(macro)     macro(DECIMAL128)
...
#define Z_CALL_WITH_TYPE_30(macro)     macro(DECIMAL64X)
...
#define Z_CALL_WITH_TYPE_31(macro)     macro(DECIMAL128X)
...
#define Z_CALL_WITH_TYPE_100(macro)    macro(UINT8)
...
#define Z_CALL_WITH_TYPE_101(macro)    macro(SINT8)
...
#define Z_CALL_WITH_TYPE_102(macro)    macro(UINT16)
...
#define Z_CALL_WITH_TYPE_103(macro)    macro(SINT16)
...
#define Z_CALL_WITH_TYPE_104(macro)    macro(UINT24)
...
#define Z_CALL_WITH_TYPE_105(macro)    macro(SINT24)
...
#define Z_CALL_WITH_TYPE_106(macro)    macro(UINT32)
...
#define Z_CALL_WITH_TYPE_107(macro)    macro(SINT32)
...
#define Z_CALL_WITH_TYPE_108(macro)    macro(UINT40)
...
#define Z_CALL_WITH_TYPE_109(macro)    macro(SINT40)
...
#define Z_CALL_WITH_TYPE_110(macro)    macro(UINT48)
...
#define Z_CALL_WITH_TYPE_111(macro)    macro(SINT48)
...
#define Z_CALL_WITH_TYPE_112(macro)    macro(UINT56)
...
#define Z_CALL_WITH_TYPE_113(macro)    macro(SINT56)
...
#define Z_CALL_WITH_TYPE_114(macro)    macro(UINT64)
...
#define Z_CALL_WITH_TYPE_115(macro)    macro(SINT64)
...
#define Z_CALL_WITH_TYPE_116(macro)    macro(UINT128)
...
#define Z_CALL_WITH_TYPE_117(macro)    macro(SINT128)
...
#define Z_CALL_WITH_TYPE_150(macro)    macro(BFP16)
...
#define Z_CALL_WITH_TYPE_151(macro)    macro(BFP32)
...
#define Z_CALL_WITH_TYPE_152(macro)    macro(BFP64)
...
#define Z_CALL_WITH_TYPE_153(macro)    macro(BFP128)
...
#define Z_CALL_WITH_TYPE_154(macro)    macro(DFP32)
...
#define Z_CALL_WITH_TYPE_155(macro)    macro(DFP64)
...
#define Z_CALL_WITH_TYPE_156(macro)    macro(DFP128)
...
#define Z_CALL_WITH_TYPE_157(macro)    macro(X87_DE80)
...
#define Z_CALL_WITH_TYPE_158(macro)    macro(X87_DE96)
...
#define Z_CALL_WITH_TYPE_159(macro)    macro(X87_DE128)
...
#define Z_CALL_WITH_BASE_TYPE( TYPE) Z_JOIN_2(Z_CALL_WITH_TYPE_,       TYPE##_FUNDAMENTAL      )
