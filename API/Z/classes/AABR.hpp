...
#ifndef _Z_classes_AABR_HPP_
#define _Z_classes_AABR_HPP_

#include <Z/classes/Line2D.hpp>
...
#	define Z_THIS ((AABR *)this)
	...
	struct Part<AABR, T, Z_NUMBER_SET_R> {
		...
		Z_CT_MEMBER(CPP11) Zeta::XY<T> absolute_point_to_unit(const Zeta::XY<T> &point)
		...
		Z_CT_MEMBER(CPP11) Zeta::XY<T> unit_point_to_absolute(Zeta::XY<T> point)
...
namespace Zeta {template <class T> struct AABR : Line2D<T>, Partials::Rectangle::Part<AABR<T>, T, Type<T>::number_set> {
	...
	Z_CT_MEMBER(CPP11) AABR(const XY<T> &a, const XY<T> &b) : Line2D<T>(a, b)		  {}
	Z_CT_MEMBER(CPP11) AABR(const XY<T> &a, T b_x, T b_y)	  : Line2D<T>(a, b_x, b_y)	  {}
	Z_CT_MEMBER(CPP11) AABR(const XY<T> &a, T b_xy)		  : Line2D<T>(a, b_xy)		  {}
	Z_CT_MEMBER(CPP11) AABR(T a_x, T a_y, const XY<T> &b)	  : Line2D<T>(a_x, a_y, b)	  {}
	...
	Z_CT_MEMBER(CPP11) AABR(T a_xy, const XY<T> &b)		  : Line2D<T>(a_xy, b)		  {}
	...
	Z_CT_MEMBER(CPP11) AABR align_in_bottom_center(const XY<T> &size) const
		{
	...
	Z_CT_MEMBER(CPP11) AABR align_in_bottom_left(const XY<T> &size) const
		{
	...
	Z_CT_MEMBER(CPP11) AABR align_in_bottom_right(const XY<T> &size) const
		{
	...
	Z_CT_MEMBER(CPP11) AABR align_in_center(const XY<T> &size) const
		{
		object.b.x = (object.a.x += (object.b.x - object.a.x - size.x) / (z##type)2) + size.x;
	...
	Z_CT_MEMBER(CPP11) AABR align_in_center_left(const XY<T> &size) const
		{
		object.b.x = object.a.x + size.x;
		object.b.y = (object.a.y += (object.b.y - object.a.y - size.y) / (z##type)2) + size.y;
		return object;
	...
	Z_CT_MEMBER(CPP11) AABR align_in_center_right(const XY<T> &size) const
		{
		object.a.x = object.b.x - size.x;
		object.b.y = (object.a.y += (object.b.y - object.a.y - size.y) / (z##type)2) + size.y;
		return object;
	...
	Z_CT_MEMBER(CPP11) AABR align_in_top_center(const XY<T> &size) const
		{
	...
	Z_CT_MEMBER(CPP11) AABR align_in_top_left(const XY<T> &size) const
		{
		object.a.y = object.b.y - size.y;
		object.b.x = object.a.x + size.x;
		return object;
	...
	Z_CT_MEMBER(CPP11) AABR align_in_top_right(const XY<T> &size) const
		{
		object.a.x = object.b.x - size.x;
		object.a.y = object.b.y - size.y;
		return object;
	...
	Z_CT_MEMBER(CPP11) XY<T> bottom_center() const
	...
	Z_CT_MEMBER(CPP11) XY<T> bottom_left() const
		{return this->a;}
	...
	Z_CT_MEMBER(CPP11) XY<T> bottom_right() const
		{return XY<T>(this->b.x, this->a.y);}
	...
	Z_CT_MEMBER(CPP11) XY<T> center_left() const
		{return XY<T>(this->a.x, (this->a.y + this->b.y) / T(2));}


	Z_CT_MEMBER(CPP11) XY<T> center_right() const
	...
	Z_CT_MEMBER(CPP11) XY<T> size()
		{return this->b - this->a;}


	Z_CT_MEMBER(CPP11) AABR fit_in_bottom_center(const XY<T> &size size)
		{
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_bottom_left(const XY<T> &size)
		{
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_bottom_right(const XY<T> &size)
		{
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_center(const XY<T> &size)
		{
		Z2D##Type old_size = z_aabr_##type##_size(object);
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_center_left(const XY<T> &size)
		{
		Z2D##Type old_size = z_aabr_##type##_size(object);
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_center_right(const XY<T> &size)
		{
		Z2D##Type old_size = z_aabr_##type##_size(object);
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_top_center(const XY<T> &size)
		{
		Z2D##Type old_size = z_aabr_##type##_size(object);
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_top_left(const XY<T> &size)
		{
		size = z_2d_##type##_fit(size, z_aabr_##type##_size(object));
	...
	Z_CT_MEMBER(CPP11) AABR fit_in_top_right(const XY<T> &size)
		{
	...
	static Z_CT_MEMBER(CPP11) AABR from_vertices(const XY<T> &a, const XY<T> &b)
		{return AABR(a.minimum(b), a.maximum(b));}


	Z_CT_MEMBER(CPP11) AABR grow_from_bottom_center(const XY<T> &delta)
		{
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_bottom_left(const XY<T> &delta)
		{
		object.b.x += delta.x;
		object.b.y += delta.y;
		return object;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_bottom_right(const XY<T> &delta)
		{
		object.a.x -= delta.x;
		object.b.y += delta.y;
		return object;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_center(const XY<T> &delta)
		{
		z##type size_x = object.b.x - object.a.x;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_center_left(const XY<T> &delta)
		{
		z##type size_y = object.b.y - object.a.y;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_center_right(const XY<T> &delta)
		{
		z##type size_y = object.b.y - object.a.y;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_top_center(const XY<T> &delta)
		{
		z##type size_x = object.b.x - object.a.x;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_top_left(const XY<T> &delta)
		{
		object.b.x += delta.x;
		object.a.y -= delta.y;
		return object;
	...
	Z_CT_MEMBER(CPP11) AABR grow_from_top_right(const XY<T> &delta)
		{
		object.a.x -= delta.x;
		object.a.y -= delta.y;
		return object;
...
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_right_half()				\
	...
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_bottom_center(const XY<T> &delta)
	{											\
	z##type size_x = object.b.x - object.a.x;						\
												\
	object.b.x  = (object.a.x += delta.x / (z##type)2) + size_x - delta.x;			\
	...
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_bottom_left(const XY<T> &delta)
	{											\
	object.b.x -= delta.x;									\
	object.b.y -= delta.y;									\
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_bottom_right(const XY<T> &delta)\
	{											\
	object.a.x += delta.x;									\
	object.b.y -= delta.y;									\
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_center(const XY<T> &delta)
	{											\
	z##type size_x = object.b.x - object.a.x;						\
	z##type size_y = object.b.y - object.a.y;						\
												\
	...
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_center_left(const XY<T> &delta)
	{											\
	z##type size_y = object.b.y - object.a.y;						\
												\
	object.b.x -= delta.x;									\
	...
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_center_right(const XY<T> &delta)
	{											\
	z##type size_y = object.b.y - object.a.y;						\
												\
	object.a.x += delta.x;									\
	...
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_top_center(const XY<T> &delta)
	{											\
	z##type size_x = object.b.x - object.a.x;						\
												\
	object.b.x  = (object.a.x += delta.x / (z##type)2) + size_x - delta.x;			\
	...
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_top_left(const XY<T> &delta)
	{											\
	object.b.x -= delta.x;									\
	object.a.y += delta.y;									\
	return object;										\
												...
												\
												\
Z_CT_MEMBER(CPP11) ZAABR##Type z_aabr_##type##_shrink_from_top_right(const XY<T> &delta)
	{											\
	object.a.x += delta.x;									\
	object.a.y += delta.y;									\
	return object;										\
...
Z_CT_MEMBER(CPP11) AABR z_aabr_##type##_top_half()				\
	...
	return object;										\
												...
												\
												\
	Z_INLINE XY<T> top_left()
		{return XY<T>(this->a.x, this->b.y);}
												\
												\
