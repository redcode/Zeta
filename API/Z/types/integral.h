...
#define Z_NATURAL_T_TYPE(	      T) Z_JOIN_2(Z_APPEND_NUMBER_, Z_##T##_BITS)(zuint)
#define Z_NATURAL_T_FIXED_FUNDAMENTAL(T) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##T##_BITS)(Z_UINT, _FIXED_FUNDAMENTAL)
#define Z_INTEGER_T_TYPE(	      T) Z_JOIN_2(Z_APPEND_NUMBER_, Z_##T##_BITS)(zsint)
#define Z_INTEGER_T_FIXED_FUNDAMENTAL(T) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##T##_BITS)(Z_SINT, _FIXED_FUNDAMENTAL)
