...
#define Z_INTEGRAL_T_LITERAL(T) \
	Z_APPEND_TYPE(Z_##T##_FIXED_FUNDAMENTAL)(Z_)

#define Z_INTEGRAL_T_FUNDAMENTAL(T) \
	Z_INSERT_TYPE(Z_##T##_FIXED_FUNDAMENTAL)(Z_, _FUNDAMENTAL)

#define Z_INTEGRAL_T_MAXIMUM(T) \
	Z_##T(Z_INSERT_TYPE(Z_##T##_FIXED_FUNDAMENTAL)(Z_, _MAXIMUM_))

#define Z_NATURAL_T_TYPE(T) \
	Z_JOIN_2(Z_APPEND_NUMBER_, Z_##T##_WIDTH)(zuint)

#define Z_NATURAL_T_FIXED_FUNDAMENTAL(T) \
	Z_JOIN_2(Z_INSERT_NUMBER_, Z_##T##_WIDTH)(Z_UINT, _FIXED_FUNDAMENTAL)

#define Z_INTEGER_T_TYPE(T) \
	Z_JOIN_2(Z_APPEND_NUMBER_, Z_##T##_WIDTH)(zsint)

#define Z_INTEGER_T_FIXED_FUNDAMENTAL(T) \
	Z_JOIN_2(Z_INSERT_NUMBER_, Z_##T##_WIDTH)(Z_SINT, _FIXED_FUNDAMENTAL)
