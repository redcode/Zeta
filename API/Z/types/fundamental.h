...
#define Z_SINT8_NUMBER_FORMAT	   Z_CPU_FORMAT(INTEGER, 8)
...
#define Z_UINT16_ENDIANNESS	   Z_CPU_ENDIANNESS(INTEGRAL, 16)
...
#define Z_SINT16_NUMBER_FORMAT	   Z_CPU_FORMAT    (INTEGER,  16)
#define Z_SINT16_ENDIANNESS	   Z_CPU_ENDIANNESS(INTEGRAL, 16)
...
#define Z_UINT32_ENDIANNESS	   Z_CPU_ENDIANNESS(INTEGRAL, 32)
...
#define Z_SINT32_NUMBER_FORMAT	   Z_CPU_FORMAT    (INTEGER,  32)
#define Z_SINT32_ENDIANNESS	   Z_CPU_ENDIANNESS(INTEGRAL, 32)
...
#	define Z_UINT64_ENDIANNESS	   Z_CPU_ENDIANNESS(INTEGRAL, 64)
...
#	define Z_SINT64_NUMBER_FORMAT	   Z_CPU_FORMAT    (INTEGER,  64)
#	define Z_SINT64_ENDIANNESS	   Z_CPU_ENDIANNESS(INTEGRAL, 64)
...
#	define Z_UINT128_ENDIANNESS	    Z_CPU_ENDIANNESS(INTEGRAL, 128)
...
#	define Z_SINT128_NUMBER_FORMAT	    Z_CPU_FORMAT    (INTEGER,  128)
#	define Z_SINT128_ENDIANNESS	    Z_CPU_ENDIANNESS(INTEGRAL, 128)
