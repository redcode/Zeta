...
#define Z_REAL_T_BITS(		     T) Z_INSERT_TYPE(Z_##T##_FIXED_FUNDAMENTAL)(Z_, _BITS		 )
...
#	define Z_FLOAT_BITS		   Z_REAL_T_BITS		     (FLOAT)
...
#	define Z_DOUBLE_BITS		    Z_REAL_T_BITS		      (DOUBLE)
...
#	define Z_LDOUBLE_BITS		     Z_REAL_T_BITS		       (LDOUBLE)
...
#	define Z_FLOAT32X_BITS		      Z_REAL_T_BITS			(FLOAT32X)
...
#	define Z_FLOAT64X_BITS		      Z_REAL_T_BITS			(FLOAT64X)
...
#	define Z_FLOAT128X_BITS		       Z_REAL_T_BITS			 (FLOAT128X)
...
#	define Z_DECIMAL64X_BITS		Z_REAL_T_BITS			  (DECIMAL64X)
...
#	define Z_DECIMAL128X_BITS		 Z_REAL_T_BITS			   (DECIMAL128X)
...
#	define Z_REAL_BITS		  Z_REAL_T_BITS		      (REAL)
