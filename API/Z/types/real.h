...
#		if Z_FLOATING_POINT_HAS_QNAN(BFP16)
#			define Z_BFP16_QNAN Z_FLOATING_POINT_QNAN(BFP16)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(BFP16)
#			define Z_BFP16_SNAN Z_FLOATING_POINT_SNAN(BFP16)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(BFP32)
#			define Z_BFP32_QNAN Z_FLOATING_POINT_QNAN(BFP32)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(BFP32)
#			define Z_BFP32_SNAN Z_FLOATING_POINT_SNAN(BFP32)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(BFP64)
#			define Z_BFP64_QNAN Z_FLOATING_POINT_QNAN(BFP64)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(BFP64)
#			define Z_BFP64_SNAN Z_FLOATING_POINT_SNAN(BFP64)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(BFP128)
#			define Z_BFP128_QNAN Z_FLOATING_POINT_QNAN(BFP128)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(BFP128)
#			define Z_BFP128_SNAN Z_FLOATING_POINT_SNAN(BFP128)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(DFP32)
#			define Z_DFP32_QNAN Z_FLOATING_POINT_QNAN(DFP32)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(DFP32)
#			define Z_DFP32_SNAN Z_FLOATING_POINT_SNAN(DFP32)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(DFP64)
#			define Z_DFP64_QNAN Z_FLOATING_POINT_QNAN(DFP64)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(DFP64)
#			define Z_DFP64_SNAN Z_FLOATING_POINT_SNAN(DFP64)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(DFP128)
#			define Z_DFP128_QNAN Z_FLOATING_POINT_QNAN(DFP128)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(DFP128)
#			define Z_DFP128_SNAN Z_FLOATING_POINT_SNAN(DFP128)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(X87_DE80)
#			define Z_X87_DE80_QNAN Z_FLOATING_POINT_QNAN(X87_DE80)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(X87_DE80)
#			define Z_X87_DE80_SNAN Z_FLOATING_POINT_SNAN(X87_DE80)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(X87_DE96)
#			define Z_X87_DE96_QNAN Z_FLOATING_POINT_QNAN(X87_DE96)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(X87_DE96)
#			define Z_X87_DE96_SNAN Z_FLOATING_POINT_SNAN(X87_DE96)
#		endif
...
#		if Z_FLOATING_POINT_HAS_QNAN(X87_DE128)
#			define Z_X87_DE128_QNAN Z_FLOATING_POINT_QNAN(X87_DE128)
#		endif

#		if Z_FLOATING_POINT_HAS_SNAN(X87_DE128)
#			define Z_X87_DE128_SNAN Z_FLOATING_POINT_SNAN(X87_DE128)
#		endif
...
#define Z_REAL_TYPE(			TYPE) Z_APPEND_base_type (Z_##TYPE)(z )
#define Z_REAL_TYPE_LITERAL(		TYPE) Z_APPEND_BASE_TYPE (Z_##TYPE)(Z_)
#define Z_REAL_TYPE_FIXED_FUNDAMENTAL(	TYPE) Z_INSERT_BASE_TYPE (Z_##TYPE)(Z_, _FIXED_FUNDAMENTAL  )
#define Z_REAL_TYPE_DIGITS_10(		TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _DIGITS_10	    )
#define Z_REAL_TYPE_MAXIMUM_DIGITS_10(	TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _MAXIMUM_DIGITS_10  )
#define Z_REAL_TYPE_RADIX(		TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _RADIX		    )
#define Z_REAL_TYPE_SIGNIFICAND_DIGITS( TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _SIGNIFICAND_DIGITS )
#define Z_REAL_TYPE_EXPONENT_MAXIMUM(	TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _EXPONENT_MAXIMUM   )
#define Z_REAL_TYPE_EXPONENT_MINIMUM(	TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _EXPONENT_MINIMUM   )
#define Z_REAL_TYPE_EXPONENT_10_MAXIMUM(TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _EXPONENT_10_MAXIMUM)
#define Z_REAL_TYPE_EXPONENT_10_MINIMUM(TYPE) Z_INSERT_FIXED_TYPE(Z_##TYPE)(Z_, _EXPONENT_10_MINIMUM)
#define Z_REAL_TYPE_EPSILON(		TYPE) Z_##TYPE(Z_INSERT_NUMBER_FORMAT(Z_##TYPE)(Z_, _EPSILON))
#define Z_REAL_TYPE_MAXIMUM(		TYPE) Z_##TYPE(Z_INSERT_NUMBER_FORMAT(Z_##TYPE)(Z_, _MAXIMUM))
#define Z_REAL_TYPE_MINIMUM(		TYPE) Z_##TYPE(Z_INSERT_NUMBER_FORMAT(Z_##TYPE)(Z_, _MINIMUM))
#define Z_REAL_TYPE_DENORMAL_MINIMUM(	TYPE) Z_##TYPE(Z_INSERT_NUMBER_FORMAT(Z_##TYPE)(Z_, _DENORMAL_MINIMUM))
#define Z_REAL_TYPE_HAS_INFINITY(	TYPE) Z_CALL_WITH_BASE_TYPE(Z_##TYPE)(Z_FLOATING_POINT_HAS_INFINITY)
#define Z_REAL_TYPE_HAS_QNAN(		TYPE) Z_CALL_WITH_BASE_TYPE(Z_##TYPE)(Z_FLOATING_POINT_HAS_QNAN	   )
#define Z_REAL_TYPE_HAS_SNAN(		TYPE) Z_CALL_WITH_BASE_TYPE(Z_##TYPE)(Z_FLOATING_POINT_HAS_SNAN	   )
#define Z_REAL_TYPE_INFINITY(		TYPE) Z_CALL_WITH_BASE_TYPE(Z_##TYPE)(Z_FLOATING_POINT_INFINITY	   )
#define Z_REAL_TYPE_QNAN(		TYPE) Z_CALL_WITH_BASE_TYPE(Z_##TYPE)(Z_FLOATING_POINT_QNAN	   )
#define Z_REAL_TYPE_SNAN(		TYPE) Z_CALL_WITH_BASE_TYPE(Z_##TYPE)(Z_FLOATING_POINT_SNAN	   )
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT)
#		define Z_FLOAT_QNAN Z_FLOATING_POINT_QNAN(FLOAT)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT)
#		define Z_FLOAT_SNAN Z_FLOATING_POINT_SNAN(FLOAT)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(DOUBLE)
#		define Z_DOUBLE_QNAN Z_FLOATING_POINT_QNAN(DOUBLE)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(DOUBLE)
#		define Z_DOUBLE_SNAN Z_FLOATING_POINT_SNAN(DOUBLE)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(LDOUBLE)
#		define Z_LDOUBLE_QNAN Z_FLOATING_POINT_QNAN(LDOUBLE)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(LDOUBLE)
#		define Z_LDOUBLE_SNAN Z_FLOATING_POINT_SNAN(LDOUBLE)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT16)
#		define Z_FLOAT16_QNAN Z_FLOATING_POINT_QNAN(FLOAT16)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT16)
#		define Z_FLOAT16_SNAN Z_FLOATING_POINT_SNAN(FLOAT16)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT32)
#		define Z_FLOAT32_QNAN Z_FLOATING_POINT_QNAN(FLOAT32)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT32)
#		define Z_FLOAT32_SNAN Z_FLOATING_POINT_SNAN(FLOAT32)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT64)
#		define Z_FLOAT64_QNAN Z_FLOATING_POINT_QNAN(FLOAT64)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT64)
#		define Z_FLOAT64_SNAN Z_FLOATING_POINT_SNAN(FLOAT64)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT128)
#		define Z_FLOAT128_QNAN Z_FLOATING_POINT_QNAN(FLOAT128)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT128)
#		define Z_FLOAT128_SNAN Z_FLOATING_POINT_SNAN(FLOAT128)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT32X)
#		define Z_FLOAT32X_QNAN Z_FLOATING_POINT_QNAN(FLOAT32X)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT32X)
#		define Z_FLOAT32X_SNAN Z_FLOATING_POINT_SNAN(FLOAT32X)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT64X)
#		define Z_FLOAT64X_QNAN Z_FLOATING_POINT_QNAN(FLOAT64X)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT64X)
#		define Z_FLOAT64X_SNAN Z_FLOATING_POINT_SNAN(FLOAT64X)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(FLOAT128X)
#		define Z_FLOAT128X_QNAN Z_FLOATING_POINT_QNAN(FLOAT128X)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(FLOAT128X)
#		define Z_FLOAT128X_SNAN Z_FLOATING_POINT_SNAN(FLOAT128X)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(DECIMAL32)
#		define Z_DECIMAL32_QNAN Z_FLOATING_POINT_QNAN(DECIMAL32)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(DECIMAL32)
#		define Z_DECIMAL32_SNAN Z_FLOATING_POINT_SNAN(DECIMAL32)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(DECIMAL64)
#		define Z_DECIMAL64_QNAN Z_FLOATING_POINT_QNAN(DECIMAL64)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(DECIMAL64)
#		define Z_DECIMAL64_SNAN Z_FLOATING_POINT_SNAN(DECIMAL64)
#	endif
...
#	if Z_FLOATING_POINT_HAS_QNAN(DECIMAL128)
#		define Z_DECIMAL128_QNAN Z_FLOATING_POINT_QNAN(DECIMAL128)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(DECIMAL128)
#		define Z_DECIMAL128_SNAN Z_FLOATING_POINT_SNAN(DECIMAL128)
#	endif
...
#	if Z_FLOATING_POINT_HAS_INFINITY(DECIMAL64X)
#		define Z_DECIMAL64X_INFINITY Z_FLOATING_POINT_INFINITY(DECIMAL64X)
#	endif

#	if Z_FLOATING_POINT_HAS_QNAN(DECIMAL64X)
#		define Z_DECIMAL64X_QNAN Z_FLOATING_POINT_QNAN(DECIMAL64X)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(DECIMAL64X)
#		define Z_DECIMAL64X_SNAN Z_FLOATING_POINT_SNAN(DECIMAL64X)
#	endif
...
#	if Z_FLOATING_POINT_HAS_INFINITY(DECIMAL128X)
#		define Z_DECIMAL128X_INFINITY Z_FLOATING_POINT_INFINITY(DECIMAL128X)
#	endif

#	if Z_FLOATING_POINT_HAS_QNAN(DECIMAL128X)
#		define Z_DECIMAL128X_QNAN Z_FLOATING_POINT_QNAN(DECIMAL128X)
#	endif

#	if Z_FLOATING_POINT_HAS_SNAN(DECIMAL128X)
#		define Z_DECIMAL128X_SNAN Z_FLOATING_POINT_SNAN(DECIMAL128X)
#	endif
...
#	if Z_REAL_TYPE_HAS_INFINITY(REAL)
#		define Z_REAL_INFINITY Z_REAL_TYPE_INFINITY(REAL)
#	endif

#	if Z_REAL_TYPE_HAS_QNAN(REAL)
#		define Z_REAL_QNAN Z_REAL_TYPE_QNAN(REAL)
#	endif

#	if Z_REAL_TYPE_HAS_SNAN(REAL)
#		define Z_REAL_SNAN Z_REAL_TYPE_SNAN(REAL)
#	endif
