...
#define Z_COMPILER_DIALECT_HAS(LANGUAGE, FEATURE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_##FEATURE)

#define Z_COMPILER_DIALECT_HAS_ATTRIBUTE(LANGUAGE, ATTRIBUTE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_ATTRIBUTE_##ATTRIBUTE)

#define Z_COMPILER_DIALECT_HAS_ESCAPE_SEQUENCE(LANGUAGE, ESCAPE_SEQUENCE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_ESCAPE_SEQUENCE_##ESCAPE_SEQUENCE)

#define Z_COMPILER_DIALECT_HAS_IDENTIFIER(LANGUAGE, IDENTIFIER) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_IDENTIFIER_##IDENTIFIER)

#define Z_COMPILER_DIALECT_HAS_LITERAL(LANGUAGE, LITERAL) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_LITERAL_##LITERAL)

#define Z_COMPILER_DIALECT_HAS_OPERATOR(LANGUAGE, OPERATOR) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_OPERATOR_##OPERATOR)

#define Z_COMPILER_DIALECT_HAS_OPERATOR_CASE(LANGUAGE, OPERATOR, CASE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_OPERATOR_CASE_##OPERATOR##_##CASE)

#define Z_COMPILER_DIALECT_HAS_PREPROCESSOR_DIRECTIVE(LANGUAGE, PREPROCESSOR_DIRECTIVE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_PREPROCESSOR_DIRECTIVE_##PREPROCESSOR_DIRECTIVE)

#define Z_COMPILER_DIALECT_HAS_PREPROCESSOR_IDENTIFIER(LANGUAGE, PREPROCESSOR_IDENTIFIER) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_PREPROCESSOR_IDENTIFIER_##PREPROCESSOR_IDENTIFIER)

#define Z_COMPILER_DIALECT_HAS_PREPROCESSOR_OPERATOR(LANGUAGE, PREPROCESSOR_OPERATOR) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_PREPROCESSOR_OPERATOR_##PREPROCESSOR_OPERATOR)

#define Z_COMPILER_DIALECT_HAS_SPECIFIER(LANGUAGE, SPECIFIER) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_SPECIFIER_##SPECIFIER)

#define Z_COMPILER_DIALECT_HAS_SPECIFIER_CASE(LANGUAGE, SPECIFIER, CASE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_SPECIFIER_CASE_##SPECIFIER##_##CASE)

#define Z_COMPILER_DIALECT_HAS_STD_PRAGMA(LANGUAGE, STD_PRAGMA) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_STD_PRAGMA_##STD_PRAGMA)

#define Z_COMPILER_DIALECT_HAS_STORAGE_CLASS(LANGUAGE, STORAGE_CLASS) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_STORAGE_CLASS_##STORAGE_CLASS)

#define Z_COMPILER_DIALECT_HAS_TYPE(LANGUAGE, TYPE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_TYPE_##TYPE)

#define Z_COMPILER_DIALECT_HAS_TYPE_MODIFIER(LANGUAGE, TYPE_MODIFIER) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_TYPE_MODIFIER_##TYPE_MODIFIER)

#define Z_COMPILER_DIALECT_HAS_TYPE_QUALIFIER(LANGUAGE, TYPE_QUALIFIER) \
	Z_IS_TRUE(Z_COMPILER_HAS_##LANGUAGE##_TYPE_QUALIFIER_##TYPE_QUALIFIER)

#define Z_COMPILER_HAS(FEATURE) \
	Z_IS_TRUE(Z_COMPILER_HAS_##FEATURE)

#define Z_COMPILER_HAS_ATTRIBUTE(ATTRIBUTE) \
	Z_IS_TRUE(Z_COMPILER_HAS_ATTRIBUTE_##ATTRIBUTE)

#define Z_COMPILER_HAS_CONSTANT(CONSTANT) \
	Z_IS_TRUE(Z_COMPILER_HAS_CONSTANT_##CONSTANT)

#define Z_COMPILER_HAS_FUNCTION(FUNCTION) \
	Z_IS_TRUE(Z_COMPILER_HAS_FUNCTION_##FUNCTION)

#define Z_COMPILER_HAS_LITERAL(LITERAL) \
	Z_IS_TRUE(Z_COMPILER_HAS_LITERAL_##LITERAL)

#define Z_COMPILER_HAS_MACRO(MACRO) \
	Z_IS_TRUE(Z_COMPILER_HAS_MACRO_##MACRO)

#define Z_COMPILER_HAS_MAGIC_CONSTANT(MAGIC_CONSTANT) \
	Z_IS_TRUE(Z_COMPILER_HAS_MAGIC_CONSTANT_##MAGIC_CONSTANT)

#define Z_COMPILER_HAS_TRAIT(TRAIT) \
	Z_IS_TRUE(Z_COMPILER_HAS_TRAIT_##TRAIT)

#define Z_COMPILER_HAS_TYPE(TYPE) \
	Z_IS_TRUE(Z_COMPILER_HAS_TYPE_##TYPE)

#define Z_COMPILER_ATTRIBUTE(ATTRIBUTE) \
	Z_COMPILER_ATTRIBUTE_##ATTRIBUTE

#define Z_COMPILER_CONSTANT(CONSTANT) \
	Z_COMPILER_CONSTANT_##CONSTANT

#define Z_COMPILER_FUNCTION(FUNCTION) \
	Z_COMPILER_FUNCTION_##FUNCTION

#define Z_COMPILER_LITERAL(LITERAL) \
	Z_COMPILER_LITERAL_##LITERAL

#define Z_COMPILER_MACRO(MACRO) \
	Z_COMPILER_MACRO_##MACRO

#define Z_COMPILER_MAGIC_CONSTANT(MAGIC_CONSTANT) \
	Z_COMPILER_MAGIC_CONSTANT_##MAGIC_CONSTANT

#define Z_COMPILER_TRAIT(TRAIT) \
	Z_COMPILER_TRAIT_##TRAIT

#define Z_COMPILER_TYPE(TYPE) \
	Z_COMPILER_TYPE_##TYPE
