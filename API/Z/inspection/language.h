...
#	define Z_LANGUAGE_HAS_MAGIC_CONSTANT(LANGUAGE, MAGIC_CONSTANT) \
		Z_##LANGUAGE##_FLAG(Z_##LANGUAGE##_HAS_MAGIC_CONSTANT_##MAGIC_CONSTANT)
...
#	define Z_LANGUAGE_HAS_MAGIC_CONSTANT(LANGUAGE, MAGIC_CONSTANT)		      \
		(Z_##LANGUAGE##_FLAG(Z_##LANGUAGE##_HAS_MAGIC_CONSTANT_##MAGIC_CONSTANT) && \
		 Z_##LANGUAGE##_FLAG(Z_COMPILER_##LANGUAGE##_HAS_MAGIC_CONSTANT_##MAGIC_CONSTANT))
