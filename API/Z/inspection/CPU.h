...
#ifndef Z_inspection_CPU_H_
#define Z_inspection_CPU_H_
...
#if Z_CPU_INTEGRAL_ENDIANNESS != Z_ENDIANNESS_MIXED

#	define Z_CPU_INTEGRAL_ENDIANNESS_16BIT  Z_CPU_INTEGRAL_ENDIANNESS
#	define Z_CPU_INTEGRAL_ENDIANNESS_32BIT  Z_CPU_INTEGRAL_ENDIANNESS
#	define Z_CPU_INTEGRAL_ENDIANNESS_64BIT  Z_CPU_INTEGRAL_ENDIANNESS
#	define Z_CPU_INTEGRAL_ENDIANNESS_128BIT Z_CPU_INTEGRAL_ENDIANNESS

#else

#	if defined(Z_CPU_INTEGRAL_ENDIANNESS_16BIT) && Z_CPU_INTEGRAL_ENDIANNESS_16BIT == Z_ENDIANNESS_MIXED
#		undef Z_CPU_INTEGRAL_ENDIANNESS_16BIT
#	endif
...
#	if defined(Z_CPU_INTEGRAL_ENDIANNESS_32BIT) && Z_CPU_INTEGRAL_ENDIANNESS_32BIT == Z_ENDIANNESS_MIXED
#		undef Z_CPU_INTEGRAL_ENDIANNESS_32BIT
#	endif
...
#	if defined(Z_CPU_INTEGRAL_ENDIANNESS_64BIT) && Z_CPU_INTEGRAL_ENDIANNESS_64BIT == Z_ENDIANNESS_MIXED
#		undef Z_CPU_INTEGRAL_ENDIANNESS_64BIT
#	endif
...
#	if defined(Z_CPU_INTEGRAL_ENDIANNESS_128BIT) && Z_CPU_INTEGRAL_ENDIANNESS_128BIT == Z_ENDIANNESS_MIXED
#		undef Z_CPU_INTEGRAL_ENDIANNESS_128BIT
#	endif
...
#		define Z_CPU_INTEGER_FORMAT_128BIT Z_NUMBER_FORMAT_128BIT_2S_COMPLEMENT_INTEGER
...
#		define Z_CPU_INTEGER_FORMAT_128BIT Z_NUMBER_FORMAT_128BIT_1S_COMPLEMENT_INTEGER
...
#define Z_CPU_ARCHITECTURE_IS(WHICH ) (Z_CPU_ARCHITECTURE == Z_CPU_ARCHITECTURE_##WHICH)
