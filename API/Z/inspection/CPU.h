...
#ifdef Z_CPU_INTEGRAL_ENDIANNESS_ALL
#	define Z_CPU_INTEGRAL_ENDIANNESS(bits) Z_CPU_INTEGRAL_ENDIANNESS_ALL
#else

#	ifndef Z_CPU_INTEGRAL_ENDIANNESS_16BIT
#		if defined(Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_16BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL
#		elif defined(Z_COMPILER_CPU_ENDIANNESS_16BIT_INTEGRAL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_16BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_16BIT
#		endif
#	endif

#	ifndef Z_CPU_INTEGRAL_ENDIANNESS_32BIT
#		if defined(Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_32BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL
#		elif defined(Z_COMPILER_CPU_ENDIANNESS_32BIT_INTEGRAL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_32BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_32BIT
#		endif
#	endif

#	ifndef Z_CPU_INTEGRAL_ENDIANNESS_64BIT
#		if defined(Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_64BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL
#		elif defined(Z_COMPILER_CPU_ENDIANNESS_64BIT_INTEGRAL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_64BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_64BIT
#		endif
#	endif

#	ifndef Z_CPU_INTEGRAL_ENDIANNESS_128BIT
#		if defined(Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL)
#			define Z_CPU_INTEGRAL_ENDIANNESS_128BIT Z_COMPILER_CPU_INTEGRAL_ENDIANNESS_ALL
#		elif defined(Z_COMPILER_CPU_ENDIANNESS_128BIT_INTEGRAL)
...
#	ifndef Z_CPU_INTEGER_FORMAT_8BIT
#		if defined(Z_COMPILER_CPU_INTEGER_FORMAT_8BIT)
...
#				define Z_CPU_INTEGER_FORMAT_8BIT Z_NUMBER_FORMAT_2S_COMPLEMENT_8BIT_INTEGER

#			elif Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_1S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_8BIT Z_NUMBER_FORMAT_1S_COMPLEMENT_8BIT_INTEGER
#			endif
#		endif
#	endif

#	ifndef Z_CPU_INTEGER_FORMAT_16BIT
#		if defined(Z_COMPILER_CPU_INTEGER_FORMAT_16BIT)
#			define Z_CPU_INTEGER_FORMAT_16BIT Z_COMPILER_CPU_INTEGER_FORMAT_16BIT

#		elif defined(Z_COMPILER_CPU_INTEGER_FORMAT_ALL)
#			if Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_2S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_16BIT Z_NUMBER_FORMAT_2S_COMPLEMENT_16BIT_INTEGER

#			elif Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_1S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_16BIT Z_NUMBER_FORMAT_1S_COMPLEMENT_16BIT_INTEGER
#			endif
#		endif
#	endif

#	ifndef Z_CPU_INTEGER_FORMAT_32BIT
#		if defined(Z_COMPILER_CPU_INTEGER_FORMAT_32BIT)
#			define Z_CPU_INTEGER_FORMAT_32BIT Z_COMPILER_CPU_INTEGER_FORMAT_32BIT

#		elif defined(Z_COMPILER_CPU_INTEGER_FORMAT_ALL)
#			if Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_2S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_32BIT Z_NUMBER_FORMAT_2S_COMPLEMENT_32BIT_INTEGER

#			elif Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_1S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_32BIT Z_NUMBER_FORMAT_1S_COMPLEMENT_32BIT_INTEGER
#			endif
#		endif
#	endif

#	ifndef Z_CPU_INTEGER_FORMAT_64BIT
#		if defined(Z_COMPILER_CPU_INTEGER_FORMAT_64BIT)
#			define Z_CPU_INTEGER_FORMAT_64BIT Z_COMPILER_CPU_INTEGER_FORMAT_64BIT

#		elif defined(Z_COMPILER_CPU_INTEGER_FORMAT_ALL)
#			if Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_2S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_64BIT Z_NUMBER_FORMAT_2S_COMPLEMENT_64BIT_INTEGER

#			elif Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_1S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_64BIT Z_NUMBER_FORMAT_1S_COMPLEMENT_64BIT_INTEGER
#			endif
#		endif
#	endif

#	ifndef Z_CPU_INTEGER_FORMAT_128BIT
#		if defined(Z_COMPILER_CPU_INTEGER_FORMAT_128BIT)
#			define Z_CPU_INTEGER_FORMAT_128BIT Z_COMPILER_CPU_INTEGER_FORMAT_128BIT

#		elif defined(Z_COMPILER_CPU_INTEGER_FORMAT_ALL)
#			if Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_2S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_128BIT Z_NUMBER_FORMAT_2S_COMPLEMENT_128BIT_INTEGER

#			elif Z_COMPILER_CPU_INTEGER_FORMAT_ALL == Z_INTEGER_FORMAT_1S_COMPLEMENT
#				define Z_CPU_INTEGER_FORMAT_128BIT Z_NUMBER_FORMAT_1S_COMPLEMENT_128BIT_INTEGER
#			endif
#		endif
#	endif
