...
#define Z_CPP_HAS_ATTRIBUTES_FOR_ENUMERATION			     TRUE /* N4266    _­_­cpp_­enumerator_­attributes	    >= 201411L */
#define Z_CPP_HAS_ATTRIBUTES_FOR_NAMESPACE			     TRUE /* N4266    _­_­cpp_­namespace_­attributes	    >= 201411L */
...
#define Z_CPP_HAS_CPP17_RULES_ON_EXPRESSION_EVALUATION_ORDER	     TRUE /* P0145R3
									     P0400R0						       */
#define Z_CPP_HAS_CPP17_RULES_ON_INHERITING_CONSTRUCTORS	     TRUE /* P0136R1  _­_­cpp_­inheriting_­constructors	    >= 201511L */
#define Z_CPP_HAS_CPP17_RULES_ON_NON_TYPE_TEMPLATE_ARGUMENTS	     TRUE /* N4268    _­_­cpp_­nontype_­template_­args	    >= 201411L */
#define Z_CPP_HAS_CPP17_RULES_ON_TEMPLATE_TEMPLATE_ARGUMENT_MATCHING TRUE /* P0522R0  _­_­cpp_­template_­template_­args	    >= 201611L */
#define Z_CPP_HAS_DIFFERING_BEGIN_AND_END_TYPES_IN_RANGE_BASED_FOR   TRUE /* P0184R0  _­_­cpp_­range_­based_­for		    >= 201603L */
#define Z_CPP_HAS_DIRECT_LIST_INITIALIZATION_FOR_ENUMERATION	     TRUE /* P0138R2						       */
#define Z_CPP_HAS_NOEXCEPT_AS_PART_OF_THE_TYPE			     TRUE /* P0012R1  _­_­cpp_­noexcept_­function_­type	    >= 201510L */
#define Z_CPP_HAS_FOLD_EXPRESSION				     TRUE /* N4295    _­_­cpp_­fold_­expressions		    >= 201411L */
#define Z_CPP_HAS_FOLD_EXPRESSION_SAFETY_WITH_EMPTY_PARAMETER_PACK   TRUE /* P0036R0  __cpp_fold_expressions		    >= 201603L */
#define Z_CPP_HAS_GUARANTEED_COPY_ELISION			     TRUE /* P0135R1  _­_­cpp_­guaranteed_­copy_­elision	    >= 201606L */
#define Z_CPP_HAS_IF_WITH_INITIALIZER				     TRUE /* P0305R1						       */
#define Z_CPP_HAS_IGNORATION_OF_UNKNOWN_ATTRIBUTES		     TRUE /* P0283R2						       */
#define Z_CPP_HAS_LAMBDA_CAPTURE_OF_THIS_OBJECT_BY_VALUE	     TRUE /* P0018R3  _­_­cpp_­capture_­star_­this		    >= 201603L */
#define Z_CPP_HAS_LAUNDER /* Not a good name */			     TRUE /* P0137R1						       */
#define Z_CPP_HAS_NESTED_NAMESPACE_DEFINITION			     TRUE /* N4230						       */
#define Z_CPP_HAS_NON_TYPE_TEMPLATE_PARAMETER_WITH_AUTO_TYPE	     TRUE /* P0127R2  _­_­cpp_­nontype_­template_­parameter_­auto >= 201606L */
#define Z_CPP_HAS_OVER_ALIGNED_DYNAMIC_ALLOCATION		     TRUE /* P0035R4  _­_­cpp_­aligned_­new			    >= 201606L */
...
#define Z_CPP_HAS_STATIC_ASSERTION_WITH_NO_MESSAGE		     TRUE /* N3928    _­_­cpp_­static_­assert		    >= 201411L */
#define Z_CPP_HAS_STRUCTURED_BINDING				     TRUE /* P0217R3  _­_­cpp_­structured_­bindings		    >= 201606L */
...
#define Z_CPP_HAS_TEMPLATE_ARGUMENT_DEDUCTION_FOR_CLASS_TEMPLATE     TRUE /* P0091R3  __cpp_deduction_guides		    >= 201606L
									     ...
									     P0620R0  _­_­cpp_­deduction_­guides		    >= 201703L */
#define Z_CPP_HAS_TYPENAME_IN_TEMPLATE_TEMPLATE_PARAMETER	     TRUE /* N4051						       */
#define Z_CPP_HAS_VARIADIC_USING				     TRUE /* P0195R2  _­_­cpp_­variadic_­using		    >= 201611L */
...
#define Z_CPP_HAS_LITERAL_HEXADECIMAL_FLOATING_POINT		     TRUE /* P0245R1  _­_­cpp_­hex_­float			    >= 201603L */
...
#define Z_CPP_HAS_SPECIFIER_CASE_CONSTEXPR_IF			     TRUE /* P0292R2  _­_­cpp_­if_­constexpr		    >= 201606L */
#define Z_CPP_HAS_SPECIFIER_CASE_CONSTEXPR_LAMBDA		     TRUE /* P0170R1  __cpp_constexpr			    >= 201603L */
#define Z_CPP_HAS_SPECIFIER_CASE_INLINE_VARIABLE		     TRUE /* P0386R2  _­_­cpp_­inline_­variables		    >= 201606L */
