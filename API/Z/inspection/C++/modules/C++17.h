...
#define Z_CPP_HAS_CONSTEXPR_IF					   TRUE /* P0292R2  __cpp_if_constexpr			  >= 201606L (!) */
#define Z_CPP_HAS_CONSTEXPR_LAMBDA				   TRUE /* P0170R1  __cpp_constexpr			  >= 201603L (+) */
#define Z_CPP_HAS_CPP17_AUTO_DEDUCTION_FROM_LIST_INITIALIZATION	   TRUE /* N3922   							 */
#define Z_CPP_HAS_CPP17_EXPRESSION_EVALUATION_ORDER		   TRUE /* P0145R3 							 */
#define Z_CPP_HAS_CPP17_INHERITING_CONSTRUCTORS			   TRUE /* P0136R1  __cpp_inheriting_constructors	  >= 201511L (+) */
#define Z_CPP_HAS_CPP17_NON_TYPE_TEMPLATE_ARGUMENTS		   TRUE /* N4268    __cpp_nontype_template_args		  >= 201411L (!) */
#define Z_CPP_HAS_CPP17_TEMPLATE_TEMPLATE_ARGUMENT_MATCHING	   TRUE /* P0522R0  __cpp_template_template_args	  >= 201611L (!) */
#define Z_CPP_HAS_DEDUCTION_GUIDES_FOR_CLASS_TEMPLATE		   TRUE /* P0091R3  __cpp_deduction_guides		  >= 201606L (!)
...
#define Z_CPP_HAS_DIRECT_LIST_INITIALIZATION_FOR_FIXED_ENUMERATION TRUE /* P0138R2 							 */
...
#define Z_CPP_HAS_IGNORING_OF_UNKNOWN_ATTRIBUTES		   TRUE /* P0283R2 							 */
#define Z_CPP_HAS_INLINE_VARIABLE				   TRUE /* P0386R2  __cpp_inline_variables		  >= 201606L (!) */
#define Z_CPP_HAS_LAMBDA_CAPTURE_OF_STAR_THIS_BY_VALUE		   TRUE /* P0018R3  __cpp_capture_star_this		  >= 201603L (!) */
#define Z_CPP_HAS_NESTED_NAMESPACE_DEFINITION			   TRUE /* N4230    __cpp_nested_namespace_definitions    >= 201411L (?) */
#define Z_CPP_HAS_NOEXCEPT_AS_PART_OF_THE_FUNCTION_TYPE		   TRUE /* P0012R1  __cpp_noexcept_function_type	  >= 201510L (!) */
...
#define Z_CPP_HAS_OVER_ALIGNED_DYNAMIC_MEMORY_ALLOCATION	   TRUE /* P0035R4  __cpp_aligned_new			  >= 201606L (!) */
#define Z_CPP_HAS_REMOVAL_OF_DYNAMIC_EXCEPTION_SPECIFICATION	   TRUE /* P0003R5 							 */
#define Z_CPP_HAS_REMOVAL_OF_BOOL_INCREMENT			   TRUE /* P0002R1 							 */
#define Z_CPP_HAS_REMOVAL_OF_REGISTER_AS_STORAGE_CLASS		   TRUE /* P0001R1 							 */
#define Z_CPP_HAS_REMOVAL_OF_TRIGRAPHS				   TRUE /* N4086   							 */
#define Z_CPP_HAS_SAFE_UNARY_FOLD_EXPRESSION			   TRUE /* P0036R0  __cpp_fold_expressions		  >= 201603L (+) */
...
#define Z_CPP_HAS_LITERAL_UTF8_CHARACTER			   TRUE /* N4267    __cpp_unicode_characters		  >= 201411L (?) */
#define Z_CPP_HAS_PREPROCESSOR_OPERATOR_HAS_INCLUDE		   TRUE /* P0061R1  defined(__has_include)				 */
