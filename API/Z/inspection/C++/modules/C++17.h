...
#define Z_CPP_HAS_AGGREGATE_INITIALIZATION_FOR_DERIVED_CLASS	     TRUE /* P0017R1 */
...
#define Z_CPP_HAS_NOEXCEPT_AS_PART_OF_THE_TYPE			     TRUE /* P0012R1 */
...
#define Z_CPP_HAS_TEMPLATE_ARGUMENT_DEDUCTION_FOR_CLASS_TEMPLATE     TRUE /* P0091R3, P0512R0, P0620R0 */
#define Z_CPP_HAS_TYPENAME_IN_TEMPLATE_TEMPLATE_PARAMETER	     TRUE /* N4051   */
#define Z_CPP_HAS_VARIADIC_USING				     TRUE /* P0195R2 */
#define Z_CPP_HAS_ATTRIBUTE_FALLTHROUGH				     TRUE /* P0188R1 */
#define Z_CPP_HAS_ATTRIBUTE_MAYBE_UNUSED			     TRUE /* P0212R1 */
#define Z_CPP_HAS_ATTRIBUTE_NODISCARD				     TRUE /* P0189R1 */
...
#define Z_CPP_HAS_SPECIFIER_CASE_CONSTEXPR_IF			     TRUE /* P0292R2 */
#define Z_CPP_HAS_SPECIFIER_CASE_CONSTEXPR_LAMBDA		     TRUE /* P0170R1 */
#define Z_CPP_HAS_SPECIFIER_CASE_INLINE_VARIABLE		     TRUE /* P0386R2 */
