...
#define Z_COMPILER_C_HAS_OPERATOR_SIZE_OF	1
#define Z_COMPILER_C_HAS_STORAGE_CLASS_AUTO	1
#define Z_COMPILER_C_HAS_STORAGE_CLASS_EXTERN	1
#define Z_COMPILER_C_HAS_STORAGE_CLASS_REGISTER 1
#define Z_COMPILER_C_HAS_STORAGE_CLASS_STATIC	1
#define Z_COMPILER_C_HAS_TYPE_FLOAT		1
#define Z_COMPILER_C_HAS_TYPE_DOUBLE		1

/* MARK: - C89 support */

#define Z_COMPILER_C_HAS_ENUMERATION		 1
#define Z_COMPILER_C_HAS_VOID_POINTER		 1
#define Z_COMPILER_C_HAS_TYPE_LDOUBLE		 1
#define Z_COMPILER_C_HAS_TYPE_QUALIFIER_CONSTANT 1
#define Z_COMPILER_C_HAS_TYPE_QUALIFIER_VOLATILE 1
...
#	define Z_COMPILER_C_HAS_DIGRAPHS 1
#endif
...
#	define Z_COMPILER_C_HAS_INLINE_FUNCION 1
#endif

#if defined(__UINTMAX_MAX__) && 0U - 1U == __UINTMAX_MAX__
#	define Z_COMPILER_C_HAS_PREPROCESSOR_ARITHMETIC_DONE_IN_MAXIMUM_INTEGRAL 1
#endif

#if Z_COMPILER_VERSION >= Z_VERSION(2,95,0)
#	define Z_COMPILER_C_HAS_TYPE_QUALIFIER_RESTRICT 1
#endif

#if defined(__STDC_VERSION__) && __STDC_VERSION__ >= 199901L

#	if /*Z_COMPILER_VERSION >= Z_VERSION(0, 9, 0) &&*/ !defined(__STDC_NO_VLA__)
#		define Z_COMPILER_C_HAS_VLA 1
#	endif

#	if Z_COMPILER_VERSION >= Z_VERSION(3,0,0)
#		define Z_COMPILER_C_HAS_DESIGNATED_INITIALIZER 1
#		define Z_COMPILER_C_HAS_FLEXIBLE_ARRAY_MEMBER  1
#	endif

#	if Z_COMPILER_VERSION >= Z_VERSION(3,1,0)
#		define Z_COMPILER_C_HAS_COMPOUND_LITERAL 1
#	endif
...
#	if Z_COMPILER_VERSION >= Z_VERSION(2,7,0)
#		define Z_COMPILER_C_HAS_CPP_STYLE_COMMENT 1
#	endif

#	if Z_COMPILER_VERSION >= Z_VERSION(3,0,0)
#		define Z_COMPILER_C_HAS_MIXED_DECLARATIONS_AND_CODE 1
#	endif

#	if Z_COMPILER_VERSION >= Z_VERSION(4,3,0)
#		define Z_COMPILER_C_HAS_SPECIFIER_INLINE 1
#	endif
...
#		define Z_COMPILER_C_HAS_TYPE_ULLONG 1
#		define Z_COMPILER_C_HAS_TYPE_LLONG  1
#	endif

#	if Z_COMPILER_VERSION >= Z_VERSION(2,95,0)
#		define Z_COMPILER_C_HAS_VARIADIC_MACRO 1
#	endif
...
#		define Z_COMPILER_C_HAS_ANONYMOUS_STRUCTURE 1
#		define Z_COMPILER_C_HAS_STATIC_ASSERTION    1

#		if Z_COMPILER_VERSION >= Z_VERSION(4,7,0)
#			define Z_COMPILER_C_HAS_OPERATOR_ALIGN_OF   1
#			define Z_COMPILER_C_HAS_SPECIFIER_ALIGN_AS  1
#			define Z_COMPILER_C_HAS_SPECIFIER_NO_RETURN 1

#			if Z_COMPILER_VERSION >= Z_VERSION(4,9,0)
#				define Z_COMPILER_C_HAS_GENERIC_SELECTION	   1
#				define Z_COMPILER_C_HAS_STORAGE_CLASS_THREAD_LOCAL 1

#				ifndef __STDC_NO_ATOMICS__
#					define Z_COMPILER_C_HAS_ATOMIC_OPERATIONS     1
#					define Z_COMPILER_C_HAS_SPECIFIER_ATOMIC      1
#					define Z_COMPILER_C_HAS_TYPE_QUALIFIER_ATOMIC 1
#				endif
#			endif
#		endif
#	endif
...
#ifdef __BLOCKS__
#	define Z_COMPILER_C_HAS_CLOSURE 1
#endif
...
#		define Z_COMPILER_CPP_HAS_SFINAE    1 /* TODO: from version...? */
#		define Z_COMPILER_CPP_HAS_TYPE_BOOL 1 /* TODO: from version...? */
#	endif
...
#		if Z_COMPILER_VERSION >= Z_VERSION(4,3,0)
#			define Z_COMPILER_CPP_HAS_C99_PREPROCESSOR				   1
#			define Z_COMPILER_CPP_HAS_CONCURRENT_STATIC_LOCAL_VARIABLE		   1
#			define Z_COMPILER_CPP_HAS_DEFAULT_TEMPLATE_ARGUMENTS_FOR_FUNCTION_TEMPLATE 1
#			define Z_COMPILER_CPP_HAS_RVALUE_REFERENCE				   1
#			define Z_COMPILER_CPP_HAS_SPECIFIER_DECLARED_TYPE			   1
#			define Z_COMPILER_CPP_HAS_VARIADIC_TEMPLATE				   1
#			define Z_COMPILER_CPP_HAS_TYPE_ULLONG					   1
#			define Z_COMPILER_CPP_HAS_TYPE_LLONG					   1

#			if Z_COMPILER_VERSION >= Z_VERSION(4,4,0)
#				define Z_COMPILER_CPP_HAS_COPY_LIST_INITIALIZATION		1
#				define Z_COMPILER_CPP_HAS_DIRECT_LIST_INITIALIZATION		1
#				define Z_COMPILER_CPP_HAS_INITIALIZER_LIST			1
#				define Z_COMPILER_CPP_HAS_STRONGLY_TYPED_ENUMERATION		1
#				define Z_COMPILER_CPP_HAS_TRAILING_RETURN_TYPE			1
#				define Z_COMPILER_CPP_HAS_VARIADIC_TEMPLATE_EXTENDED_PARAMETERS 1
#				define Z_COMPILER_CPP_HAS_SPECIFIER_AUTO			1

#				if Z_COMPILER_VERSION >= Z_VERSION(4,5,0)
#					define Z_COMPILER_CPP_HAS_EXPLICIT_CONVERSION 1
#					define Z_COMPILER_CPP_HAS_EXPRESSION_SFINAE   1
#					define Z_COMPILER_CPP_HAS_LAMBDA	      1
#					define Z_COMPILER_CPP_HAS_OPERATOR_ALIGN_OF   1

#					if Z_COMPILER_VERSION >= Z_VERSION(4,6,0)
#						define Z_COMPILER_CPP_HAS_RANGE_BASED_FOR		1
#						define Z_COMPILER_CPP_HAS_UNRESTRICTED_UNION		1
#						define Z_COMPILER_CPP_HAS_MOVE_SPECIAL_MEMBER_FUNCTIONS 1
#						define Z_COMPILER_CPP_HAS_LITERAL_NULLPTR		1
#						define Z_COMPILER_CPP_HAS_OPERATOR_NO_EXCEPTION		1
#						define Z_COMPILER_CPP_HAS_SPECIFIER_CONSTANT_EXPRESSION 1
#						define Z_COMPILER_CPP_HAS_SPECIFIER_NO_EXCEPTION	1

#						if Z_COMPILER_VERSION >= Z_VERSION(4,7,0)
#							define Z_COMPILER_CPP_HAS_DEFAULT_MEMBER_INITIALIZER 1
#							define Z_COMPILER_CPP_HAS_TEMPLATE_ALIAS	     1

#							if Z_COMPILER_VERSION >= Z_VERSION(4,8,0)
#								define Z_COMPILER_CPP_HAS_INHERITING_CONSTRUCTORS 1
#								define Z_COMPILER_CPP_HAS_SPECIFIER_ALIGN_AS	  1

#								if Z_COMPILER_VERSION >= Z_VERSION(4,8,1)
#									define Z_COMPILER_CPP_HAS_REFERENCE_QUALIFIED_NON_STATIC_MEMBER_FUNCTION 1
#									define Z_COMPILER_CPP_HAS_SPECIFIER_DECLARED_TYPE_OF_INCOMPLETE_RETURN	 1
#								endif
#							endif
#						endif
#					endif
...
#ifdef __CHAR_BIT__
#	define Z_COMPILER_CONSTANT_UCHAR_WIDTH  __CHAR_BIT__
...
#	define Z_COMPILER_CONSTANT_USHORT_WIDTH (__SIZEOF_SHORT__ * 8)
#	define Z_COMPILER_CONSTANT_USHORT_SIZE	__SIZEOF_SHORT__
#	define Z_COMPILER_CONSTANT_SHORT_WIDTH  (__SIZEOF_SHORT__ * 8)
...
#	define Z_COMPILER_CONSTANT_UINT_WIDTH (__SIZEOF_INT__ * 8)
#	define Z_COMPILER_CONSTANT_UINT_SIZE  __SIZEOF_INT__
#	define Z_COMPILER_CONSTANT_INT_WIDTH  (__SIZEOF_INT__ * 8)
...
#	define Z_COMPILER_CONSTANT_ULONG_WIDTH (__SIZEOF_LONG__ * 8)
#	define Z_COMPILER_CONSTANT_ULONG_SIZE  __SIZEOF_LONG__
#	define Z_COMPILER_CONSTANT_LONG_WIDTH  (__SIZEOF_LONG__ * 8)
...
#	define Z_COMPILER_CONSTANT_ULLONG_WIDTH (__SIZEOF_LONG_LONG__ * 8)
#	define Z_COMPILER_CONSTANT_ULLONG_SIZE	__SIZEOF_LONG_LONG__
#	define Z_COMPILER_CONSTANT_LLONG_WIDTH  (__SIZEOF_LONG_LONG__ * 8)
...
#	define Z_COMPILER_CONSTANT_FLOAT_WIDTH (__SIZEOF_FLOAT__ * 8)
#	define Z_COMPILER_CONSTANT_FLOAT_SIZE  __SIZEOF_FLOAT__
#endif

#ifdef __SIZEOF_DOUBLE__
#	define Z_COMPILER_CONSTANT_DOUBLE_WIDTH (__SIZEOF_DOUBLE__ * 8)
#	define Z_COMPILER_CONSTANT_DOUBLE_SIZE	__SIZEOF_DOUBLE__
#endif

#ifdef __SIZEOF_LONG_DOUBLE__
#	define Z_COMPILER_CONSTANT_LDOUBLE_WIDTH (__SIZEOF_LONG_DOUBLE__ * 8)
...
#	define Z_COMPILER_CONSTANT_SIZE_WIDTH  (__SIZEOF_SIZE_T__ * 8)
#	define Z_COMPILER_CONSTANT_SIZE_SIZE   __SIZEOF_SIZE_T__
#	define Z_COMPILER_CONSTANT_SSIZE_WIDTH (__SIZEOF_SIZE_T__ * 8)
