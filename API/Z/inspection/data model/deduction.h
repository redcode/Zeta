/* Zeta API - Z/inspection/data model/deduction.h
...
#ifndef Z__LONG_BITS
#	define Z__LONG_BITS 0
#endif

#if Z_COMPILER_HAS_CONSTANT(LLONG_BITS)
#	define Z__LLONG_BITS Z_COMPILER_CONSTANT(LLONG_BITS)

#elif Z_COMPILER_HAS_CONSTANT(LLONG_SIZE)
#	define Z__LLONG_BITS (Z_COMPILER_CONSTANT(LLONG_SIZE) * 8)
...
#	define Z__LLONG_BITS Z__LONG_BITS
...
#ifndef Z__LLONG_BITS
#	define Z__LLONG_BITS 0
#endif

#if Z_COMPILER_HAS_CONSTANT(POINTER_BITS)
#	define Z__POINTER_BITS Z_COMPILER_CONSTANT(POINTER_BITS)

#elif Z_COMPILER_HAS_CONSTANT(POINTER_SIZE)
#	define Z__POINTER_BITS (Z_COMPILER_CONSTANT(POINTER_SIZE) * 8)

#elif Z_COMPILER_HAS_CONSTANT(SIZE_BITS)
#	define Z__POINTER_BITS Z_COMPILER_CONSTANT(SIZE_BITS)

#elif Z_COMPILER_HAS_CONSTANT(SIZE_SIZE)
#	define Z__POINTER_BITS (Z_COMPILER_CONSTANT(SIZE_SIZE) * 8)

#elif Z_COMPILER_HAS_CONSTANT(UINTPTR_BITS)
#	define Z__POINTER_BITS Z_COMPILER_CONSTANT(UINTPTR_BITS)

#elif Z_COMPILER_HAS_CONSTANT(UINTPTR_SIZE)
#	define Z__POINTER_BITS (Z_COMPILER_CONSTANT(UINTPTR_SIZE) * 8)

#elif Z_COMPILER_HAS_CONSTANT(SINTPTR_BITS)
#	define Z__POINTER_BITS Z_COMPILER_CONSTANT(SINTPTR_BITS)

#elif Z_COMPILER_HAS_CONSTANT(SINTPTR_SIZE)
#	define Z__POINTER_BITS (Z_COMPILER_CONSTANT(SINTPTR_SIZE) * 8)

#else
#	define Z__POINTER_BITS 0
#endif
