...
#ifndef Z__LONG_WIDTH
#	define Z__LONG_WIDTH 0
#endif

#if Z_COMPILER_HAS_CONSTANT(LLONG_WIDTH)
#	define Z__LLONG_WIDTH Z_COMPILER_CONSTANT(LLONG_WIDTH)

#elif Z_COMPILER_HAS_CONSTANT(LLONG_SIZE)
#	define Z__LLONG_WIDTH (Z_COMPILER_CONSTANT(LLONG_SIZE) * 8)
...
#	define Z__LLONG_WIDTH Z__LONG_WIDTH
...
#ifndef Z__LLONG_WIDTH
#	define Z__LLONG_WIDTH 0
#endif

#if Z_COMPILER_HAS_CONSTANT(POINTER_WIDTH)
#	define Z__POINTER_WIDTH Z_COMPILER_CONSTANT(POINTER_WIDTH)
#elif Z_COMPILER_HAS_CONSTANT(POINTER_SIZE)
#	define Z__POINTER_WIDTH (Z_COMPILER_CONSTANT(POINTER_SIZE) * 8)
#elif Z_COMPILER_HAS_CONSTANT(SIZE_WIDTH)
#	define Z__POINTER_WIDTH Z_COMPILER_CONSTANT(SIZE_WIDTH)
#elif Z_COMPILER_HAS_CONSTANT(SIZE_SIZE)
#	define Z__POINTER_WIDTH (Z_COMPILER_CONSTANT(SIZE_SIZE) * 8)
#elif Z_COMPILER_HAS_CONSTANT(UINTPTR_WIDTH)
#	define Z__POINTER_WIDTH Z_COMPILER_CONSTANT(UINTPTR_WIDTH)
#elif Z_COMPILER_HAS_CONSTANT(UINTPTR_SIZE)
#	define Z__POINTER_WIDTH (Z_COMPILER_CONSTANT(UINTPTR_SIZE) * 8)
#elif Z_COMPILER_HAS_CONSTANT(SINTPTR_WIDTH)
#	define Z__POINTER_WIDTH Z_COMPILER_CONSTANT(SINTPTR_WIDTH)
#elif Z_COMPILER_HAS_CONSTANT(SINTPTR_SIZE)
#	define Z__POINTER_WIDTH (Z_COMPILER_CONSTANT(SINTPTR_SIZE) * 8)
#else
#	define Z__POINTER_WIDTH 0
#endif

#if Z__SHORT_WIDTH == 16
#	if Z__INT_WIDTH == 16
...
#undef Z__SHORT_WIDTH
#undef Z__INT_WIDTH
#undef Z__LONG_WIDTH
#undef Z__LLONG_WIDTH
#undef Z__POINTER_WIDTH
