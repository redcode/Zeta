...
#define Q_STRICT_STRUCTURE(...)		struct {__VA_ARGS__} Q_ATTRIBUTE_STRICT_SIZE
#define Q_STRICT_UNION(...)		union  {__VA_ARGS__} Q_ATTRIBUTE_STRICT_SIZE
...
#define Q_DEFINE_STRICT_STRUCTURE_WITH_NAME(name, ...) \
	Q_DEFINE_STRUCTURE_WITH_NAME(name, __VA_ARGS__) Q_ATTRIBUTE_STRICT_SIZE
