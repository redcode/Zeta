...
#define Q_KEY_TYPE(	      NAME) Q_JOIN_4(Q_, UINT, Q_JOIN_2(Q_KEY_BITS_, NAME), _FIXED_TYPE)
...
#define Q_KEY_FIXED_TYPE_NAME(NAME) Q_JOIN_4(Q_, UINT, Q_JOIN_2(Q_KEY_BITS_, NAME), _NAME)
#define Q_KEY_FIXED_TYPE_Name(NAME) Q_JOIN_4(Q_, UINT, Q_JOIN_2(Q_KEY_BITS_, NAME), _Name)
#define Q_KEY_FIXED_TYPE_name(NAME) Q_JOIN_4(Q_, UINT, Q_JOIN_2(Q_KEY_BITS_, NAME), _name)
