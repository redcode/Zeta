/* Q API - hardware/PSG/General Instrument/AY-3-891x.h
	      __	   __
...
Released under the terms of the GNU General Public License v3.
   ...
   | R1  |			 |          UNUSED	 |  4-Bit Coarse Tune A  |
   |-----+-----------------------+-----------------------------------------------|
   | R2  |			 |		 8-Bit Fine Tune B		 |
   |-----| Channel B Tone Period |-----------------------------------------------|
   | R3  |			 |          UNUSED	 |  4-Bit Coarse Tune B  |
   |-----+-----------------------+-----------------------------------------------|
...
#ifndef __Q_hardware_PSG_General_Instrument_AY_3_891x_H__
#define __Q_hardware_PSG_General_Instrument_AY_3_891x_H__
...
Q_DEFINE_STRICT_UNION(
	...
	struct {quint8 channel_a_tone_period_fine_tune;
		quint8 channel_a_tone_period_coarse_tune;
		quint8 channel_b_tone_period_fine_tune;
		quint8 channel_b_tone_perid_coarse_tune;
		quint8 channel_c_tone_period_fine_tune;
...
#define Q_AY_3_891X_STATE(p) ((QAY3891xState *)(p))
...
#endif /* __Q_hardware_PSG_General_Instrument_AY_3_891x_H__ */
