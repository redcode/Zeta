/* Q API - formats/storage medium image/tape/TZX.h
	      __	   __
...
/* Example
   ...
   |--------+---------------+-----------------------------------------
   |   0C   | 152 (98h)    | Total number of symbols (bits, in this case) in data stream
   |--------+---------------+-----------------------------------------
   ...
   |	    | (0, 1710, 1710) |
   |--------+-----------------+-----------------------------------------
   |   2C   | 00000000b	(00h) | Data stream:
   |	    | 00000011b	(03h) |
   |	    | 01001010b	(4Ah) | 00h: Floading flag (00h = header)
   |	    | 01010000b	(50h) | 03h: Data type (02h = "Bytes:")
   |	    | 01010011b	(53h) | 4Ah, 50h, 53h, 50h, 20h, 20h, 20h,20h,20h,20h: File name ("JPSP")
   |	    | 01010000b	(50h) | 1B00: data length
   |	    | 00100000b	(20h) | 4000: start address
   |	    | 00100000b	(20h) | 8000: autostart (no meaning here)
   |	    | 00100000b	(20h) | C1: checksum
   |	    | 00100000b	(20h) |
   |	    | 00100000b	(20h) |
   |	    | 00100000b	(20h) |
   |	    | 00000000b	(00h) |
