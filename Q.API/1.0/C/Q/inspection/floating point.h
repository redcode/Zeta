...
#define Q_FLOATING_POINT_BIAS(		     TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _BIAS)
...
#define Q_FLOATING_POINT_MANTISSA_OFFSET(    TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _MANTISSA_OFFSET)
#define Q_FLOATING_POINT_MANTISSA_BITS(      TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _MANTISSA_BITS)
#define Q_FLOATING_POINT_MANTISSA_DIGITS(    TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _MANTISSA_DIGITS)
#define Q_FLOATING_POINT_EXPONENT_OFFSET(    TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _EXPONENT_OFFSET)
#define Q_FLOATING_POINT_EXPONENT_BITS(      TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _EXPONENT_BITS)
#define Q_FLOATING_POINT_EXPONENT_RADIX(     TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _EXPONENT_RADIX)
...
#define Q_FLOATING_POINT_SIGN_OFFSET(	     TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _SIGN_OFFSET)
#define Q_FLOATING_POINT_SIGN_BITS(	     TYPE) Q_JOIN_3(Q_, Q_FLOATING_POINT_TOKEN(TYPE), _SIGN_BITS)
