...
#define Q_CPU_HAS(WHAT)				((defined Q_JOIN_3(Q_CPU_ARCHITECTURE_PREFIX, HAS_, WHAT)) || \
						 (defined Q_JOIN_3(Q_CPU_MODEL_PREFIX,	      HAS_, WHAT)))

#define Q_CPU_IS_CAPABLE_OF(WHAT)		((defined Q_JOIN_3(Q_CPU_ARCHITECTURE_PREFIX, IS_CAPABLE_OF_, WHAT) || \
						 (defined Q_JOIN_3(Q_CPU_MODEL_PREFIX,	      IS_CAPABLE_OF_, WHAT)))
