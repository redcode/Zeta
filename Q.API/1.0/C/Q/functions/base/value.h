...
#if Q_COMPILER_HAS_FUNCTION(FLOAT_CEIL)
#	define q_float_ceil Q_COMPILER_FUNCTION_FLOAT_CEIL
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_FLOAT_CEIL)
#	Q_ASSEMBLY_IMPLEMENTATION_FLOAT_CEIL
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(FLOAT_FLOOR)
#	define q_float_floor Q_COMPILER_FUNCTION_FLOAT_FLOOR
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_FLOAT_FLOOR)
#	Q_ASSEMBLY_IMPLEMENTATION_FLOAT_FLOOR
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(FLOAT_ROUND)
#	define q_float_round Q_COMPILER_FUNCTION_FLOAT_ROUND
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_FLOAT_ROUND)
#	Q_ASSEMBLY_IMPLEMENTATION_FLOAT_ROUND
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(DOUBLE_CEIL)
#	define q_double_ceil Q_COMPILER_FUNCTION_DOUBLE_CEIL
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_CEIL)
#	Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_CEIL
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(DOUBLE_FLOOR)
#	define q_double_floor Q_COMPILER_FUNCTION_DOUBLE_FLOOR
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_FLOOR)
#	Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_FLOOR
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(DOUBLE_ROUND)
#	define q_double_round Q_COMPILER_FUNCTION_DOUBLE_ROUND
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_ROUND)
#	Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_ROUND
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(LDOUBLE_CEIL)
#	define q_ldouble_ceil Q_COMPILER_FUNCTION_LDOUBLE_CEIL
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_CEIL)
#	Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_CEIL
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(LDOUBLE_FLOOR)
#	define q_ldouble_floor Q_COMPILER_FUNCTION_LDOUBLE_FLOOR
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_FLOOR)
#	Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_FLOOR
#else
#endif

#if Q_COMPILER_HAS_FUNCTION(LDOUBLE_ROUND)
#	define q_ldouble_round Q_COMPILER_FUNCTION_LDOUBLE_ROUND
#elif defined(Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_ROUND)
