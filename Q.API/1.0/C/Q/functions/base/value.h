...
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL( 8,  1)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL( 8,  2)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL( 8,  4)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(16,  1)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(16,  2)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(16,  4)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(16,  8)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(32,  1)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(32,  2)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(32,  4)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(32,  8)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(32, 16)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(64,  1)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(64,  2)
Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(64,  4)
...
#define q_int64_reversed  q_int64_reversed_in_8bit
	...
	Q_IMPLEMENTATION_VALUE_REVERSED_IN_LEVEL(128,  4)
...
#ifdef Q_USE_INLINE_ROUNDING

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_FLOAT_CEIL)
#		Q_ASSEMBLY_IMPLEMENTATION_FLOAT_CEIL
#	elif Q_COMPILER_HAS_FUNCTION(FLOAT_CEIL)
#		define q_float_ceil Q_COMPILER_FUNCTION_FLOAT_CEIL
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_FLOAT_FLOOR)
#		Q_ASSEMBLY_IMPLEMENTATION_FLOAT_FLOOR
#	elif Q_COMPILER_HAS_FUNCTION(FLOAT_FLOOR)
#		define q_float_floor Q_COMPILER_FUNCTION_FLOAT_FLOOR
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_FLOAT_ROUND)
#		Q_ASSEMBLY_IMPLEMENTATION_FLOAT_ROUND
#	elif Q_COMPILER_HAS_FUNCTION(FLOAT_ROUND)
#		define q_float_round Q_COMPILER_FUNCTION_FLOAT_ROUND
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_CEIL)
#		Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_CEIL
#	elif Q_COMPILER_HAS_FUNCTION(DOUBLE_CEIL)
#		define q_double_ceil Q_COMPILER_FUNCTION_DOUBLE_CEIL
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_FLOOR)
#		Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_FLOOR
#	elif Q_COMPILER_HAS_FUNCTION(DOUBLE_FLOOR)
#		define q_double_floor Q_COMPILER_FUNCTION_DOUBLE_FLOOR
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_ROUND)
#		Q_ASSEMBLY_IMPLEMENTATION_DOUBLE_ROUND
#	elif Q_COMPILER_HAS_FUNCTION(DOUBLE_ROUND)
#		define q_double_round Q_COMPILER_FUNCTION_DOUBLE_ROUND
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_CEIL)
#		Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_CEIL
#	elif Q_COMPILER_HAS_FUNCTION(LDOUBLE_CEIL)
#		define q_ldouble_ceil Q_COMPILER_FUNCTION_LDOUBLE_CEIL
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_FLOOR)
#		Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_FLOOR
#	elif Q_COMPILER_HAS_FUNCTION(LDOUBLE_FLOOR)
#		define q_ldouble_floor Q_COMPILER_FUNCTION_LDOUBLE_FLOOR
#	else
#	endif

#	if defined(Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_ROUND)
#		Q_ASSEMBLY_IMPLEMENTATION_LDOUBLE_ROUND
#	elif Q_COMPILER_HAS_FUNCTION(LDOUBLE_ROUND)
#		define q_ldouble_round Q_COMPILER_FUNCTION_LDOUBLE_ROUND
#	else
#	endif

#	define Q_AVAILABLE_ROUNDING
...
#	if Q_IS_AVAILABLE(ROUNDING)
#		define q_ceil	  q_float_ceil
#		define q_floor	  q_float_floor
#		define q_round	  q_float_round
#	endif
...
#	if Q_IS_AVAILABLE(ROUNDING)
#		define q_ceil	  q_ldouble_ceil
#		define q_floor	  q_ldouble_floor
#		define q_round	  q_ldouble_round
#	endif
...
#	if Q_IS_AVAILABLE(ROUNDING)
#		define q_ceil	  q_double_ceil
#		define q_floor	  q_double_floor
#		define q_round	  q_double_round
#	endif
...
#if defined(Q_USE_INLINE_ATOMICS) || defined(Q_DECLARE_ATOMIC_SELECTORS)
...
#	define Q_AVAILABLE_ATOMIC_SELECTORS
