...
#define Q_IMPLEMENTATION_3D_VALUE(Type, type)					\
										\
										\
...
Q_IMPLEMENTATION_3D_VALUE(UChar,   uchar  )
Q_IMPLEMENTATION_3D_VALUE(UShort,  ushort )
Q_IMPLEMENTATION_3D_VALUE(UInt,	   uint	  )
Q_IMPLEMENTATION_3D_VALUE(ULong,   ulong  )
Q_IMPLEMENTATION_3D_VALUE(ULLong,  ullong )
Q_IMPLEMENTATION_3D_VALUE(Char,	   char	  )
Q_IMPLEMENTATION_3D_VALUE(Short,   short  )
Q_IMPLEMENTATION_3D_VALUE(Int,	   int	  )
Q_IMPLEMENTATION_3D_VALUE(Long,	   long	  )
Q_IMPLEMENTATION_3D_VALUE(LLong,   llong  )
Q_IMPLEMENTATION_3D_VALUE(Float,   float  )
Q_IMPLEMENTATION_3D_VALUE(Double,  double )
Q_IMPLEMENTATION_3D_VALUE(LDouble, ldouble)
Q_IMPLEMENTATION_3D_VALUE(UInt8,   uint8  )
Q_IMPLEMENTATION_3D_VALUE(UInt16,  uint16 )
Q_IMPLEMENTATION_3D_VALUE(UInt32,  uint32 )
Q_IMPLEMENTATION_3D_VALUE(UInt64,  uint64 )
Q_IMPLEMENTATION_3D_VALUE(Int8,	   int8	  )
Q_IMPLEMENTATION_3D_VALUE(Int16,   int16  )
Q_IMPLEMENTATION_3D_VALUE(Int32,   int32  )
Q_IMPLEMENTATION_3D_VALUE(Int64,   int64  )
Q_IMPLEMENTATION_3D_VALUE(Size,	   size	  )
Q_IMPLEMENTATION_3D_VALUE(UIntPtr, uintptr)
Q_IMPLEMENTATION_3D_VALUE(UIntTop, uinttop)
Q_IMPLEMENTATION_3D_VALUE(UIntMax, uintmax)
Q_IMPLEMENTATION_3D_VALUE(SSize,   ssize  )
Q_IMPLEMENTATION_3D_VALUE(IntPtr,  intptr )
Q_IMPLEMENTATION_3D_VALUE(IntTop,  inttop )
Q_IMPLEMENTATION_3D_VALUE(IntMax,  intmax )
Q_IMPLEMENTATION_3D_VALUE(Natural, natural)
Q_IMPLEMENTATION_3D_VALUE(Integer, integer)
Q_IMPLEMENTATION_3D_VALUE(Real,	   real	  )
