...
#define Q_FLOAT_MINIMUM				Q_FLOATING_POINT_MINIMUM	    (FLOAT)
#define Q_FLOAT_MAXIMUM				Q_FLOATING_POINT_MAXIMUM	    (FLOAT)
#define Q_FLOAT_EPSILON				Q_FLOATING_POINT_EPSILON	    (FLOAT)
...
#define Q_FLOAT_INFINITY			(Q_SUFFIX_F(Q_FLOAT_MAXIMUM) + Q_SUFFIX_F(Q_FLOAT_MAXIMUM))
#define Q_FLOAT_NAN				(Q_FLOAT_INFINITY - Q_FLOAT_INFINITY)
...
#define Q_DOUBLE_INFINITY			(Q_DOUBLE_MAXIMUM  + Q_DOUBLE_MAXIMUM)
#define Q_DOUBLE_NAN				(Q_DOUBLE_INFINITY - Q_DOUBLE_INFINITY)
...
#	define Q_LDOUBLE_MINIMUM		Q_FLOATING_POINT_MINIMUM	    (LDOUBLE)
#	define Q_LDOUBLE_MAXIMUM		Q_FLOATING_POINT_MAXIMUM	    (LDOUBLE)
#	define Q_LDOUBLE_EPSILON		Q_FLOATING_POINT_EPSILON	    (LDOUBLE)
...
#	define Q_LDOUBLE_INFINITY		(Q_SUFFIX_L(Q_LDOUBLE_MAXIMUM) + Q_SUFFIX_L(Q_LDOUBLE_MAXIMUM))
#	define Q_LDOUBLE_NAN			(Q_LDOUBLE_INFINITY - Q_LDOUBLE_INFINITY)
