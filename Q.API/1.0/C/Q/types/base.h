...
#define Q_FLOAT_INFINITY			(Q_FLOAT(Q_FLOAT_MAXIMUM) + Q_FLOAT(Q_FLOAT_MAXIMUM))
...
#	define Q_LDOUBLE_INFINITY		(Q_LDOUBLE(Q_LDOUBLE_MAXIMUM) + Q_LDOUBLE(Q_LDOUBLE_MAXIMUM))
