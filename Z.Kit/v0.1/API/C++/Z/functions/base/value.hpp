...
namespace ZKit {
	...
	template <typename T> inline typename enable_if<Type<T>::is_signed, T>::type
	...
	template <typename T> inline typename enable_if<Type<T>::is_real, Boolean>::type
	are_almost_equal(T a, T b) {return absolute(a - b) <= Type<T>::epsilon;}


	template <typename T> inline typename enable_if<Type<T>::is_real, T>::type
	...
	template <typename T> inline typename enable_if<Type<T>::is_real, Boolean>::type
	is_finite(T value) {return value == value && value != Type<T>::infinity && value != -Type<T>::infinity;}


	template <typename T> inline typename enable_if<Type<T>::is_real, Boolean>::type
	is_infinity(T value) {return value == Type<T>::infinity || value == -Type<T>::infinity;}
