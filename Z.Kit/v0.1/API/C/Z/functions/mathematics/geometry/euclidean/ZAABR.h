...
#define z_aabr_type_collide(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _collide		      )
#define z_aabr_type_contains(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _contains	      )
#define z_aabr_type_intersection(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _intersection	      )
#define z_aabr_type_union(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _union		      )
#define z_aabr_type_from_vertices(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _from_vertices	      )
#define z_aabr_type_area(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _area		      )
#define z_aabr_type_absolute_point_to_unit(TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _absolute_point_to_unit)
#define z_aabr_type_align_in_bottom_center(TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_bottom_center)
#define z_aabr_type_align_in_bottom_left(  TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_bottom_left  )
#define z_aabr_type_align_in_bottom_right( TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_bottom_right )
#define z_aabr_type_align_in_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_center	      )
#define z_aabr_type_align_in_center_left(  TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_center_left  )
#define z_aabr_type_align_in_center_right( TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_center_right )
#define z_aabr_type_align_in_top_center(   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_top_center   )
#define z_aabr_type_align_in_top_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_top_left     )
#define z_aabr_type_align_in_top_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _align_in_top_right    )
#define z_aabr_type_bottom_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _bottom_center	      )
#define z_aabr_type_bottom_half(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _bottom_half	      )
#define z_aabr_type_bottom_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _bottom_left	      )
#define z_aabr_type_bottom_left_quarter(   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _bottom_left_quarter   )
#define z_aabr_type_bottom_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _bottom_right	      )
#define z_aabr_type_bottom_right_quarter(  TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _bottom_right_quarter  )
#define z_aabr_type_center_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _center_left	      )
#define z_aabr_type_center_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _center_right	      )
#define z_aabr_type_contains_circle(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _contains_circle	      )
#define z_aabr_type_contains_line_segment( TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _contains_line_segment )
#define z_aabr_type_contains_point(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _contains_point	      )
#define z_aabr_type_contains_rectangle(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _contains_rectangle    )
#define z_aabr_type_fit_in_bottom_center(  TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_bottom_center  )
#define z_aabr_type_fit_in_bottom_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_bottom_left    )
#define z_aabr_type_fit_in_bottom_right(   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_bottom_right   )
#define z_aabr_type_fit_in_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_center	      )
#define z_aabr_type_fit_in_center_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_center_left    )
#define z_aabr_type_fit_in_center_right(   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_center_right   )
#define z_aabr_type_fit_in_top_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_top_center     )
#define z_aabr_type_fit_in_top_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_top_left	      )
#define z_aabr_type_fit_in_top_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _fit_in_top_right      )
#define z_aabr_type_inner_circle(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _inner_circle	      )
#define z_aabr_type_left_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _left_half	      )
#define z_aabr_type_middle_x(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _middle_x	      )
#define z_aabr_type_middle_y(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _middle_y	      )
#define z_aabr_type_rectangle(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _rectangle	      )
#define z_aabr_type_right_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _right_half	      )
#define z_aabr_type_size(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _size		      )
#define z_aabr_type_top_center(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _top_center	      )
#define z_aabr_type_top_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _top_half	      )
#define z_aabr_type_top_left(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _top_left	      )
#define z_aabr_type_top_left_quarter(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _top_left_quarter      )
#define z_aabr_type_top_right(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _top_right	      )
#define z_aabr_type_top_right_quarter(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _top_right_quarter     )
#define z_aabr_type_unit_point_to_absolute(TYPE) Z_INSERT_##TYPE##_sized_type(z_aabr_, _unit_point_to_absolute)
