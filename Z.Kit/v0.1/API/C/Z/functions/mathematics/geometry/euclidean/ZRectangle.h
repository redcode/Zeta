...
#define z_rectangle_type_are_equal(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _are_equal		      )
#define z_rectangle_type_collide(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _collide		      )
#define z_rectangle_type_contains(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _contains		      )
#define z_rectangle_type_intersection(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _intersection	      )
#define z_rectangle_type_swap(			   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _swap		      )
#define z_rectangle_type_union(			   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _union		      )
#define z_rectangle_type_from_vertices(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _from_vertices	      )
#define z_rectangle_type_aabr(			   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _aabr		      )
#define z_rectangle_type_absolute_point_to_unit(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _absolute_point_to_unit   )
#define z_rectangle_type_align_in_bottom_center(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_bottom_center   )
#define z_rectangle_type_align_in_bottom_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_bottom_left     )
#define z_rectangle_type_align_in_bottom_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_bottom_right    )
#define z_rectangle_type_align_in_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_center	      )
#define z_rectangle_type_align_in_center_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_center_left     )
#define z_rectangle_type_align_in_center_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_center_right    )
#define z_rectangle_type_align_in_top_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_top_center      )
#define z_rectangle_type_align_in_top_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_top_left	      )
#define z_rectangle_type_align_in_top_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _align_in_top_right	      )
#define z_rectangle_type_bottom_center(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _bottom_center	      )
#define z_rectangle_type_bottom_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _bottom_half	      )
#define z_rectangle_type_bottom_left(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _bottom_left	      )
#define z_rectangle_type_bottom_left_quarter(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _bottom_left_quarter      )
#define z_rectangle_type_bottom_right(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _bottom_right	      )
#define z_rectangle_type_bottom_right_quarter(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _bottom_right_quarter     )
#define z_rectangle_type_center(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _center		      )
#define z_rectangle_type_center_left(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _center_left	      )
#define z_rectangle_type_center_right(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _center_right	      )
#define z_rectangle_type_contains_aabr(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _contains_aabr	      )
#define z_rectangle_type_contains_circle(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _contains_circle	      )
#define z_rectangle_type_contains_line_segment(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _contains_line_segment    )
#define z_rectangle_type_contains_point(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _contains_point	      )
#define z_rectangle_type_correct(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _correct		      )
#define z_rectangle_type_fit_in_bottom_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_bottom_center     )
#define z_rectangle_type_fit_in_bottom_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_bottom_left	      )
#define z_rectangle_type_fit_in_bottom_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_bottom_right      )
#define z_rectangle_type_fit_in_center(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_center	      )
#define z_rectangle_type_fit_in_center_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_center_left	      )
#define z_rectangle_type_fit_in_center_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_center_right      )
#define z_rectangle_type_fit_in_top_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_top_center	      )
#define z_rectangle_type_fit_in_top_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_top_left	      )
#define z_rectangle_type_fit_in_top_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _fit_in_top_right	      )
#define z_rectangle_type_grow_from_bottom_center(  TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_bottom_center  )
#define z_rectangle_type_grow_from_bottom_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_bottom_left    )
#define z_rectangle_type_grow_from_bottom_right(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_bottom_right   )
#define z_rectangle_type_grow_from_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_center	      )
#define z_rectangle_type_grow_from_center_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_center_left    )
#define z_rectangle_type_grow_from_center_right(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_center_right   )
#define z_rectangle_type_grow_from_top_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_top_center     )
#define z_rectangle_type_grow_from_top_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_top_left	      )
#define z_rectangle_type_grow_from_top_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_from_top_right      )
#define z_rectangle_type_grow_in_x_from_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_in_x_from_center    )
#define z_rectangle_type_grow_in_x_from_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_in_x_from_left      )
#define z_rectangle_type_grow_in_x_from_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_in_x_from_right     )
#define z_rectangle_type_grow_in_y_from_bottom(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_in_y_from_bottom    )
#define z_rectangle_type_grow_in_y_from_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_in_y_from_center    )
#define z_rectangle_type_grow_in_y_from_top(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _grow_in_y_from_top	      )
#define z_rectangle_type_inner_circle(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _inner_circle	      )
#define z_rectangle_type_is_zero(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _is_zero		      )
#define z_rectangle_type_left_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _left_half		      )
#define z_rectangle_type_maximum_x(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _maximum_x		      )
#define z_rectangle_type_maximum_y(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _maximum_y		      )
#define z_rectangle_type_middle_x(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _middle_x		      )
#define z_rectangle_type_middle_y(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _middle_y		      )
#define z_rectangle_type_minimum_x(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _minimum_x		      )
#define z_rectangle_type_minimum_y(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _minimum_y		      )
#define z_rectangle_type_right_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _right_half		      )
#define z_rectangle_type_shrink_from_bottom_center(TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_bottom_center)
#define z_rectangle_type_shrink_from_bottom_left(  TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_bottom_left  )
#define z_rectangle_type_shrink_from_bottom_right( TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_bottom_right )
#define z_rectangle_type_shrink_from_center(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_center	      )
#define z_rectangle_type_shrink_from_center_left(  TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_center_left  )
#define z_rectangle_type_shrink_from_center_right( TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_center_right )
#define z_rectangle_type_shrink_from_top_center(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_top_center   )
#define z_rectangle_type_shrink_from_top_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_top_left     )
#define z_rectangle_type_shrink_from_top_right(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_from_top_right    )
#define z_rectangle_type_shrink_in_x_from_center(  TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_in_x_from_center  )
#define z_rectangle_type_shrink_in_x_from_left(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_in_x_from_left    )
#define z_rectangle_type_shrink_in_x_from_right(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_in_x_from_right   )
#define z_rectangle_type_shrink_in_y_from_bottom(  TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_in_y_from_bottom  )
#define z_rectangle_type_shrink_in_y_from_center(  TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_in_y_from_center  )
#define z_rectangle_type_shrink_in_y_from_top(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _shrink_in_y_from_top     )
#define z_rectangle_type_top_center(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _top_center		      )
#define z_rectangle_type_top_half(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _top_half		      )
#define z_rectangle_type_top_left(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _top_left		      )
#define z_rectangle_type_top_left_quarter(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _top_left_quarter	      )
#define z_rectangle_type_top_right(		   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _top_right		      )
#define z_rectangle_type_top_right_quarter(	   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _top_right_quarter	      )
#define z_rectangle_type_unit_point_to_absolute(   TYPE) Z_INSERT_##TYPE##_sized_type(z_rectangle_, _unit_point_to_absolute   )
