...
#define z_box_type_are_equal(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _are_equal		    )
#define z_box_type_collide(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _collide		    )
#define z_box_type_contains(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _contains		    )
#define z_box_type_intersection(	  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _intersection	    )
#define z_box_type_swap(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _swap		    )
#define z_box_type_union(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _union		    )
#define z_box_type_from_vertices(	  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _from_vertices	    )
#define z_box_type_aabb(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _aabb		    )
#define z_box_type_absolute_point_to_unit(TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _absolute_point_to_unit)
#define z_box_type_center(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _center		    )
#define z_box_type_contains_aabb(	  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _contains_aabb	    )
#define z_box_type_contains_line_segment( TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _contains_line_segment )
#define z_box_type_contains_point(	  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _contains_point	    )
#define z_box_type_contains_sphere(	  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _contains_sphere	    )
#define z_box_type_correct(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _correct		    )
#define z_box_type_inner_sphere(	  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _inner_sphere	    )
#define z_box_type_is_zero(		  TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _is_zero		    )
#define z_box_type_unit_point_to_absolute(TYPE) Z_INSERT_##TYPE##_sized_type(z_box_, _unit_point_to_absolute)
