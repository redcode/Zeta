...
#define Z_IMPLEMENTATION_2D_LINE_SIGNED(Type, type)					 \
											 \
											 \
...
Z_IMPLEMENTATION_2D_LINE_SIGNED(Int8,  int8 )
Z_IMPLEMENTATION_2D_LINE_SIGNED(Int16, int16)
Z_IMPLEMENTATION_2D_LINE_SIGNED(Int32, int32)

#ifdef Z_INT64
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Int64, int64)
#endif

#ifdef Z_INT128
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Int128, int128)
#endif

#ifdef Z_FLOAT16
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float16, float16)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float16, float16)
#endif

#ifdef Z_FLOAT24
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float24, float24)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float24, float24)
#endif

#ifdef Z_FLOAT32
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float32, float32)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float32, float32)
#endif

#ifdef Z_FLOAT48
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float48, float48)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float48, float48)
#endif

#ifdef Z_FLOAT64
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float64, float64)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float64, float64)
#endif

#ifdef Z_FLOAT72
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float72, float72)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float72, float72)
#endif

#ifdef Z_FLOAT80
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float80, float80)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float80, float80)
#endif

#ifdef Z_FLOAT96
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float96, float96)
	Z_IMPLEMENTATION_2D_LINE_REAL  (Float96, float96)
#endif

#ifdef Z_FLOAT128
	Z_IMPLEMENTATION_2D_LINE_SIGNED(Float128, float128)
