...
Z_IMPLEMENTATION_3D_LINE_COMMON(SInt8,	sint8 )
Z_IMPLEMENTATION_3D_LINE_COMMON(SInt16, sint16)
Z_IMPLEMENTATION_3D_LINE_COMMON(SInt32, sint32)

#ifdef Z_SINT64
	Z_IMPLEMENTATION_3D_LINE_COMMON(SInt64, sint64)
#endif

#ifdef Z_SINT128
	Z_IMPLEMENTATION_3D_LINE_COMMON(SInt128, sint128)
#endif
...
#ifdef Z_FLOAT80_X87
	Z_IMPLEMENTATION_3D_LINE_COMMON(Float80_x87, float80_x87)
	Z_IMPLEMENTATION_3D_LINE_REAL  (Float80_x87, float80_x87)
#endif

#ifdef Z_FLOAT96_X87
	Z_IMPLEMENTATION_3D_LINE_COMMON(Float96_x87, float96_x87)
	Z_IMPLEMENTATION_3D_LINE_REAL  (Float96_x87, float96_x87)
#endif

#ifdef Z_FLOAT128_X87
	Z_IMPLEMENTATION_3D_LINE_COMMON(Float128_x87, float128_x87)
	Z_IMPLEMENTATION_3D_LINE_REAL  (Float128_x87, float128_x87)
#endif
