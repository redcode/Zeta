...
#define z_2d_line_segment_collide   Z_JOIN_3(z_2d_line_segment_, Z_REAL_FIXED_TYPE_name, _collide)
#define z_2d_line_segment_center    Z_JOIN_3(z_2d_line_segment_, Z_REAL_FIXED_TYPE_name, _center )
#define z_2d_line_segment_lerp	    Z_JOIN_3(z_2d_line_segment_, Z_REAL_FIXED_TYPE_name, _lerp	 )
