...
#define Z_JOIN_box_type_are_equal(	       type) Z_PASTE_3(z_box_, type, _are_equal		    )
#define Z_JOIN_box_type_contains(	       type) Z_PASTE_3(z_box_, type, _contains		    )
#define Z_JOIN_box_type_collide(	       type) Z_PASTE_3(z_box_, type, _collide		    )
#define Z_JOIN_box_type_intersection(	       type) Z_PASTE_3(z_box_, type, _intersection	    )
#define Z_JOIN_box_type_union(		       type) Z_PASTE_3(z_box_, type, _union		    )
#define Z_JOIN_box_type_from_vertices(	       type) Z_PASTE_3(z_box_, type, _from_vertices	    )
#define Z_JOIN_box_type_is_zero(	       type) Z_PASTE_3(z_box_, type, _is_zero		    )
#define Z_JOIN_box_type_center(		       type) Z_PASTE_3(z_box_, type, _center		    )
#define Z_JOIN_box_type_correct(	       type) Z_PASTE_3(z_box_, type, _correct		    )
#define Z_JOIN_box_type_inner_sphere(	       type) Z_PASTE_3(z_box_, type, _inner_sphere	    )
#define Z_JOIN_box_type_to_aabb(	       type) Z_PASTE_3(z_box_, type, _to_aabb		    )
#define Z_JOIN_box_type_absolute_point_to_unit(type) Z_PASTE_3(z_box_, type, _absolute_point_to_unit)
#define Z_JOIN_box_type_unit_point_to_absolute(type) Z_PASTE_3(z_box_, type, _unit_point_to_absolute)
#define Z_JOIN_box_type_contains_point(	       type) Z_PASTE_3(z_box_, type, _contains_point	    )
#define Z_JOIN_box_type_contains_line_segment( type) Z_PASTE_3(z_box_, type, _contains_line_segment )
#define Z_JOIN_box_type_contains_aabb(	       type) Z_PASTE_3(z_box_, type, _contains_aabb	    )
#define Z_JOIN_box_type_contains_sphere(       type) Z_PASTE_3(z_box_, type, _contains_sphere	    )


/* MARK: - Default real type definitions */


#define z_box_are_equal		     Z_JOIN_box_type_are_equal		   (Z_REAL_FIXED_TYPE_name)
#define z_box_contains		     Z_JOIN_box_type_contains		   (Z_REAL_FIXED_TYPE_name)
#define z_box_collide		     Z_JOIN_box_type_collide		   (Z_REAL_FIXED_TYPE_name)
#define z_box_intersection	     Z_JOIN_box_type_intersection	   (Z_REAL_FIXED_TYPE_name)
#define z_box_union		     Z_JOIN_box_type_union		   (Z_REAL_FIXED_TYPE_name)
#define z_box_from_vertices	     Z_JOIN_box_type_from_vertices	   (Z_REAL_FIXED_TYPE_name)
#define z_box_is_zero		     Z_JOIN_box_type_is_zero		   (Z_REAL_FIXED_TYPE_name)
#define z_box_center		     Z_JOIN_box_type_center		   (Z_REAL_FIXED_TYPE_name)
#define z_box_correct		     Z_JOIN_box_type_correct		   (Z_REAL_FIXED_TYPE_name)
#define z_box_inner_sphere	     Z_JOIN_box_type_inner_sphere	   (Z_REAL_FIXED_TYPE_name)
#define z_box_to_aabb		     Z_JOIN_box_type_to_aabb		   (Z_REAL_FIXED_TYPE_name)
#define z_box_absolute_point_to_unit Z_JOIN_box_type_absolute_point_to_unit(Z_REAL_FIXED_TYPE_name)
#define z_box_unit_point_to_absolute Z_JOIN_box_type_unit_point_to_absolute(Z_REAL_FIXED_TYPE_name)
#define z_box_contains_point	     Z_JOIN_box_type_contains_point	   (Z_REAL_FIXED_TYPE_name)
#define z_box_contains_line_segment  Z_JOIN_box_type_contains_line_segment (Z_REAL_FIXED_TYPE_name)
#define z_box_contains_aabb	     Z_JOIN_box_type_contains_aabb	   (Z_REAL_FIXED_TYPE_name)
#define z_box_contains_sphere	     Z_JOIN_box_type_contains_sphere	   (Z_REAL_FIXED_TYPE_name)
