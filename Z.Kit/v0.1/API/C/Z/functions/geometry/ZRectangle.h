...
#define z_rectangle_are_equal		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _are_equal		 )
#define z_rectangle_contains		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _contains		 )
#define z_rectangle_collide		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _collide		 )
#define z_rectangle_intersection	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _intersection		 )
#define z_rectangle_union		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _union		 )
#define z_rectangle_from_vertices	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _from_vertices	 )
#define z_rectangle_is_zero		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _is_zero		 )
#define z_rectangle_minimum_x		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _minimum_x		 )
#define z_rectangle_minimum_y		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _minimum_y		 )
#define z_rectangle_maximum_x		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _maximum_x		 )
#define z_rectangle_maximum_y		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _maximum_y		 )
#define z_rectangle_middle_x		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _middle_x		 )
#define z_rectangle_middle_y		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _middle_y		 )
#define z_rectangle_top_left		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _top_left		 )
#define z_rectangle_top_right		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _top_right		 )
#define z_rectangle_top_center		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _top_center		 )
#define z_rectangle_bottom_left		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _bottom_left		 )
#define z_rectangle_bottom_right	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _bottom_right		 )
#define z_rectangle_bottom_center	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _bottom_center	 )
#define z_rectangle_center_left		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _center_left		 )
#define z_rectangle_center_right	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _center_right		 )
#define z_rectangle_center		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _center		 )
#define z_rectangle_correct		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _correct		 )
#define z_rectangle_top_half		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _top_half		 )
#define z_rectangle_bottom_half		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _bottom_half		 )
#define z_rectangle_left_half		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _left_half		 )
#define z_rectangle_right_half		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _right_half		 )
#define z_rectangle_top_left_quarter	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _top_left_quarter	 )
#define z_rectangle_top_right_quarter	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _top_right_quarter	 )
#define z_rectangle_bottom_left_quarter	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _bottom_left_quarter	 )
#define z_rectangle_bottom_right_quarter   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _bottom_right_quarter	 )
#define z_rectangle_align_in_top_left	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_top_left	 )
#define z_rectangle_align_in_top_right	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_top_right	 )
#define z_rectangle_align_in_top_center	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_top_center	 )
#define z_rectangle_align_in_bottom_left   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_bottom_left	 )
#define z_rectangle_align_in_bottom_right  Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_bottom_right )
#define z_rectangle_align_in_bottom_center Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_bottom_center)
#define z_rectangle_align_in_center_left   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_center_left	 )
#define z_rectangle_align_in_center_right  Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_center_right )
#define z_rectangle_align_in_center	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _align_in_center	 )
#define z_rectangle_fit_in_top_left	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_top_left	 )
#define z_rectangle_fit_in_top_right	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_top_right	 )
#define z_rectangle_fit_in_top_center	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_top_center	 )
#define z_rectangle_fit_in_bottom_left	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_bottom_left	 )
#define z_rectangle_fit_in_bottom_right	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_bottom_right	 )
#define z_rectangle_fit_in_bottom_center   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_bottom_center	 )
#define z_rectangle_fit_in_center_left	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_center_left	 )
#define z_rectangle_fit_in_center_right	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_center_right	 )
#define z_rectangle_fit_in_center	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _fit_in_center	 )
#define z_rectangle_inner_circle	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _inner_circle		 )
#define z_rectangle_to_aabr		   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _to_aabr		 )
#define z_rectangle_absolute_point_to_unit Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _absolute_point_to_unit)
#define z_rectangle_unit_point_to_absolute Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _unit_point_to_absolute)
#define z_rectangle_contains_point	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _contains_point	 )
#define z_rectangle_contains_line_segment  Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _contains_line_segment )
#define z_rectangle_contains_aabr	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _contains_aabr	 )
#define z_rectangle_contains_circle	   Z_JOIN_3(z_rectangle_, Z_REAL_FIXED_TYPE_name, _contains_circle	 )
