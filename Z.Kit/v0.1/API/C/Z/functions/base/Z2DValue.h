...
#define z_2d_type_add(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _add		  )
#define z_2d_type_add_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _add_3		  )
#define z_2d_type_add_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _add_4		  )
#define z_2d_type_add_scalar(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _add_scalar	  )
#define z_2d_type_are_equal(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _are_equal	  )
#define z_2d_type_clamp(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _clamp		  )
#define z_2d_type_contains(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _contains	  )
#define z_2d_type_contains_scalar(   TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _contains_scalar	  )
#define z_2d_type_cross_product(     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _cross_product	  )
#define z_2d_type_divide(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _divide		  )
#define z_2d_type_divide_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _divide_3	  )
#define z_2d_type_divide_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _divide_4	  )
#define z_2d_type_divide_by_scalar(  TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _divide_by_scalar  )
#define z_2d_type_dot_product(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _dot_product	  )
#define z_2d_type_fit(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _fit		  )
#define z_2d_type_from_scalar(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _from_scalar	  )
#define z_2d_type_has_zero(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _has_zero	  )
#define z_2d_type_inner_maximum(     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _inner_maximum	  )
#define z_2d_type_inner_middle(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _inner_middle	  )
#define z_2d_type_inner_minimum(     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _inner_minimum	  )
#define z_2d_type_inner_product(     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _inner_product	  )
#define z_2d_type_inner_sum(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _inner_sum	  )
#define z_2d_type_is_zero(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _is_zero		  )
#define z_2d_type_maximum(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _maximum		  )
#define z_2d_type_middle(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _middle		  )
#define z_2d_type_minimum(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _minimum		  )
#define z_2d_type_multiply(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _multiply	  )
#define z_2d_type_multiply_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _multiply_3	  )
#define z_2d_type_multiply_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _multiply_4	  )
#define z_2d_type_multiply_by_scalar(TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _multiply_by_scalar)
#define z_2d_type_nxy(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _nxy		  )
#define z_2d_type_nyx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _nyx		  )
#define z_2d_type_square_clamp(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _square_clamp	  )
#define z_2d_type_squared_length(    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _squared_length	  )
#define z_2d_type_subtract(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _subtract	  )
#define z_2d_type_subtract_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _subtract_3	  )
#define z_2d_type_subtract_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _subtract_4	  )
#define z_2d_type_subtract_scalar(   TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _subtract_scalar   )
#define z_2d_type_swap(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _swap		  )
#define z_2d_type_xny(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _xny		  )
#define z_2d_type_xyn(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _xyn		  )
#define z_2d_type_ynx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _ynx		  )
#define z_2d_type_yx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _yx		  )
#define z_2d_type_yxn(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _yxn		  )
...
#define z_2d_type_absolute(    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _absolute    )
#define z_2d_type_has_negative(TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _has_negative)
#define z_2d_type_is_negative( TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _is_negative )
#define z_2d_type_negative(    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _negative    )
...
#define z_2d_type_are_almost_equal( TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _are_almost_equal )
#define z_2d_type_are_perpendicular(TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _are_perpendicular)
#define z_2d_type_clamp_01(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _clamp_01		)
#define z_2d_type_has_almost_zero(  TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _has_almost_zero	)
#define z_2d_type_has_finite(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _has_finite	)
#define z_2d_type_has_infinity(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _has_infinity	)
#define z_2d_type_has_nan(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _has_nan		)
#define z_2d_type_inverse_lerp(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _inverse_lerp	)
#define z_2d_type_is_almost_zero(   TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _is_almost_zero	)
#define z_2d_type_is_finite(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _is_finite	)
#define z_2d_type_is_infinity(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _is_infinity	)
#define z_2d_type_is_nan(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _is_nan		)
#define z_2d_type_lerp(		    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _lerp		)
#define z_2d_type_reciprocal(	    TYPE) Z_INSERT_##TYPE##_sized_type(z_2d_, _reciprocal	)
