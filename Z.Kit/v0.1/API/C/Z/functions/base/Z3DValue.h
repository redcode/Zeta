...
#define z_3d_are_equal		Z_INSERT_REAL_fixed_type(z_3d_, _are_equal	   )
#define z_3d_are_almost_equal	Z_INSERT_REAL_fixed_type(z_3d_, _are_almost_equal  )
#define z_3d_are_perpendicular	Z_INSERT_REAL_fixed_type(z_3d_, _are_perpendicular )
#define z_3d_swap		Z_INSERT_REAL_fixed_type(z_3d_, _swap		   )
#define z_3d_contains		Z_INSERT_REAL_fixed_type(z_3d_, _contains	   )
#define z_3d_add		Z_INSERT_REAL_fixed_type(z_3d_, _add		   )
#define z_3d_add_3		Z_INSERT_REAL_fixed_type(z_3d_, _add_3		   )
#define z_3d_add_4		Z_INSERT_REAL_fixed_type(z_3d_, _add_4		   )
#define z_3d_add_scalar		Z_INSERT_REAL_fixed_type(z_3d_, _add_scalar	   )
#define z_3d_subtract		Z_INSERT_REAL_fixed_type(z_3d_, _subtract	   )
#define z_3d_subtract_3		Z_INSERT_REAL_fixed_type(z_3d_, _subtract_3	   )
#define z_3d_subtract_4		Z_INSERT_REAL_fixed_type(z_3d_, _subtract_4	   )
#define z_3d_subtract_scalar	Z_INSERT_REAL_fixed_type(z_3d_, _subtract_scalar   )
#define z_3d_multiply		Z_INSERT_REAL_fixed_type(z_3d_, _multiply	   )
#define z_3d_multiply_3		Z_INSERT_REAL_fixed_type(z_3d_, _multiply_3	   )
#define z_3d_multiply_4		Z_INSERT_REAL_fixed_type(z_3d_, _multiply_4	   )
#define z_3d_multiply_by_scalar	Z_INSERT_REAL_fixed_type(z_3d_, _multiply_by_scalar)
#define z_3d_divide		Z_INSERT_REAL_fixed_type(z_3d_, _divide		   )
#define z_3d_divide_3		Z_INSERT_REAL_fixed_type(z_3d_, _divide_3	   )
#define z_3d_divide_4		Z_INSERT_REAL_fixed_type(z_3d_, _divide_4	   )
#define z_3d_divide_by_scalar	Z_INSERT_REAL_fixed_type(z_3d_, _divide_by_scalar  )
#define z_3d_dot_product	Z_INSERT_REAL_fixed_type(z_3d_, _dot_product	   )
#define z_3d_cross_product	Z_INSERT_REAL_fixed_type(z_3d_, _cross_product	   )
#define z_3d_minimum		Z_INSERT_REAL_fixed_type(z_3d_, _minimum	   )
#define z_3d_maximum		Z_INSERT_REAL_fixed_type(z_3d_, _maximum	   )
#define z_3d_middle		Z_INSERT_REAL_fixed_type(z_3d_, _middle		   )
#define z_3d_fit		Z_INSERT_REAL_fixed_type(z_3d_, _fit		   )
#define z_3d_lerp		Z_INSERT_REAL_fixed_type(z_3d_, _lerp		   )
#define z_3d_inverse_lerp	Z_INSERT_REAL_fixed_type(z_3d_, _inverse_lerp	   )
#define z_3d_from_scalar	Z_INSERT_REAL_fixed_type(z_3d_, _from_scalar	   )
#define z_3d_is_finite		Z_INSERT_REAL_fixed_type(z_3d_, _is_finite	   )
#define z_3d_is_infinity	Z_INSERT_REAL_fixed_type(z_3d_, _is_infinity	   )
#define z_3d_is_nan		Z_INSERT_REAL_fixed_type(z_3d_, _is_nan		   )
#define z_3d_is_negative	Z_INSERT_REAL_fixed_type(z_3d_, _is_negative	   )
#define z_3d_is_zero		Z_INSERT_REAL_fixed_type(z_3d_, _is_zero	   )
#define z_3d_is_almost_zero	Z_INSERT_REAL_fixed_type(z_3d_, _is_almost_zero	   )
#define z_3d_has_finite		Z_INSERT_REAL_fixed_type(z_3d_, _has_finite	   )
#define z_3d_has_infinity	Z_INSERT_REAL_fixed_type(z_3d_, _has_infinity	   )
#define z_3d_has_nan		Z_INSERT_REAL_fixed_type(z_3d_, _has_nan	   )
#define z_3d_has_negative	Z_INSERT_REAL_fixed_type(z_3d_, _has_negative	   )
#define z_3d_has_zero		Z_INSERT_REAL_fixed_type(z_3d_, _has_zero	   )
#define z_3d_has_almost_zero	Z_INSERT_REAL_fixed_type(z_3d_, _has_almost_zero   )
#define z_3d_negative		Z_INSERT_REAL_fixed_type(z_3d_, _negative	   )
#define z_3d_absolute		Z_INSERT_REAL_fixed_type(z_3d_, _absolute	   )
#define z_3d_reciprocal		Z_INSERT_REAL_fixed_type(z_3d_, _reciprocal	   )
#define z_3d_inner_sum		Z_INSERT_REAL_fixed_type(z_3d_, _inner_sum	   )
#define z_3d_inner_product	Z_INSERT_REAL_fixed_type(z_3d_, _inner_product	   )
#define z_3d_inner_minimum	Z_INSERT_REAL_fixed_type(z_3d_, _inner_minimum	   )
#define z_3d_inner_maximum	Z_INSERT_REAL_fixed_type(z_3d_, _inner_maximum	   )
#define z_3d_inner_middle	Z_INSERT_REAL_fixed_type(z_3d_, _inner_middle	   )
#define z_3d_squared_length	Z_INSERT_REAL_fixed_type(z_3d_, _squared_length	   )
#define z_3d_clamp		Z_INSERT_REAL_fixed_type(z_3d_, _clamp		   )
#define z_3d_cube_clamp		Z_INSERT_REAL_fixed_type(z_3d_, _cube_clamp	   )
#define z_3d_cube_clamp_01	Z_INSERT_REAL_fixed_type(z_3d_, _cube_clamp_01	   )
#define z_3d_rotated_as_axes	Z_INSERT_REAL_fixed_type(z_3d_, _rotated_as_axes   )
