...
Z_IMPLEMENTATION_3D_COMMON (Int8,  int8 )
Z_IMPLEMENTATION_3D_SIGNED (Int8,  int8 )
Z_IMPLEMENTATION_3D_INTEGER(Int8,  int8 )
Z_IMPLEMENTATION_3D_COMMON (Int16, int16)
Z_IMPLEMENTATION_3D_SIGNED (Int16, int16)
Z_IMPLEMENTATION_3D_INTEGER(Int16, int16)
Z_IMPLEMENTATION_3D_COMMON (Int32, int32)
Z_IMPLEMENTATION_3D_SIGNED (Int32, int32)
Z_IMPLEMENTATION_3D_INTEGER(Int32, int32)

#ifdef Z_INT64
	Z_IMPLEMENTATION_3D_COMMON (Int64, int64)
	Z_IMPLEMENTATION_3D_SIGNED (Int64, int64)
	Z_IMPLEMENTATION_3D_INTEGER(Int64, int64)
#endif

#ifdef Z_INT128
	Z_IMPLEMENTATION_3D_COMMON (Int128, int128)
	Z_IMPLEMENTATION_3D_SIGNED (Int128, int128)
...
#ifdef Z_FLOAT24
	Z_IMPLEMENTATION_3D_COMMON(Float24, float24)
	Z_IMPLEMENTATION_3D_SIGNED(Float24, float24)
	Z_IMPLEMENTATION_3D_REAL  (Float24, float24, Z_FLOAT24_EPSILON)
#endif
...
#ifdef Z_FLOAT48
	Z_IMPLEMENTATION_3D_COMMON(Float48, float48)
	Z_IMPLEMENTATION_3D_SIGNED(Float48, float48)
	Z_IMPLEMENTATION_3D_REAL  (Float48, float48, Z_FLOAT48_EPSILON)
#endif
...
#ifdef Z_FLOAT72
	Z_IMPLEMENTATION_3D_COMMON(Float72, float72)
	Z_IMPLEMENTATION_3D_SIGNED(Float72, float72)
	Z_IMPLEMENTATION_3D_REAL  (Float72, float72, Z_FLOAT72_EPSILON)
#endif

#ifdef Z_FLOAT80
	Z_IMPLEMENTATION_3D_COMMON(Float80, float80)
	Z_IMPLEMENTATION_3D_SIGNED(Float80, float80)
	Z_IMPLEMENTATION_3D_REAL  (Float80, float80, Z_FLOAT80_EPSILON)
#endif

#ifdef Z_FLOAT96
	Z_IMPLEMENTATION_3D_COMMON(Float96, float96)
	Z_IMPLEMENTATION_3D_SIGNED(Float96, float96)
	Z_IMPLEMENTATION_3D_REAL  (Float96, float96, Z_FLOAT96_EPSILON)
#endif
