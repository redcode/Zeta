...
#define z_3d_type_add(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _add		  )
#define z_3d_type_add_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _add_3		  )
#define z_3d_type_add_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _add_4		  )
#define z_3d_type_add_scalar(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _add_scalar	  )
#define z_3d_type_are_equal(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _are_equal	  )
#define z_3d_type_clamp(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _clamp		  )
#define z_3d_type_contains(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _contains	  )
#define z_3d_type_contains_scalar(   TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _contains_scalar	  )
#define z_3d_type_cross_product(     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _cross_product	  )
#define z_3d_type_cube_clamp(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _cube_clamp	  )
#define z_3d_type_divide(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _divide		  )
#define z_3d_type_divide_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _divide_3	  )
#define z_3d_type_divide_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _divide_4	  )
#define z_3d_type_divide_by_scalar(  TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _divide_by_scalar  )
#define z_3d_type_dot_product(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _dot_product	  )
#define z_3d_type_fit(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _fit		  )
#define z_3d_type_from_scalar(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _from_scalar	  )
#define z_3d_type_has_zero(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _has_zero	  )
#define z_3d_type_inner_maximum(     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _inner_maximum	  )
#define z_3d_type_inner_middle(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _inner_middle	  )
#define z_3d_type_inner_minimum(     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _inner_minimum	  )
#define z_3d_type_inner_product(     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _inner_product	  )
#define z_3d_type_inner_sum(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _inner_sum	  )
#define z_3d_type_is_zero(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _is_zero		  )
#define z_3d_type_maximum(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _maximum		  )
#define z_3d_type_middle(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _middle		  )
#define z_3d_type_minimum(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _minimum		  )
#define z_3d_type_multiply(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _multiply	  )
#define z_3d_type_multiply_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _multiply_3	  )
#define z_3d_type_multiply_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _multiply_4	  )
#define z_3d_type_multiply_by_scalar(TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _multiply_by_scalar)
#define z_3d_type_rotate_as_axes(    TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _rotate_as_axes	  )
#define z_3d_type_squared_length(    TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _squared_length	  )
#define z_3d_type_subtract(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _subtract	  )
#define z_3d_type_subtract_3(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _subtract_3	  )
#define z_3d_type_subtract_4(	     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _subtract_4	  )
#define z_3d_type_subtract_scalar(   TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _subtract_scalar	  )
#define z_3d_type_swap(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _swap		  )
#define z_3d_type_xy(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _xy		  )
#define z_3d_type_xz(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _xz		  )
#define z_3d_type_xzy(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _xzy		  )
#define z_3d_type_yx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _yx		  )
#define z_3d_type_yxz(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _yxz		  )
#define z_3d_type_yz(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _yz		  )
#define z_3d_type_yzx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _yzx		  )
#define z_3d_type_zx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _zx		  )
#define z_3d_type_zxy(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _zxy		  )
#define z_3d_type_zy(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _zy		  )
#define z_3d_type_zyx(		     TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _zyx		  )
...
#define z_3d_type_absolute(    TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _absolute    )
#define z_3d_type_has_negative(TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _has_negative)
#define z_3d_type_is_negative( TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _is_negative )
#define z_3d_type_negative(    TYPE) Z_INSERT_##TYPE##_sized_type(z_3d_, _negative    )
...
#define z_3d_type_are_almost_equal( VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _are_almost_equal )
#define z_3d_type_are_perpendicular(VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _are_perpendicular)
#define z_3d_type_clamp_01(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _clamp_01	 )
#define z_3d_type_has_almost_zero(  VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _has_almost_zero  )
#define z_3d_type_has_finite(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _has_finite	 )
#define z_3d_type_has_infinity(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _has_infinity	 )
#define z_3d_type_has_nan(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _has_nan		 )
#define z_3d_type_inverse_lerp(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _inverse_lerp	 )
#define z_3d_type_is_almost_zero(   VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _is_almost_zero	 )
#define z_3d_type_is_finite(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _is_finite	 )
#define z_3d_type_is_infinity(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _is_infinity	 )
#define z_3d_type_is_nan(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _is_nan		 )
#define z_3d_type_lerp(		    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _lerp		 )
#define z_3d_type_reciprocal(	    VALUE) Z_INSERT_##TYPE##_sized_type(z_3d_, _reciprocal	 )
