...
/* MARK: - Template for rotation operations */


#define Z_TEMPLATE_VALUE_ROTATED(type, bits)					     \
										     \
Z_TEMPLATE_VALUE_ROTATED_SPECIFIER z##type					     \
Z_TEMPLATE_VALUE_ROTATED_PREFIX(type##_rotated_left)(z##type value, zuint rotation)  \
	{return Z_##bits##BIT_ROTATE_LEFT(value, rotation);}			     \
										     \
Z_TEMPLATE_VALUE_ROTATED_SPECIFIER z##type					     \
Z_TEMPLATE_VALUE_ROTATED_PREFIX(type##_rotated_right)(z##type value, zuint rotation) \
...
#define Z_TEMPLATE_VALUE_REVERSED(type, bits, level)				 \
										 \
Z_TEMPLATE_VALUE_REVERSED_SPECIFIER z##type					 \
Z_TEMPLATE_VALUE_REVERSED_PREFIX(type##_reversed_in_##level##bit)(z##type value) \
...
Z_TEMPLATE_VALUE_ROTATED_ALLOW_INTEGER (Z_TEMPLATE_VALUE_ROTATED (int8, 8))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int8, 8, 1))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int8, 8, 2))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int8, 8, 4))

#define z_int8_reversed Z_SAME

Z_TEMPLATE_NATURAL						 (int16)
Z_TEMPLATE_INTEGER						 (int16)
Z_TEMPLATE_VALUE_ROTATED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_ROTATED	 (int16, 16))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int16, 16, 1))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int16, 16, 2))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int16, 16, 4))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int16, 16, 8))

#define z_int16_reversed z_int16_reversed_in_8bit

Z_TEMPLATE_NATURAL						 (int32)
Z_TEMPLATE_INTEGER						 (int32)
Z_TEMPLATE_VALUE_ROTATED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_ROTATED	 (int32, 32))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int32, 32,  1))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int32, 32,  2))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int32, 32,  4))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int32, 32,  8))
Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int32, 32, 16))
...
#define z_int32_reversed z_int32_reversed_in_8bit
	...
	Z_TEMPLATE_VALUE_ROTATED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_ROTATED	 (int64, 64))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int64, 64,  1))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int64, 64,  2))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int64, 64,  4))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int64, 64,  8))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int64, 64, 16))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int64, 64, 32))
...
#	define z_int64_reversed z_int64_reversed_in_8bit
	...
	Z_TEMPLATE_VALUE_ROTATED_ALLOW_INTEGER (Z_TEMPLATE_VALUE_ROTATED (int128, 128))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128,	1))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128,	2))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128,	4))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128,	8))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128, 16))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128, 32))
	Z_TEMPLATE_VALUE_REVERSED_ALLOW_INTEGER(Z_TEMPLATE_VALUE_REVERSED(int128, 128, 64))
...
#if Z_CPU_IS_CAPABLE_OF(64BIT_ATOMICS) && Z_IS_AVAILABLE(UINT64)
...
#if Z_CPU_IS_CAPABLE_OF(64BIT_ATOMICS) && Z_IS_AVAILABLE(INT64)
