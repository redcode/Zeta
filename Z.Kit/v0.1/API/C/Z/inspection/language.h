...
#	define Z_LANGUAGE_HAS(WHAT)			 \
		(!(defined Z_COMPILER_LACKS_##WHAT)   && \
...
#	define Z_LANGUAGE_HAS_TYPE_QUALIFIER(WHICH)			 \
		(!(defined Z_COMPILER_LACKS_TYPE_QUALIFIER_##WHICH)   && \
...
#	define Z_LANGUAGE_HAS_STORAGE_CLASS(WHICH)			\
		(!(defined Z_COMPILER_LACKS_STORAGE_CLASS_##WHICH)   && \
...
#	define Z_LANGUAGE_HAS_SPECIFIER(WHICH)			    \
		(!(defined Z_COMPILER_LACKS_SPECIFIER_##WHICH)	 && \
...
#	define Z_LANGUAGE_HAS_OPERATOR(WHICH)			   \
		(!(defined Z_COMPILER_LACKS_OPERATOR_##WHICH)	&& \
