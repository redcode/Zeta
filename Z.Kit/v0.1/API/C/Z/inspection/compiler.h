...
#define Z_COMPILER_OBJECTIVE_HAS(		  WHAT ) Z_COMPILER_CPP_HAS_##WHAT
#define Z_COMPILER_OBJECTIVE_C_HAS_TYPE(	  WHICH) Z_COMPILER_C_HAS_TYPE_##WHICH
#define Z_COMPILER_OBJECTIVE_C_HAS_TYPE_QUALIFIER(WHICH) Z_COMPILER_C_HAS_TYPE_QUALIFIER_##WHICH
#define Z_COMPILER_OBJECTIVE_C_HAS_STORAGE_CLASS( WHICH) Z_COMPILER_C_HAS_STORAGE_CLASS_##WHICH
#define Z_COMPILER_OBJECTIVE_C_HAS_SPECIFIER(	  WHICH) Z_COMPILER_C_HAS_SPECIFIER_##WHICH
#define Z_COMPILER_OBJECTIVE_C_HAS_OPERATOR(	  WHICH) Z_COMPILER_C_HAS_OPERATOR_##WHICH
#define Z_COMPILER_OBJECTIVE_C_HAS_ATTRIBUTE(	  WHICH) Z_COMPILER_C_HAS_ATTRIBUTE_##WHICH
#define Z_COMPILER_OBJECTIVE_C_ATTRIBUTE(	  WHICH) Z_COMPILER_C_HAS_ATTRIBUTE_##WHICH

#define Z_COMPILER_HAS_VARIABLE(WHICH) Z_COMPILER_HAS_##WHICH
...
#define Z_COMPILER_VARIABLE(WHICH) Z_COMPILER_##WHICH
...
#define Z_COMPILER_HAS_FULL_KR_C		     \
	(Z_COMPILER_C_HAS_TYPE	       (FLOAT   ) && \
	 Z_COMPILER_C_HAS_TYPE	       (DOUBLE  ) && \
	 Z_COMPILER_C_HAS_STORAGE_CLASS(AUTO    ) && \
	 Z_COMPILER_C_HAS_STORAGE_CLASS(EXTERN  ) && \
	 Z_COMPILER_C_HAS_STORAGE_CLASS(REGISTER) && \
	 Z_COMPILER_C_HAS_STORAGE_CLASS(STATIC  ) && \
	 Z_COMPILER_C_HAS_OPERATOR     (SIZE_OF ))

#define Z_COMPILER_HAS_FULL_C89				  \
	(Z_COMPILER_HAS_FULL_KR_C		       && \
	 Z_COMPILER_C_HAS		(ENUMERATION ) && \
	 Z_COMPILER_C_HAS		(VOID_POINTER) && \
	 Z_COMPILER_C_HAS_TYPE		(LDOUBLE     ) && \
	 Z_COMPILER_C_HAS_TYPE_QUALIFIER(CONSTANT    ) && \
	 Z_COMPILER_C_HAS_TYPE_QUALIFIER(VOLATILE    ))

#define Z_COMPILER_HAS_FULL_C90 Z_COMPILER_HAS_FULL_C89
#define Z_COMPILER_HAS_FULL_C94 (Z_COMPILER_HAS_FULL_C89 && Z_COMPILER_C_HAS(DIGRAPH))

#define Z_COMPILER_HAS_FULL_C99							\
	(Z_COMPILER_HAS_FULL_C94					     && \
	 Z_COMPILER_C_HAS		(COMPOUND_LITERAL		   ) && \
	 Z_COMPILER_C_HAS		(CPP_STYLE_COMMENT		   ) && \
	 Z_COMPILER_C_HAS		(DESIGNATED_INITIALIZER		   ) && \
	 Z_COMPILER_C_HAS		(FLEXIBLE_ARRAY_MEMBER		   ) && \
	 Z_COMPILER_C_HAS		(INLINE_FUNCION			   ) && \
	 Z_COMPILER_C_HAS		(MIXED_DECLARATIONS_AND_CODE	   ) && \
	 Z_COMPILER_C_HAS		(VARIADIC_MACRO			   ) && \
	 Z_COMPILER_C_HAS		(VLA				   ) && \
	 Z_COMPILER_C_HAS_TYPE		(ULLONG				   ) && \
	 Z_COMPILER_C_HAS_TYPE		(LLONG				   ) && \
	 Z_COMPILER_C_HAS_TYPE_QUALIFIER(RESTRICT			   ) && \
	 Z_COMPILER_C_HAS_SPECIFIER	(INLINE				   ))

/*
#define Z_COMPILER_HAS_FULL_C11
#define Z_COMPILER_HAS_FULL_CPP98
#define Z_COMPILER_HAS_FULL_CPP11
#define Z_COMPILER_HAS_FULL_CPP14*/
