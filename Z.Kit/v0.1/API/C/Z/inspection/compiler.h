...
#define Z_COMPILER_C_HAS_ATTRIBUTE(	WHICH) (defined Z_COMPILER_C_ATTRIBUTE_##WHICH	       )
...
#define Z_COMPILER_CPP_HAS_ATTRIBUTE(	  WHICH) (defined Z_COMPILER_CPP_ATTRIBUTE_##WHICH	   )
...
#define Z_COMPILER_OBJECTIVE_C_HAS_ATTRIBUTE(	  WHICH) (defined Z_COMPILER_C_ATTRIBUTE_##WHICH	 )
...
#define Z_COMPILER_HAS_KEY(	WHICH) (defined Z_COMPILER_KEY_##WHICH	   )
#define Z_COMPILER_HAS_CONSTANT(WHICH) (defined Z_COMPILER_CONSTANT_##WHICH)
#define Z_COMPILER_HAS_TYPE(	WHICH) (defined Z_COMPILER_TYPE_##WHICH	   )
...
#define Z_COMPILER_KEY(	     WHICH) Z_COMPILER_KEY_##WHICH
