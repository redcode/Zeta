...
#elif	defined(__amd64	  ) || /* Clang, GCC, Oracle Solaris Studio */ \
...
#else
#	error "Target Processor architecture not detected."
#endif
...
#define Z_CPU_KEY(		 WHICH)	Z_INSERT_CPU_ARCHITECTURE(Z_, _##WHICH)
#define Z_CPU_INTEGER_ENDIANNESS(BITS )	Z_CPU_INTEGER_ENDIANNESS_##BITS

#if Z_CPU(INTEGER_FORMAT) == Z_INTEGER_FORMAT_2S_COMPLEMENT
#	define Z_CPU_INTEGER_FORMAT(BITS) Z_VALUE_FORMAT_##BITS##_2S_COMPLEMENT_INTEGER
#elif Z_CPU(INTEGER_FORMAT) == Z_INTEGER_FORMAT_1S_COMPLEMENT
#	define Z_CPU_INTEGER_FORMAT(BITS) Z_VALUE_FORMAT_##BITS##_1S_COMPLEMENT_INTEGER
#endif
...
#	define Z_CPU_INTEGER_ENDIANNESS_16BIT Z_CPU(INTEGER_ENDIANNESS_16BIT)
#else
#	define Z_CPU_INTEGER_ENDIANNESS_16BIT Z_CPU(INTEGER_ENDIANNESS)
#endif
...
#	define Z_CPU_INTEGER_ENDIANNESS_32BIT Z_CPU(INTEGER_ENDIANNESS_32BIT)
#else
#	define Z_CPU_INTEGER_ENDIANNESS_32BIT Z_CPU(INTEGER_ENDIANNESS)
#endif
...
#	define Z_CPU_INTEGER_ENDIANNESS_64BIT Z_CPU(INTEGER_ENDIANNESS_64BIT)
#else
#	define Z_CPU_INTEGER_ENDIANNESS_64BIT Z_CPU(INTEGER_ENDIANNESS)
#endif
...
#	define Z_CPU_INTEGER_ENDIANNESS_128BIT Z_CPU(INTEGER_ENDIANNESS_128BIT)
#else
#	define Z_CPU_INTEGER_ENDIANNESS_128BIT Z_CPU(INTEGER_ENDIANNESS)
#endif
