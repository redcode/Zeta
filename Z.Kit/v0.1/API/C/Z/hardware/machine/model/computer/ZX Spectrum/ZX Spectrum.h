...
#define Z_ZX_SPECTRUM_SCREEN_PIXELS			 (352 * 296)
#define Z_ZX_SPECTRUM_SCREEN_PAPER_WIDTH		 256
#define Z_ZX_SPECTRUM_SCREEN_PAPER_HEIGHT		 192
#define Z_ZX_SPECTRUM_SCREEN_PAPER_PIXELS		 (256 * 192)
...
#define Z_ZX_SPECTRUM_CYCLES_AT_INVISIBLE_TOP_BORDER Z_ZX_SPECTRUM_CYCLES_PER_VBLANK

#define Z_ZX_SPECTRUM_CYCLES_AT_VISIBLE_TOP_BORDER   (Z_ZX_SPECTRUM_CYCLES_AT_INVISIBLE_TOP_BORDER + \
						      Z_ZX_SPECTRUM_CYCLES_PER_SCANLINE		   * \
						      Z_ZX_SPECTRUM_SCREEN_INVISIBLE_TOP_BORDER_HEIGHT)

#define Z_ZX_SPECTRUM_CYCLES_AT_PAPER_REGION	     (Z_ZX_SPECTRUM_CYCLES_AT_VISIBLE_TOP_BORDER + \
						      Z_ZX_SPECTRUM_CYCLES_PER_SCANLINE		 * \
						      Z_ZX_SPECTRUM_SCREEN_VISIBLE_TOP_BORDER_HEIGHT)

#define Z_ZX_SPECTRUM_CYCLES_AT_BOTTOM_BORDER	     (Z_ZX_SPECTRUM_CYCLES_AT_PAPER_REGION + \
						      Z_ZX_SPECTRUM_CYCLES_PER_SCANLINE	   * \
						      Z_ZX_SPECTRUM_SCREEN_PAPER_HEIGHT)

#define Z_ZX_SPECTRUM_CYCLES_AT_LINE(region, line)   (Z_ZX_SPECTRUM_CYCLES_AT_##region	+ \
						      Z_ZX_SPECTRUM_CYCLES_PER_SCANLINE * line)
