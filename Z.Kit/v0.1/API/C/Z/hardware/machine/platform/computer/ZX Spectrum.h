...
#define Z_ZX_SPECTRUM_VIDEO_RAM_SIZE		  ((1024 * 6) + 768)
#define Z_ZX_SPECTRUM_VIDEO_CHARACTER_RAM_SIZE	   (1024 * 6)
#define Z_ZX_SPECTRUM_VIDEO_ATTRIBUTE_RAM_SIZE			768
...
Z_DEFINE_STRICT_STRUCTURE (
	zuint8			  characters[Z_ZX_SPECTRUM_VIDEO_CHARACTER_RAM_SIZE];
	ZZXSpectrumColorAttribute attributes[Z_ZX_SPECTRUM_VIDEO_ATTRIBUTE_RAM_SIZE];
) ZZXSpectrumVRAM;
...
#define Z_ZX_SPECTRUM_KEY_ROW_0		   3
#define Z_ZX_SPECTRUM_KEY_ROW_1		   4
#define Z_ZX_SPECTRUM_KEY_ROW_2		   4
#define Z_ZX_SPECTRUM_KEY_ROW_3		   4
#define Z_ZX_SPECTRUM_KEY_ROW_4		   4
#define Z_ZX_SPECTRUM_KEY_ROW_5		   4
#define Z_ZX_SPECTRUM_KEY_ROW_6		   3
#define Z_ZX_SPECTRUM_KEY_ROW_7		   3
#define Z_ZX_SPECTRUM_KEY_ROW_8		   3
#define Z_ZX_SPECTRUM_KEY_ROW_9		   3
...
#define Z_ZX_SPECTRUM_ADC_PULSES_PER_HEADER_PILOT	8064 /* 5 seconds */
#define Z_ZX_SPECTRUM_ADC_PULSES_PER_DATA_PILOT		3224 /*	2 seconds */
...
#define Z_ZX_SPECTRUM_ADC_BLOCK_HEADER(p) ((ZZXSpectrumADCBlockHeader *)(p))
