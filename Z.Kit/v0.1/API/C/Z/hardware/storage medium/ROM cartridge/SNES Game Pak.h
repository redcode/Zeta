/* Z Kit C API - hardware/storage medium/ROM cartridge/SNES Game Pak.h
	      __	   __
...
#define Z_SNES_GAME_PAK_REGION_JAPAN				  0
#define Z_SNES_GAME_PAK_REGION_USA				  1
#define Z_SNES_GAME_PAK_REGION_AUSTRALIA_EUROPE_OCEANIA_AND_ASIA  2
#define Z_SNES_GAME_PAK_REGION_SWEDEN				  3
#define Z_SNES_GAME_PAK_REGION_FINLAND				  4
#define Z_SNES_GAME_PAK_REGION_DENMARK				  5
#define Z_SNES_GAME_PAK_REGION_FRANCE				  6
#define Z_SNES_GAME_PAK_REGION_HOLLAND				  7
#define Z_SNES_GAME_PAK_REGION_SPAIN				  8
#define Z_SNES_GAME_PAK_REGION_GERMANY_AUSTRIA_AND_SWITZERLAND	  9
#define Z_SNES_GAME_PAK_REGION_ITALY				 10
#define Z_SNES_GAME_PAK_REGION_HONG_KONG_AND_CHINA		 11
#define Z_SNES_GAME_PAK_REGION_INDONESIA			 12
#define Z_SNES_GAME_PAK_REGION_KOREA				 13
