...
#ifndef __Z_formats_keymap_Z_H__
#define __Z_formats_keymap_Z_H__
...
#define Z_KEY_CODE_ANSI_KEYPAD_7                 00
#define Z_KEY_CODE_ANSI_KEYPAD_8                 01
#define Z_KEY_CODE_ANSI_KEYPAD_9                 02
#define Z_KEY_CODE_APPLE_ANSI_KEYPAD_EQUALS_SIGN 03 /* Apple keyboards */
#define Z_KEY_CODE_UNUSED_1                      04 /* Unused */
#define Z_KEY_CODE_UNUSED_2                      05 /* Unused */
#define Z_KEY_CODE_UNUSED_3                      06 /* Unused */
#define Z_KEY_CODE_UNUSED_4                      07 /* Unused */
#define Z_KEY_CODE_UNUSED_5                      08 /* Unused */
#define Z_KEY_CODE_UNUSED_6                      09 /* Unused */
#define Z_KEY_CODE_UNUSED_7                      10 /* Unused */
#define Z_KEY_CODE_UNUSED_8                      11 /* Unused */
#define Z_KEY_CODE_UNUSED_9                      12 /* Unused */
#define Z_KEY_CODE_UNUSED_10                     13 /* Unused */
#define Z_KEY_CODE_UNUSED_11                     14 /* Unused */
#define Z_KEY_CODE_JIS_EISU                      15 /* Japanese keyboards */
#define Z_KEY_CODE_JIS_KANA                      16 /* Japanese keyboards */
#define Z_KEY_CODE_JIS_LOW_LINE                  17 /* Japanese keyboards */
#define Z_KEY_CODE_JIS_YEN_SIGN                  18 /* Japanese keyboards */
#define Z_KEY_CODE_JIS_KEYPAD_COMMA              19 /* Japanese keyboards */
#define Z_KEY_CODE_ISO_SECTION                   20 /* ISO keyboards */
#define Z_KEY_CODE_APPLE_F16                     21 /* Apple keyboards */
#define Z_KEY_CODE_APPLE_F17                     22 /* Apple keyboards */
#define Z_KEY_CODE_APPLE_F18                     23 /* Apple keyboards */
#define Z_KEY_CODE_APPLE_F19                     24 /* Apple keyboards */
#define Z_KEY_CODE_APPLE_F20                     25 /* Apple keyboards */
#define Z_KEY_CODE_FUNCTION                      26
#define Z_KEY_CODE_DELETE                        27 /* Similar to ASCII */

#endif /* __Z_formats_keymap_Z_H__ */
