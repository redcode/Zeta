/* Z Kit C API - formats/character set/ASCII.h
...
#ifndef __Z_formats_character_set_ASCII_H__
#define __Z_formats_character_set_ASCII_H__
...
#endif /* __Z_formats_character_set_ASCII_H__ */
