/* Z Kit C API - formats/hardware snapshot/machine/ZX Spectrum/SNA.h
	      __	   __
...
/\					       \
\_| Extensions: .sna, .snap, .snapshot		|
  | Endianness: Little				|
  | Created by: Unknown				|
...
#ifndef __Z_formats_hardware_snapshot_machine_ZX_Spectrum_SNA_H__
#define __Z_formats_hardware_snapshot_machine_ZX_Spectrum_SNA_H__
