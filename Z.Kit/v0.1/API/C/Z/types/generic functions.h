...
#define ZCompareType(	     TYPE) Z_INSERT_##TYPE##_SizedType(ZCompare,	 )
#define ZCompareTypeWithData(TYPE) Z_INSERT_##TYPE##_SizedType(ZCompare, WithData)

#define ZHandleContextIndexAndType(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContextIndexAnd,		)
#define ZHandleContextIndexTypeAndStop(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContextIndex,    AndStop	)
#define ZHandleContextIndexTypeAndData(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContextIndex,    AndData	)
#define ZHandleContextIndexTypeDataAndStop(TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContextIndex,    DataAndStop)
#define ZHandleContextAndType(		   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContextAnd,			)
#define ZHandleContextTypeAndStop(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContext,	     AndStop	)
#define ZHandleContextTypeAndData(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContext,	     AndData	)
#define ZHandleContextTypeDataAndStop(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleContext,	     DataAndStop)
#define ZHandleIndexAndType(		   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleIndexAnd,			)
#define ZHandleIndexTypeAndStop(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleIndex,	     AndStop	)
#define ZHandleIndexTypeAndData(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleIndex,	     AndData	)
#define ZHandleIndexTypeDataAndStop(	   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandleIndex,	     DataAndStop)
#define ZHandleType(			   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandle,				)
#define ZHandleTypeAndStop(		   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandle,		     AndStop	)
#define ZHandleTypeAndData(		   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandle,		     AndData	)
#define ZHandleTypeDataAndStop(		   TYPE) Z_INSERT_##TYPE##_SizedType(ZHandle,		     DataAndStop)

#define ZValidateContextIndexAndType(	 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidateContextIndexAnd,	    )
#define ZValidateContextIndexTypeAndData(TYPE) Z_INSERT_##TYPE##_SizedType(ZValidateContextIndex,    AndData)
#define ZValidateContextAndType(	 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidateContextAnd,		    )
#define ZValidateContextTypeAndData(	 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidateContext,	     AndData)
#define ZValidateIndexAndType(		 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidateIndexAnd,		    )
#define ZValidateIndexTypeAndData(	 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidateIndex,	     AndData)
#define ZValidateType(			 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidate,			    )
#define ZValidateTypeAndData(		 TYPE) Z_INSERT_##TYPE##_SizedType(ZValidate,		     AndData)
