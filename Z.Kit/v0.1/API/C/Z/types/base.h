...
#define Z_UINT8_SIZED_VALUE_TYPE		Z_VALUE_TYPE_UINT8
...
#define Z_UINT16_SIZED_VALUE_TYPE		Z_VALUE_TYPE_UINT16
...
#define Z_UINT32_SIZED_VALUE_TYPE		Z_VALUE_TYPE_UINT32
...
#	define Z_UINT64_SIZED_VALUE_TYPE	Z_VALUE_TYPE_UINT64
...
#	define Z_UINT128_SIZED_VALUE_TYPE	Z_VALUE_TYPE_UINT128
...
#define Z_INT8_SIZED_VALUE_TYPE			Z_VALUE_TYPE_INT8
...
#define Z_INT16_SIZED_VALUE_TYPE		Z_VALUE_TYPE_INT16
...
#define Z_INT32_SIZED_VALUE_TYPE		Z_VALUE_TYPE_INT32
...
#	define Z_INT64_SIZED_VALUE_TYPE		Z_VALUE_TYPE_INT64
...
#	if Z_DATA_MODEL_HAS_LITERAL(INT64)
...
#	define Z_INT128_SIZED_VALUE_TYPE	Z_VALUE_TYPE_INT128
...
#	define Z_FLOAT16_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT16
...
#	define Z_FLOAT24_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT24
...
#	define Z_FLOAT32_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT32
...
#	define Z_FLOAT48_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT48
...
#	define Z_FLOAT64_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT64
...
#	define Z_FLOAT72_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT72
...
#	define Z_FLOAT80_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT80
...
#	define Z_FLOAT96_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT96
...
#	define Z_FLOAT128_SIZED_VALUE_TYPE	Z_VALUE_TYPE_FLOAT128
...
#define ztype(			   TYPE)	Z_INSERT_##TYPE##_sized_type(z, )
#define Z2DType(		   TYPE)	Z_INSERT_##TYPE##_SizedType(Z2D,)
#define Z3DType(		   TYPE)	Z_INSERT_##TYPE##_SizedType(Z3D,)
#define Z4DType(		   TYPE)	Z_INSERT_##TYPE##_SizedType(Z4D,)
#define Z_TYPE(			   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_,		     )
#define Z_TYPE_BASE_VALUE_TYPE(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _BASE_VALUE_TYPE    )
#define Z_TYPE_VALUE_TYPE(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _VALUE_TYPE	     )
#define Z_TYPE_VALUE_FORMAT(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _VALUE_FORMAT	     )
#define Z_TYPE_ENDIANNESS(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _ENDIANNESS	     )
#define Z_TYPE_SIZE(		   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _SIZE		     )
#define Z_TYPE_BIAS(		   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _BIAS		     )
#define Z_TYPE_DECIMAL_DIGITS(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _DECIMAL_DIGITS     )
#define Z_TYPE_SIGNIFICAND_OFFSET( TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _SIGNIFICAND_OFFSET )
#define Z_TYPE_SIGNIFICAND_BITS(   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _SIGNIFICAND_BITS   )
#define Z_TYPE_SIGNIFICAND_DIGITS( TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _SIGNIFICAND_DIGITS )
#define Z_TYPE_EXPONENT_OFFSET(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_OFFSET    )
#define Z_TYPE_EXPONENT_BITS(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_BITS      )
#define Z_TYPE_EXPONENT_RADIX(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_RADIX     )
#define Z_TYPE_EXPONENT_MINIMUM(   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_MINIMUM   )
#define Z_TYPE_EXPONENT_MAXIMUM(   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_MAXIMUM   )
#define Z_TYPE_EXPONENT_10_MINIMUM(TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_10_MINIMUM)
#define Z_TYPE_EXPONENT_10_MAXIMUM(TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EXPONENT_10_MAXIMUM)
#define Z_TYPE_SIGN_OFFSET(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _SIGN_OFFSET	     )
#define Z_TYPE_SIGN_BITS(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _SIGN_BITS	     )
#define Z_TYPE_EPSILON(		   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _EPSILON	     )
...
#define Z_TYPE_INFINITY(	   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _INFINITY	     )
#define Z_TYPE_NAN(		   TYPE)	Z_INSERT_##TYPE##_SIZED_TYPE(Z_, _NAN		     )

/* MARK: - Sized types for binary operations */

typedef zuint8					zbint8;
#define Z_BINT8					Z_UINT8
#define Z_BINT8_BASE_VALUE_TYPE			Z_UINT8_BASE_VALUE_TYPE
#define Z_BINT8_SIZED_VALUE_TYPE		Z_UINT8_SIZED_VALUE_TYPE
...
#define Z_BINT16_SIZED_VALUE_TYPE		Z_UINT16_SIZED_VALUE_TYPE
...
#define Z_BINT32_SIZED_VALUE_TYPE		Z_UINT32_SIZED_VALUE_TYPE
...
#	define Z_BINT64_SIZED_VALUE_TYPE	Z_UINT64_SIZED_VALUE_TYPE
...
#	define Z_BINT64_SIZED_VALUE_TYPE	Z_INT64_SIZED_VALUE_TYPE
...
#	define Z_BINT128_SIZED_VALUE_TYPE	Z_UINT128_SIZED_VALUE_TYPE
...
#	define Z_BINT128_SIZED_VALUE_TYPE	Z_INT128_SIZED_VALUE_TYPE
...
#define Z_UCHAR_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE  (UCHAR)
...
#define Z_USHORT_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE  (USHORT)
...
#define Z_UINT_SIZED_VALUE_TYPE			Z_TYPE_VALUE_TYPE  (UINT)
...
#define Z_ULONG_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE  (ULONG)
...
#	define Z_ULLONG_SIZED_VALUE_TYPE	Z_TYPE_VALUE_TYPE  (ULLONG)
...
#define Z_CHAR_SIZED_VALUE_TYPE			Z_TYPE_VALUE_TYPE  (CHAR)
...
#define Z_SHORT_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE  (SHORT)
...
#define Z_INT_SIZED_VALUE_TYPE			Z_TYPE_VALUE_TYPE  (INT)
...
#define Z_LONG_SIZED_VALUE_TYPE			Z_TYPE_VALUE_TYPE  (LONG)
...
#	define Z_LLONG_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE  (LLONG)
...
#	define Z_FLOAT_SIZED_VALUE_TYPE		Z_TYPE_SIZED_VALUE_TYPE	  (FLOAT)
...
#	define Z_DOUBLE_SIZED_VALUE_TYPE	Z_TYPE_SIZED_VALUE_TYPE	  (DOUBLE)
...
#	define Z_LDOUBLE_SIZED_VALUE_TYPE	Z_TYPE_SIZED_VALUE_TYPE	  (LDOUBLE)
...
#define Z_SIZE_SIZED_VALUE_TYPE			Z_TYPE_VALUE_TYPE     (SIZE)
...
#define Z_SSIZE_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (SSIZE)
...
#define Z_UINTMAX_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (UINTMAX)
...
#define Z_INTMAX_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (INTMAX)
...
#	define Z_BINTMAX_SIZED_VALUE_TYPE	Z_UINTMAX_SIZED_VALUE_TYPE
...
#	define Z_BINTMAX_SIZED_VALUE_TYPE	Z_INTMAX_SIZED_VALUE_TYPE
...
#define Z_UINTPTR_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (UINTPTR)
...
#define Z_INTPTR_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (INTPTR)
...
#define Z_UINTTOP_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (UINTTOP)
...
#define Z_INTTOP_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (INTTOP)
...
#	define Z_BINTTOP_SIZED_VALUE_TYPE	Z_UINTTOP_SIZED_VALUE_TYPE
...
#	define Z_BINTTOP_SIZED_VALUE_TYPE	Z_INTTOP_SIZED_VALUE_TYPE
...
#define Z_BOOLEAN_SIZED_VALUE_TYPE		Z_UINT8_SIZED_VALUE_TYPE
...
#define Z_CHARACTER_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (CHARACTER)
...
#define Z_NATURAL_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (NATURAL)
...
#define Z_INTEGER_SIZED_VALUE_TYPE		Z_TYPE_VALUE_TYPE     (INTEGER)
...
#	define Z_REAL_SIZED_VALUE_TYPE		Z_TYPE_SIZED_VALUE_TYPE	  (REAL)
...
#define ZRangeType(TYPE)			Z_INSERT_##TYPE##_SizedType(ZRange,)
