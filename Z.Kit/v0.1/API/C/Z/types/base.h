...
#	define Z_UINT128_BASE_TYPE		Z_VALUE_TYPE_UINT128
#	define Z_UINT128_FIXED_TYPE		Z_VALUE_TYPE_UINT128
#	define Z_UINT128_TYPE			Z_VALUE_TYPE_UINT128
...
#define Z_UINTX_ENDIANNESS(BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _ENDIANNESS))
#define Z_UINTX_SIZE(	   BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _SIZE	  ))
#define Z_UINTX_MINIMUM(   BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _MINIMUM   ))
#define Z_UINTX_MAXIMUM(   BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _MAXIMUM   ))
#define Z_UINTX_NAME(	   BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _NAME	  ))
#define Z_UINTX_Name(	   BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _Name	  ))
#define Z_UINTX_name(	   BITS)		Z_PREFIX_Z_UINT(Z_JOIN_2(BITS, _name	  ))
...
#	define Z_INT128_BASE_TYPE		Z_VALUE_TYPE_INT128
#	define Z_INT128_FIXED_TYPE		Z_VALUE_TYPE_INT128
#	define Z_INT128_TYPE			Z_VALUE_TYPE_INT128
...
#define Z_INTX_ENDIANNESS(BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _ENDIANNESS))
#define Z_INTX_SIZE(	  BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _SIZE	 ))
#define Z_INTX_MINIMUM(	  BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _MINIMUM	 ))
#define Z_INTX_MAXIMUM(	  BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _MAXIMUM	 ))
#define Z_INTX_NAME(	  BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _NAME	 ))
#define Z_INTX_Name(	  BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _Name	 ))
#define Z_INTX_name(	  BITS)			Z_PREFIX_Z_INT(Z_JOIN_2(BITS, _name	 ))
...
#define Z_UCHAR_FIXED_TYPE_NAME			Z_UINTX_NAME   (Z_UCHAR_BITS)
#define Z_UCHAR_FIXED_TYPE_Name			Z_UINTX_Name   (Z_UCHAR_BITS)
#define Z_UCHAR_FIXED_TYPE_name			Z_UINTX_name   (Z_UCHAR_BITS)
#define Z_UCHAR_NAME				UCHAR
#define Z_UCHAR_Name				UChar
#define Z_UCHAR_name				uchar
...
#define Z_USHORT_FIXED_TYPE_NAME		Z_UINTX_NAME	  (Z_USHORT_BITS)
#define Z_USHORT_FIXED_TYPE_Name		Z_UINTX_Name	  (Z_USHORT_BITS)
#define Z_USHORT_FIXED_TYPE_name		Z_UINTX_name	  (Z_USHORT_BITS)
#define Z_USHORT_NAME				USHORT
#define Z_USHORT_Name				UShort
#define Z_USHORT_name				ushort
...
#define Z_UINT_FIXED_TYPE_NAME			Z_UINTX_NAME	  (Z_UINT_BITS)
#define Z_UINT_FIXED_TYPE_Name			Z_UINTX_Name	  (Z_UINT_BITS)
#define Z_UINT_FIXED_TYPE_name			Z_UINTX_name	  (Z_UINT_BITS)
#define Z_UINT_NAME				UINT
#define Z_UINT_Name				UInt
#define Z_UINT_name				uint
...
#define Z_ULONG_FIXED_TYPE_NAME			Z_UINTX_NAME	  (Z_ULONG_BITS)
#define Z_ULONG_FIXED_TYPE_Name			Z_UINTX_Name	  (Z_ULONG_BITS)
#define Z_ULONG_FIXED_TYPE_name			Z_UINTX_name	  (Z_ULONG_BITS)
#define Z_ULONG_NAME				ULONG
#define Z_ULONG_Name				ULong
#define Z_ULONG_name				ulong
...
#	define Z_ULLONG_FIXED_TYPE_NAME		Z_UINTX_NAME	  (Z_ULLONG_BITS)
#	define Z_ULLONG_FIXED_TYPE_Name		Z_UINTX_Name	  (Z_ULLONG_BITS)
#	define Z_ULLONG_FIXED_TYPE_name		Z_UINTX_name	  (Z_ULLONG_BITS)
#	define Z_ULLONG_NAME			UULLONG
#	define Z_ULLONG_Name			UULLong
#	define Z_ULLONG_name			uullong
...
#	define Z_ULLONG_FIXED_TYPE_NAME		Z_ULLONG_FIXED_TYPE_NAME
#	define Z_ULLONG_FIXED_TYPE_Name		Z_ULLONG_FIXED_TYPE_Name
#	define Z_ULLONG_FIXED_TYPE_name		Z_ULLONG_FIXED_TYPE_name
#	define Z_ULLONG_NAME			Z_ULLONG_NAME
#	define Z_ULLONG_Name			Z_ULLONG_Name
#	define Z_ULLONG_name			Z_ULLONG_name
...
#define Z_CHAR_FIXED_TYPE_NAME			Z_INTX_NAME   (Z_CHAR_BITS)
#define Z_CHAR_FIXED_TYPE_Name			Z_INTX_Name   (Z_CHAR_BITS)
#define Z_CHAR_FIXED_TYPE_name			Z_INTX_name   (Z_CHAR_BITS)
#define Z_CHAR_NAME				UCHAR
#define Z_CHAR_Name				UChar
#define Z_CHAR_name				uchar
...
#define Z_SHORT_FIXED_TYPE_NAME			Z_INTX_NAME	 (Z_SHORT_BITS)
#define Z_SHORT_FIXED_TYPE_Name			Z_INTX_Name	 (Z_SHORT_BITS)
#define Z_SHORT_FIXED_TYPE_name			Z_INTX_name	 (Z_SHORT_BITS)
#define Z_SHORT_NAME				USHORT
#define Z_SHORT_Name				UShort
#define Z_SHORT_name				ushort
...
#define Z_INT_FIXED_TYPE_NAME			Z_INTX_NAME	 (Z_INT_BITS)
#define Z_INT_FIXED_TYPE_Name			Z_INTX_Name	 (Z_INT_BITS)
#define Z_INT_FIXED_TYPE_name			Z_INTX_name	 (Z_INT_BITS)
#define Z_INT_NAME				UINT
#define Z_INT_Name				UInt
#define Z_INT_name				uint
...
#define Z_LONG_FIXED_TYPE_NAME			Z_INTX_NAME	 (Z_LONG_BITS)
#define Z_LONG_FIXED_TYPE_Name			Z_INTX_Name	 (Z_LONG_BITS)
#define Z_LONG_FIXED_TYPE_name			Z_INTX_name	 (Z_LONG_BITS)
#define Z_LONG_NAME				ULONG
#define Z_LONG_Name				ULong
#define Z_LONG_name				ulong
...
#	define Z_LLONG_FIXED_TYPE_NAME		Z_INTX_NAME	 (Z_LLONG_BITS)
#	define Z_LLONG_FIXED_TYPE_Name		Z_INTX_Name	 (Z_LLONG_BITS)
#	define Z_LLONG_FIXED_TYPE_name		Z_INTX_name	 (Z_LLONG_BITS)
#	define Z_LLONG_NAME			ULLONG
#	define Z_LLONG_Name			ULLong
#	define Z_LLONG_name			ullong
...
#	define Z_LLONG_FIXED_TYPE_NAME		Z_LLONG_FIXED_TYPE_NAME
#	define Z_LLONG_FIXED_TYPE_Name		Z_LLONG_FIXED_TYPE_Name
#	define Z_LLONG_FIXED_TYPE_name		Z_LLONG_FIXED_TYPE_name
#	define Z_LLONG_NAME			Z_LLONG_NAME
#	define Z_LLONG_Name			Z_LLONG_Name
#	define Z_LLONG_name			Z_LLONG_name
...
#define Z_DOUBLE_NAME				DOUBLE
#define Z_DOUBLE_Name				Double
#define Z_DOUBLE_name				double

#define Z_LDOUBLE_NAME				LDOUBLE
#define Z_LDOUBLE_Name				LDouble
#define Z_LDOUBLE_name				ldouble
...
#	define Z_LDOUBLE_FIXED_TYPE_NAME	LDOUBLE
#	define Z_LDOUBLE_FIXED_TYPE_Name	LDouble
#	define Z_LDOUBLE_FIXED_TYPE_name	ldouble
...
#	define Z_LDOUBLE_FIXED_TYPE_NAME	Z_DOUBLE_NAME
#	define Z_LDOUBLE_FIXED_TYPE_Name	Z_DOUBLE_Name
#	define Z_LDOUBLE_FIXED_TYPE_name	Z_DOUBLE_name
...
#define Z_SIZE_FIXED_TYPE_NAME			Z_UINTX_NAME	  (Z_SIZE_BITS)
#define Z_SIZE_FIXED_TYPE_Name			Z_UINTX_Name	  (Z_SIZE_BITS)
#define Z_SIZE_FIXED_TYPE_name			Z_UINTX_name	  (Z_SIZE_BITS)
#define Z_SIZE_NAME				SIZE
#define Z_SIZE_Name				Size
#define Z_SIZE_name				size
...
#define Z_SSIZE_FIXED_TYPE_NAME			Z_INTX_NAME	 (Z_SSIZE_BITS)
#define Z_SSIZE_FIXED_TYPE_Name			Z_INTX_Name	 (Z_SSIZE_BITS)
#define Z_SSIZE_FIXED_TYPE_name			Z_INTX_name	 (Z_SSIZE_BITS)
#define Z_SSIZE_NAME				USSIZE
#define Z_SSIZE_Name				USSize
#define Z_SSIZE_name				ussize
...
#define Z_UINTMAX_FIXED_TYPE_NAME		Z_UINTX_NAME	  (Z_UINTMAX_BITS)
#define Z_UINTMAX_FIXED_TYPE_Name		Z_UINTX_Name	  (Z_UINTMAX_BITS)
#define Z_UINTMAX_FIXED_TYPE_name		Z_UINTX_name	  (Z_UINTMAX_BITS)
#define Z_UINTMAX_NAME				UINTMAX
#define Z_UINTMAX_Name				UIntMax
#define Z_UINTMAX_name				uintmax
...
#define Z_INTMAX_FIXED_TYPE_NAME		Z_INTX_NAME	 (Z_INTMAX_BITS)
#define Z_INTMAX_FIXED_TYPE_Name		Z_INTX_Name	 (Z_INTMAX_BITS)
#define Z_INTMAX_FIXED_TYPE_name		Z_INTX_name	 (Z_INTMAX_BITS)
#define Z_INTMAX_NAME				UINTMAX
#define Z_INTMAX_Name				UIntMax
#define Z_INTMAX_name				uintmax
...
#define Z_POINTER_FIXED_TYPE			Z_UINTX_TYPE  (Z_POINTER_BITS)
#define Z_POINTER_BASE_TYPE			Z_VALUE_TYPE_POINTER
#define Z_POINTER_FORMAT			Z_UINTX_FORMAT(Z_UINTPTR_BITS)
#define Z_POINTER_SIZE				Z_UINTX_SIZE  (Z_UINTPTR_BITS)
...
#define Z_UINTPTR_FIXED_TYPE_NAME		Z_UINTX_NAME	  (Z_UINTPTR_BITS)
#define Z_UINTPTR_FIXED_TYPE_Name		Z_UINTX_Name	  (Z_UINTPTR_BITS)
#define Z_UINTPTR_FIXED_TYPE_name		Z_UINTX_name	  (Z_UINTPTR_BITS)
#define Z_UINTPTR_NAME				UINTPTR
#define Z_UINTPTR_Name				UIntPtr
#define Z_UINTPTR_name				uintptr
...
#define Z_INTPTR_FIXED_TYPE_NAME		Z_INTX_NAME	 (Z_INTPTR_BITS)
#define Z_INTPTR_FIXED_TYPE_Name		Z_INTX_Name	 (Z_INTPTR_BITS)
#define Z_INTPTR_FIXED_TYPE_name		Z_INTX_name	 (Z_INTPTR_BITS)
#define Z_INTPTR_NAME				UINTPTR
#define Z_INTPTR_Name				UIntPtr
#define Z_INTPTR_name				uintptr
...
#define Z_UINTTOP_FIXED_TYPE_NAME		Z_UINTX_NAME	  (Z_UINTTOP_BITS)
#define Z_UINTTOP_FIXED_TYPE_Name		Z_UINTX_Name	  (Z_UINTTOP_BITS)
#define Z_UINTTOP_FIXED_TYPE_name		Z_UINTX_name	  (Z_UINTTOP_BITS)
#define Z_UINTTOP_NAME				UINTTOP
#define Z_UINTTOP_Name				UIntTop
#define Z_UINTTOP_name				uinttop
...
#define Z_INTTOP_FIXED_TYPE_NAME		Z_INTX_NAME	 (Z_INTTOP_BITS)
#define Z_INTTOP_FIXED_TYPE_Name		Z_INTX_Name	 (Z_INTTOP_BITS)
#define Z_INTTOP_FIXED_TYPE_name		Z_INTX_name	 (Z_INTTOP_BITS)
#define Z_INTTOP_NAME				UINTTOP
#define Z_INTTOP_Name				UIntTop
#define Z_INTTOP_name				uinttop
...
#define Z_BOOLEAN_BASE_TYPE			Z_UINT8_BASE_TYPE
#define Z_BOOLEAN_FIXED_TYPE			Z_UINT8_FIXED_TYPE
#define Z_BOOLEAN_TYPE				Z_VALUE_TYPE_BOOLEAN
#define Z_BOOLEAN_FORMAT			Z_UINT8_FORMAT
#define Z_BOOLEAN_BITS				Z_UINT8_BITS
#define Z_BOOLEAN_SIZE				Z_UINT8_SIZE
#define Z_BOOLEAN_FIXED_TYPE_NAME		Z_UINT8_NAME
#define Z_BOOLEAN_FIXED_TYPE_Name		Z_UINT8_Name
#define Z_BOOLEAN_FIXED_TYPE_name		Z_UINT8_name
#define Z_BOOLEAN_NAME				BOOLEAN
#define Z_BOOLEAN_Name				Boolean
#define Z_BOOLEAN_name				boolean
...
#define Z_NATURAL_FIXED_TYPE_NAME		Z_UINTX_NAME	  (Z_NATURAL_BITS)
#define Z_NATURAL_FIXED_TYPE_Name		Z_UINTX_Name	  (Z_NATURAL_BITS)
#define Z_NATURAL_FIXED_TYPE_name		Z_UINTX_name	  (Z_NATURAL_BITS)
#define Z_NATURAL_NAME				UNATURAL
#define Z_NATURAL_Name				UNatural
#define Z_NATURAL_name				unatural
...
#define Z_INTEGER_FIXED_TYPE_NAME		Z_INTX_NAME	 (Z_INTEGER_BITS)
#define Z_INTEGER_FIXED_TYPE_Name		Z_INTX_Name	 (Z_INTEGER_BITS)
#define Z_INTEGER_FIXED_TYPE_name		Z_INTX_name	 (Z_INTEGER_BITS)
#define Z_INTEGER_NAME				UINTEGER
#define Z_INTEGER_Name				UInteger
#define Z_INTEGER_name				uinteger

#define Z_REAL_TYPE				Z_VALUE_TYPE_REAL
#define Z_REAL_NAME				REAL
#define Z_REAL_Name				Real
#define Z_REAL_name				real
...
#	define Z_REAL_FIXED_TYPE_NAME		Z_FLOAT_NAME
#	define Z_REAL_FIXED_TYPE_Name		Z_FLOAT_Name
#	define Z_REAL_FIXED_TYPE_name		Z_FLOAT_name
...
#	define Z_REAL_FIXED_TYPE_NAME		Z_LDOUBLE_FIXED_TYPE_NAME
#	define Z_REAL_FIXED_TYPE_Name		Z_LDOUBLE_FIXED_TYPE_Name
#	define Z_REAL_FIXED_TYPE_name		Z_LDOUBLE_FIXED_TYPE_name
...
#	define Z_REAL_FIXED_TYPE_NAME		Z_DOUBLE_NAME
#	define Z_REAL_FIXED_TYPE_Name		Z_DOUBLE_Name
#	define Z_REAL_FIXED_TYPE_name		Z_DOUBLE_name
...
#define Z_STATUS_FIXED_TYPE			Z_INT_FIXED_TYPE
#define Z_STATUS_BASE_TYPE			Z_INT_BASE_TYPE
...
#define Z_STATUS_FIXED_TYPE_NAME		Z_INT_FIXED_TYPE_NAME
#define Z_STATUS_FIXED_TYPE_Name		Z_INT_FIXED_TYPE_Name
#define Z_STATUS_FIXED_TYPE_name		Z_INT_FIXED_TYPE_name
...
#define Z_ORDER_FIXED_TYPE			Z_UINT8_FIXED_TYPE
#define Z_ORDER_BASE_TYPE			Z_UINT8_BASE_TYPE
#define Z_ORDER_FORMAT				Z_UINT8_FORMAT
#define Z_ORDER_BITS				Z_UINT8_BITS
#define Z_ORDER_SIZE				Z_UINT8_SIZE
#define Z_ORDER_FIXED_TYPE_NAME			Z_UINT8_NAME
#define Z_ORDER_FIXED_TYPE_Name			Z_UINT8_Name
#define Z_ORDER_FIXED_TYPE_name			Z_UINT8_name
