...
#define Z_UINTX_LITERAL(	bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT,		 )
#define Z_UINTX_BASE_VALUE_TYPE(bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _BASE_VALUE_TYPE)
#define Z_UINTX_VALUE_TYPE(	bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _VALUE_TYPE	 )
#define Z_UINTX_VALUE_FORMAT(	bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _VALUE_FORMAT	 )
#define Z_UINTX_ENDIANNESS(	bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _ENDIANNESS	 )
#define Z_UINTX_SIZE(		bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _SIZE		 )
#define Z_UINTX_MINIMUM(	bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _MINIMUM	 )
#define Z_UINTX_MAXIMUM(	bits)		Z_JOIN_2(Z_INSERT_NUMBER_, biys)(Z_UINT, _MAXIMUM	 )
...
#define Z_INTX_VALUE_FORMAT(   bits)		Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_INT, _VALUE_FORMAT	)
...
#	define Z_FLOAT128_INFINITY		Z_FLOATING_POINT_INFINITY	    (FLOAT128, Z_FLOAT96)
#	define Z_FLOAT128_NAN			Z_FLOATING_POINT_NAN		    (FLOAT128, Z_FLOAT96)
#	define Z_AVAILABLE_FLOAT128

#endif

#define Z_FLOATX_LITERAL(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT,		      )
#define Z_FLOATX_BASE_VALUE_TYPE(    bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _BASE_VALUE_TYPE    )
#define Z_FLOATX_VALUE_TYPE(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _VALUE_TYPE	      )
#define Z_FLOATX_VALUE_FORMAT(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _VALUE_FORMAT	      )
#define Z_FLOATX_SIZE(		     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _SIZE		      )
#define Z_FLOATX_BIAS(		     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _BIAS		      )
#define Z_FLOATX_EPSILON(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EPSILON	      )
#define Z_FLOATX_MINIMUM(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _MINIMUM	      )
#define Z_FLOATX_MAXIMUM(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _MAXIMUM	      )
#define Z_FLOATX_DECIMAL_DIGITS(     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _DECIMAL_DIGITS     )
#define Z_FLOATX_SIGNIFICAND_OFFSET( bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _SIGNIFICAND_OFFSET )
#define Z_FLOATX_SIGNIFICAND_BITS(   bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _SIGNIFICAND_BITS   )
#define Z_FLOATX_SIGNIFICAND_DIGITS( bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _SIGNIFICAND_DIGITS )
#define Z_FLOATX_EXPONENT_OFFSET(    bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_OFFSET    )
#define Z_FLOATX_EXPONENT_BITS(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_BITS      )
#define Z_FLOATX_EXPONENT_RADIX(     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_RADIX     )
#define Z_FLOATX_EXPONENT_MINIMUM(   bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_MINIMUM   )
#define Z_FLOATX_EXPONENT_MAXIMUM(   bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_MAXIMUM   )
#define Z_FLOATX_EXPONENT_10_MINIMUM(bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_10_MINIMUM)
#define Z_FLOATX_EXPONENT_10_MAXIMUM(bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _EXPONENT_10_MAXIMUM)
#define Z_FLOATX_SIGN_OFFSET(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _SIGN_OFFSET	      )
#define Z_FLOATX_SIGN_BITS(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _SIGN_BITS	      )
#define Z_FLOATX_INFINITY(	     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _INFINITY	      )
#define Z_FLOATX_NAN(		     bits)	Z_JOIN_2(Z_INSERT_NUMBER_, bits)(Z_FLOAT, _NAN		      )
...
#define Z_UCHAR_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT(Z_UCHAR_BITS)
...
#define Z_USHORT_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT(Z_USHORT_BITS)
...
#define Z_UINT_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT(Z_UINT_BITS)
...
#define Z_ULONG_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT(Z_ULONG_BITS)
...
#	define Z_ULLONG_VALUE_FORMAT		Z_UINTX_VALUE_FORMAT(Z_ULLONG_BITS)
...
#define Z_CHAR_VALUE_FORMAT			Z_INTX_VALUE_FORMAT(Z_CHAR_BITS)
...
#define Z_SHORT_VALUE_FORMAT			Z_INTX_VALUE_FORMAT(Z_SHORT_BITS)
...
#define Z_INT_VALUE_FORMAT			Z_INTX_VALUE_FORMAT(Z_INT_BITS)
...
#define Z_LONG_VALUE_FORMAT			Z_INTX_VALUE_FORMAT(Z_LONG_BITS)
...
#	define Z_LLONG_VALUE_FORMAT		Z_INTX_VALUE_FORMAT(Z_LLONG_BITS)
...
#define Z_FLOAT_VALUE_FORMAT			Z_FLOATING_POINT_VALUE_FORMAT	    (FLOAT)
...
#define Z_FLOAT_SIGNIFICAND_OFFSET		Z_FLOATING_POINT_SIGNIFICAND_OFFSET (FLOAT)
#define Z_FLOAT_SIGNIFICAND_BITS		Z_FLOATING_POINT_SIGNIFICAND_BITS   (FLOAT)
#define Z_FLOAT_SIGNIFICAND_DIGITS		Z_FLOATING_POINT_SIGNIFICAND_DIGITS (FLOAT)
...
#define Z_DOUBLE_VALUE_FORMAT			Z_FLOATING_POINT_VALUE_FORMAT	    (DOUBLE)
...
#define Z_DOUBLE_SIGNIFICAND_OFFSET		Z_FLOATING_POINT_SIGNIFICAND_OFFSET (DOUBLE)
#define Z_DOUBLE_SIGNIFICAND_BITS		Z_FLOATING_POINT_SIGNIFICAND_BITS   (DOUBLE)
#define Z_DOUBLE_SIGNIFICAND_DIGITS		Z_FLOATING_POINT_SIGNIFICAND_DIGITS (DOUBLE)
...
#	define Z_LDOUBLE_VALUE_FORMAT		Z_FLOATING_POINT_VALUE_FORMAT	    (LDOUBLE)
...
#	define Z_LDOUBLE_SIGNIFICAND_OFFSET	Z_FLOATING_POINT_SIGNIFICAND_OFFSET (LDOUBLE)
#	define Z_LDOUBLE_SIGNIFICAND_BITS	Z_FLOATING_POINT_SIGNIFICAND_BITS   (LDOUBLE)
#	define Z_LDOUBLE_SIGNIFICAND_DIGITS	Z_FLOATING_POINT_SIGNIFICAND_DIGITS (LDOUBLE)
...
#define Z_SIZE_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT   (Z_SIZE_BITS)
...
#define Z_SSIZE_VALUE_FORMAT			Z_INTX_VALUE_FORMAT   (Z_SSIZE_BITS)
...
#define Z_UINTMAX_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT   (Z_UINTMAX_BITS)
...
#define Z_INTMAX_VALUE_FORMAT			Z_INTX_VALUE_FORMAT   (Z_INTMAX_BITS)
...
#define Z_POINTER_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT(Z_POINTER_BITS)
...
#define Z_UINTPTR_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT   (Z_UINTPTR_BITS)
...
#define Z_INTPTR_VALUE_FORMAT			Z_INTX_VALUE_FORMAT   (Z_INTPTR_BITS)
...
#define Z_UINTTOP_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT   (Z_UINTTOP_BITS)
...
#define Z_INTTOP_VALUE_FORMAT			Z_INTX_VALUE_FORMAT   (Z_INTTOP_BITS)
...
#define Z_NATURAL_VALUE_FORMAT			Z_UINTX_VALUE_FORMAT   (Z_NATURAL_BITS)
...
#define Z_INTEGER_VALUE_FORMAT			Z_INTX_VALUE_FORMAT   (Z_INTEGER_BITS)
