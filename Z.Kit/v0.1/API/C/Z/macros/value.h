...
#define Z_VALUE_REVERSED(TYPE) Z_JOIN_3(Z_, Z_##TYPE##_BITS, BIT_REVERSED_IN_8BIT)
#define Z_VALUE_REVERSE( TYPE) Z_JOIN_3(Z_, Z_##TYPE##_BITS, BIT_REVERSE_IN_8BIT )
...
#define Z_VALUE_ENSURE_BIG_ENDIAN(   TYPE) Z_JOIN_3(Z_, Z_##TYPE##_BITS, BIT_ENSURE_BIG_ENDIAN   )
#define Z_VALUE_ENSURE_LITTLE_ENDIAN(TYPE) Z_JOIN_3(Z_, Z_##TYPE##_BITS, BIT_ENSURE_LITTLE_ENDIAN)
#define Z_VALUE_BIG_ENDIAN(	     TYPE) Z_JOIN_3(Z_, Z_##TYPE##_BITS, BIT_BIG_ENDIAN		 )
#define Z_VALUE_LITTLE_ENDIAN(	     TYPE) Z_JOIN_3(Z_, Z_##TYPE##_BITS, BIT_LITTLE_ENDIAN	 )

/* MARK: - Structure */

#define Z_VALUE_STRUCTURE(TYPE, value) ((Z_PREFIX_Z(Z_JOIN_2(Z_##TYPE##_BITS, Bit)))value)
