...
#define Z_8BIT_64BIT_MIRROR( value) (((zuint64 )(value)) * Z_UINT64(0x0101010101010101))
...
#	if Z_COMPILER_HAS(UINT128_LITERAL)
#		define Z_8BIT_128BIT_MIRROR( value) (((zuint128)(value)) * Z_UINT128(0x01010101010101010101010101010101))
#		define Z_16BIT_128BIT_MIRROR(value) (((zuint128)(value)) * Z_UINT128(0x00010001000100010001000100010001))
#		define Z_32BIT_128BIT_MIRROR(value) (((zuint128)(value)) * Z_UINT128(0x00000001000000010000000100000001))
#		define Z_64BIT_128BIT_MIRROR(value) (((zuint128)(value)) * Z_UINT128(0x00000000000000010000000000000001))
#	else
#		define Z_8BIT_128BIT_MIRROR( value) (((zuint128)(value)) * ((zuint128)0x0101010101010101 | ((zuint128)0101010101010101 << 64)))
#		define Z_16BIT_128BIT_MIRROR(value) (((zuint128)(value)) * ((zuint128)0x0001000100010001 | ((zuint128)0001000100010001 << 64)))
#		define Z_32BIT_128BIT_MIRROR(value) (((zuint128)(value)) * ((zuint128)0x0000000100000001 | ((zuint128)0000000100000001 << 64)))
...
#define Z_VALUE_REVERSED(TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_REVERSED_IN_8BIT)
#define Z_VALUE_REVERSE( TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_REVERSE_IN_8BIT )
...
#	define Z_AVAILABLE_128BIT_ROTATION_MACROS
...
#define Z_64BIT_FROM_32BIT_BA(b, a)		\
	((((zuint64)(b)) << 32) |		\
	  ((zuint64)(a)))
...
#define Z_VALUE_ENSURE_BIG_ENDIAN(   TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_ENSURE_BIG_ENDIAN   )
#define Z_VALUE_ENSURE_LITTLE_ENDIAN(TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_ENSURE_LITTLE_ENDIAN)
#define Z_VALUE_BIG_ENDIAN(	     TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_BIG_ENDIAN	   )
#define Z_VALUE_LITTLE_ENDIAN(	     TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_LITTLE_ENDIAN	   )
