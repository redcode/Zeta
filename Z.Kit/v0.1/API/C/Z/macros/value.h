...
#define Z_TYPE_REVERSED(	    TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_REVERSED_IN_8BIT	  )
#define Z_TYPE_REVERSE(		    TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_REVERSE_IN_8BIT	  )
#define Z_TYPE_ENSURE_BIG_ENDIAN(   TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_ENSURE_BIG_ENDIAN	  )
#define Z_TYPE_ENSURE_LITTLE_ENDIAN(TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_ENSURE_LITTLE_ENDIAN)
#define Z_TYPE_BIG_ENDIAN(	    TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_BIG_ENDIAN	  )
#define Z_TYPE_LITTLE_ENDIAN(	    TYPE) Z_JOIN_2(Z_INSERT_NUMBER_, Z_##TYPE##_BITS)(Z_, BIT_LITTLE_ENDIAN	  )
