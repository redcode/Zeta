...
#define Z_INSERT_FLOAT_FIXED_TYPE   Z_JOIN_2(Z_INSERT_FLOAT,   Z_FLOAT_PRECISION_BITS  )
#define Z_INSERT_FLOAT_FixedType    Z_JOIN_2(Z_INSERT_Float,   Z_FLOAT_PRECISION_BITS  )
#define Z_INSERT_FLOAT_fixed_type   Z_JOIN_2(Z_INSERT_float,   Z_FLOAT_PRECISION_BITS  )
#define Z_INSERT_DOUBLE_BITS	    Z_JOIN_2(Z_INSERT_NUMBER_, Z_DOUBLE_BITS	       )
#define Z_INSERT_DOUBLE_FIXED_TYPE  Z_JOIN_2(Z_INSERT_FLOAT,   Z_DOUBLE_PRECISION_BITS )
#define Z_INSERT_DOUBLE_FixedType   Z_JOIN_2(Z_INSERT_Float,   Z_DOUBLE_PRECISION_BITS )
#define Z_INSERT_DOUBLE_fixed_type  Z_JOIN_2(Z_INSERT_float,   Z_DOUBLE_PRECISION_BITS )
#define Z_INSERT_LDOUBLE_BITS	    Z_JOIN_2(Z_INSERT_NUMBER_, Z_LDOUBLE_BITS	       )
#define Z_INSERT_LDOUBLE_FIXED_TYPE Z_JOIN_2(Z_INSERT_FLOAT,   Z_LDOUBLE_PRECISION_BITS)
#define Z_INSERT_LDOUBLE_FixedType  Z_JOIN_2(Z_INSERT_Float,   Z_LDOUBLE_PRECISION_BITS)
#define Z_INSERT_LDOUBLE_fixed_type Z_JOIN_2(Z_INSERT_float,   Z_LDOUBLE_PRECISION_BITS)
...
#define Z_INSERT_REAL_FIXED_TYPE    Z_JOIN_2(Z_INSERT_FLOAT,   Z_REAL_PRECISION_BITS)
#define Z_INSERT_REAL_FixedType	    Z_JOIN_2(Z_INSERT_Float,   Z_REAL_PRECISION_BITS)
#define Z_INSERT_REAL_fixed_type    Z_JOIN_2(Z_INSERT_float,   Z_REAL_PRECISION_BITS)
