...
#define Z_APPEND_REAL_FIXED_TYPE    Z_JOIN_2(Z_APPEND_FIXED_TYPE_, Z_LDOUBLE_FIXED_VALUE_TYPE)
#define Z_APPEND_REAL_FixedType	    Z_JOIN_2(Z_APPEND_FixedType_,  Z_LDOUBLE_FIXED_VALUE_TYPE)
#define Z_APPEND_REAL_fixed_type    Z_JOIN_2(Z_APPEND_fixed_type_, Z_LDOUBLE_FIXED_VALUE_TYPE)
#define Z_INSERT_REAL_FIXED_TYPE    Z_JOIN_2(Z_INSERT_FIXED_TYPE_, Z_LDOUBLE_FIXED_VALUE_TYPE)
#define Z_INSERT_REAL_FixedType	    Z_JOIN_2(Z_INSERT_FixedType_,  Z_LDOUBLE_FIXED_VALUE_TYPE)
#define Z_INSERT_REAL_fixed_type    Z_JOIN_2(Z_INSERT_fixed_type_, Z_LDOUBLE_FIXED_VALUE_TYPE)
