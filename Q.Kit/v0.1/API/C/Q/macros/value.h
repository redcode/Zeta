...
#define Q_8BIT_16BIT_MIRROR( value) (((quint16 )(value)) * 0x0101)
#define Q_8BIT_32BIT_MIRROR( value) (((quint32 )(value)) * Q_UINT32(0x01010101))
#define Q_8BIT_64BIT_MIRROR( value) (((quint64 )(value)) * Q_UINT64(0x0101010101010101))
#define Q_16BIT_32BIT_MIRROR(value) (((quint32 )(value)) * Q_UINT32(0x00010001))
#define Q_16BIT_64BIT_MIRROR(value) (((quint64 )(value)) * Q_UINT64(0x0001000100010001))
#define Q_32BIT_64BIT_MIRROR(value) (((quint64 )(value)) * Q_UINT64(0x0000000100000001))
...
#	define Q_8BIT_TOP_MIRROR  Q_8BIT_16BIT_MIRROR

#elif Q_UINTTOP_BITS == 32

#	define Q_8BIT_TOP_MIRROR  Q_8BIT_32BIT_MIRROR
#	define Q_16BIT_TOP_MIRROR Q_16BIT_32BIT_MIRROR

#elif Q_UINTTOP_BITS == 64

#	define Q_8BIT_TOP_MIRROR  Q_8BIT_64BIT_MIRROR
#	define Q_16BIT_TOP_MIRROR Q_16BIT_64BIT_MIRROR
#	define Q_32BIT_TOP_MIRROR Q_32BIT_64BIT_MIRROR

#elif Q_UINTTOP_BITS == 128

#	define Q_8BIT_TOP_MIRROR  Q_8BIT_128BIT_MIRROR
#	define Q_16BIT_TOP_MIRROR Q_16BIT_128BIT_MIRROR
#	define Q_32BIT_TOP_MIRROR Q_32BIT_128BIT_MIRROR
#	define Q_64BIT_TOP_MIRROR Q_64BIT_128BIT_MIRROR
...
#define Q_VALUE_ENSURE_BIG_ENDIAN(   TYPE) Q_JOIN_3(Q_, Q_##TYPE##_BITS, BIT_ENSURE_BIG_ENDIAN   )
#define Q_VALUE_ENSURE_LITTLE_ENDIAN(TYPE) Q_JOIN_3(Q_, Q_##TYPE##_BITS, BIT_ENSURE_LITTLE_ENDIAN)
#define Q_VALUE_BIG_ENDIAN(	     TYPE) Q_JOIN_3(Q_, Q_##TYPE##_BITS, BIT_BIG_ENDIAN		 )
#define Q_VALUE_LITTLE_ENDIAN(	     TYPE) Q_JOIN_3(Q_, Q_##TYPE##_BITS, BIT_LITTLE_ENDIAN	 )
