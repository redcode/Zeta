/* Q Kit C API - inspection/compiler.h
	      __	   __
...
#define Q_COMPILER_C_HAS(		WHAT ) (defined Q_COMPILER_C_HAS_##WHAT		       )
#define Q_COMPILER_C_HAS_TYPE(		WHICH) (defined Q_COMPILER_C_HAS_TYPE_##WHICH	       )
#define Q_COMPILER_C_HAS_TYPE_QUALIFIER(WHICH) (defined Q_COMPILER_C_HAS_TYPE_QUALIFIER_##WHICH)
#define Q_COMPILER_C_HAS_STORAGE_CLASS(	WHICH) (defined Q_COMPILER_C_HAS_STORAGE_CLASS_##WHICH )
#define Q_COMPILER_C_HAS_SPECIFIER(	WHICH) (defined Q_COMPILER_C_HAS_SPECIFIER_##WHICH     )
#define Q_COMPILER_C_HAS_OPERATOR(	WHICH) (defined Q_COMPILER_C_HAS_OPERATOR_##WHICH      )

#define Q_COMPILER_CPP_HAS(		  WHAT ) (defined Q_COMPILER_CPP_HAS_##WHAT		   )
#define Q_COMPILER_CPP_HAS_TYPE(	  WHICH) (defined Q_COMPILER_CPP_HAS_TYPE_##WHICH	   )
#define Q_COMPILER_CPP_HAS_TYPE_QUALIFIER(WHICH) (defined Q_COMPILER_CPP_HAS_TYPE_QUALIFIER_##WHICH)
#define Q_COMPILER_CPP_HAS_STORAGE_CLASS( WHICH) (defined Q_COMPILER_CPP_HAS_STORAGE_CLASS_##WHICH )
#define Q_COMPILER_CPP_HAS_SPECIFIER(	  WHICH) (defined Q_COMPILER_CPP_HAS_SPECIFIER_##WHICH     )
#define Q_COMPILER_CPP_HAS_OPERATOR(	  WHICH) (defined Q_COMPILER_CPP_HAS_OPERATOR_##WHICH	   )

#define Q_COMPILER_OBJECTIVE_C_HAS(		  WHAT ) (defined Q_COMPILER_C_HAS_##WHAT		 )
#define Q_COMPILER_OBJECTIVE_C_HAS_TYPE(	  WHICH) (defined Q_COMPILER_C_HAS_TYPE_##WHICH		 )
#define Q_COMPILER_OBJECTIVE_C_HAS_TYPE_QUALIFIER(WHICH) (defined Q_COMPILER_C_HAS_TYPE_QUALIFIER_##WHICH)
#define Q_COMPILER_OBJECTIVE_C_HAS_STORAGE_CLASS( WHICH) (defined Q_COMPILER_C_HAS_STORAGE_CLASS_##WHICH )
#define Q_COMPILER_OBJECTIVE_C_HAS_SPECIFIER(	  WHICH) (defined Q_COMPILER_C_HAS_SPECIFIER_##WHICH	 )
#define Q_COMPILER_OBJECTIVE_C_HAS_OPERATOR(	  WHICH) (defined Q_COMPILER_C_HAS_OPERATOR_##WHICH	 )

#define Q_COMPILER_HAS(			     WHAT ) (defined Q_COMPILER_HAS_##WHAT		     )
#define Q_COMPILER_HAS_C_ATTRIBUTE(	     WHICH) (defined Q_COMPILER_C_ATTRIBUTE_##WHICH	     )
#define Q_COMPILER_HAS_CPP_ATTRIBUTE(	     WHICH) (defined Q_COMPILER_CPP_ATTRIBUTE_##WHICH	     )
#define Q_COMPILER_HAS_OBJECTIVE_C_ATTRIBUTE(WHICH) (defined Q_COMPILER_OBJECTIVE_C_ATTRIBUTE_##WHICH)
#define Q_COMPILER_HAS_CONSTANT(	     WHICH) (defined Q_COMPILER_CONSTANT_##WHICH	     )
#define Q_COMPILER_HAS_LITERAL(		     WHICH) (defined Q_COMPILER_LITERAL_##WHICH		     )
#define Q_COMPILER_HAS_SUFFIX(		     WHICH) (defined Q_COMPILER_SUFFIX_##WHICH		     )
#define Q_COMPILER_HAS_MACRO(		     WHICH) (defined Q_COMPILER_MACRO_##WHICH		     )
#define Q_COMPILER_HAS_FUNCTION(	     WHICH) (defined Q_COMPILER_FUNCTION_##WHICH	     )

#define Q_COMPILER_HAS_TYPE(WHICH) \
	(!(defined Q_COMPILER_LACKS_TYPE_##WHICH) && (defined Q_COMPILER_TYPE_##WHICH))

#define Q_COMPILER_C_ATTRIBUTE(		 WHICH) Q_COMPILER_C_ATTRIBUTE_##WHICH
#define Q_COMPILER_CPP_ATTRIBUTE(	 WHICH) Q_COMPILER_CPP_ATTRIBUTE_##WHICH
#define Q_COMPILER_OBJECTIVE_C_ATTRIBUTE(WHICH) Q_COMPILER_OBJECTIVE_C_ATTRIBUTE_##WHICH
#define Q_COMPILER_CONSTANT(		 WHICH) Q_COMPILER_CONSTANT_##WHICH
#define Q_COMPILER_TYPE(		 WHICH) Q_COMPILER_TYPE_##WHICH
#define Q_COMPILER_LITERAL(		 WHICH) Q_COMPILER_LITERAL_##WHICH
#define Q_COMPILER_SUFFIX(		 WHICH) Q_COMPILER_SUFFIX_##WHICH
#define Q_COMPILER_MACRO(		 WHICH) Q_COMPILER_MACRO_##WHICH
#define Q_COMPILER_FUNCTION(		 WHICH) Q_COMPILER_FUNCTION_##WHICH
