...
#define Q_COMPILER_HAS_ATTRIBUTE(ATTRIBUTE) (defined Q_COMPILER_ATTRIBUTE_##ATTRIBUTE)
...
#define Q_COMPILER_ATTRIBUTE(	 ATTRIBUTE) Q_COMPILER_ATTRIBUTE_##ATTRIBUTE
#define Q_COMPILER_CONSTANT(	 CONSTANT ) Q_COMPILER_CONSTANT_##CONSTANT
#define Q_COMPILER_TYPE(	 TYPE	  ) Q_COMPILER_TYPE_##TYPE
#define Q_COMPILER_MACRO(	 MACRO	  ) Q_COMPILER_MACRO_##MACRO
