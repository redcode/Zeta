...
#define Q_IMPLEMENTATION_3D_VECTOR(Type, type)							\
												\
												\
Q_INLINE qboolean q_3d_##type##_vector_are_equal(Q3D##Type##Vector a, Q3D##Type##Vector b)	\
...
Q_INLINE qboolean q_3d_##type##_vector_is_zero(Q3D##Type##Vector object)			\
	{return q_3d_##type##_is_zero(object.a) && q_3d_##type##_is_zero(object.b);}		\
												\
												\
Q_INLINE Q3D##Type##Vector q_3d_##type##_vector_reversed(Q3D##Type##Vector object)		\
	{											\
